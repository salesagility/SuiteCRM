...
{
    public function testvarExportHelper()
    {
    ...
    public function testoverrideValueToString()
    {
        //execute the method and test if it returns expected values
    ...
    public function testaddBlankOption()
    {
    ...
    public function testoverrideValueToStringRecursive()
    {
        //execute the method and test if it returns expected values
        ...
        //with keys
        $tempArray = [];
        $tempArray['Key1']['Key2'] = ['Key3' => 'value', 'Key4' => 'value'];
        $expected = "\$tempArray['key1']['key2']=array (\n  'Key1' => \n  array (\n    'Key2' => \n    array (\n      'Key3' => 'value',\n      'Key4' => 'value',\n    ),\n  ),\n);";
        $actual = override_value_to_string_recursive(['key1', 'key2'], 'tempArray', $tempArray);

        $this->assertSame($expected, $actual);
    }

    public function testoverrideRecursiveHelper()
    {
        //execute the method and test if it returns expected values
        ...
        $actual = override_recursive_helper(['key1', 'key2'], 'tempArray', $tempArray);
        $this->assertSame($expected, $actual);
    }

    public function testoverrideValueToStringRecursive2()
    {
        //execute the method and test if it returns expected values
    ...
    public function testobjectToArrayRecursive()
    {
        ...
        $obj = new TimeDate();
        $expected = ['dbDayFormat' => 'Y-m-d', 'dbTimeFormat' => 'H:i:s', 'allow_cache' => true];
        $actual = object_to_array_recursive($obj);
    ...
    public function testdeepArrayDiff()
    {
        ...
        //same simple arrays
        $tempArray1 = ['Key1' => 'value1', 'Key2' => 'value2'];
        $tempArray2 = ['Key1' => 'value1', 'Key2' => 'value2'];
        $expected = [];
        ...
        $tempArray1 = ['Key1' => 'value1', 'Key2' => 'value2'];
        $tempArray2 = ['Key1' => 'value1', 'Key2' => 'value3'];
        $expected = ['Key2' => 'value2'];
        $actual = deepArrayDiff($tempArray1, $tempArray2);
        $this->assertSame($expected, $actual);

        //same complex arrays
        $tempArray1 = ['Key1' => ['Key2' => 'value2', 'Key3' => 'value3']];
        $tempArray2 = ['Key1' => ['Key2' => 'value2', 'Key3' => 'value3']];
        $expected = [];
        $actual = deepArrayDiff($tempArray1, $tempArray2);
        $this->assertSame($expected, $actual);
        ...
        $tempArray1 = ['Key1' => ['Key2' => 'value2', 'Key3' => 'value3']];
        $tempArray2 = ['Key2' => ['Key2' => 'value2', 'Key3' => 'value3']];
        ...
        $tempArray1 = ['Key1' => ['Key2' => 'value2', 'Key3' => 'value3']];
        $tempArray2 = ['Key1' => ['Key2' => 'value2', 'Key4' => 'value4']];
        $expected = ['Key1' => ['Key3' => 'value3']];
        $actual = deepArrayDiff($tempArray1, $tempArray2);
        $this->assertSame($expected, $actual);
    }
    ...
    public function testsetDeepArrayValue()
    {
        ...
        $tempArray = ['Key1' => ['Key2' => 'value2', 'Key3' => 'value3']];
        $expected = ['Key1' => ['Key2' => 'value2', 'Key3' => 'value3'], 'key4' => 'value4'];
    ...
    public function testarrayMergeValues()
    {
        //execute the method and test if it returns expected values
        ...
        $tempArray1 = ['v1', 'v2', 'v3'];
        $tempArray2 = ['v4', 'v5', 'v6'];
        $expected = ['v1v4', 'v2v5', 'v3v6'];
        $actual = array_merge_values($tempArray1, $tempArray2);
        $this->assertSame($expected, $actual);
    }

    public function testarraySearchInsensitive()
    {
        ...
        $tempArray = ['Key1' => 'value1', 'Key2' => 'value2', 'Key3' => 'value3', 'key4' => 'value4'];
        $actual = array_search_insensitive('', $tempArray);
        $this->assertFalse($actual);
    ...
    public function testget()
    {
        ...
        $tempArray = new SugarArray(['Key1' => ['Key2' => 'value2', 'Key3' => 'value3'], 'key4' => 'value4']);
        $expected = 'value4';
    ...
    public function teststaticGet()
    {
        ...
        //test for a top level key
        $haystack = ['key1' => ['key2' => 'value2', 'key3' => 'value3'], 'key4' => 'value4'];
        $expected = 'value4';
