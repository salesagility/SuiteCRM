...
class file_utilsTest extends SuitePHPUnitFrameworkTestCase
{
    ...
    public function testgetModuleDirList()
    {
        //execute the method and test if it returns expected values
...
//        $this->assertFileExists($actual);
    ...
    public function testwriteArrayToFile()
    {
...
//        unlink($cache_dir.'\tempArray.txt');
    ...
    public function testwriteEncodedFile()
    {
        ...
        //without filename
        $tempArray = ['filename' => 'soap_array.txt', 'md5' => '523ef67de860fc54794f27117dba4fac', 'data' => 'some soap data'];
        $actual = write_encoded_file($tempArray, $cache_dir, '');
        $this->assertFileExists($actual);
        unlink($actual);

        //with filename
        $tempArray = ['md5' => '523ef67de860fc54794f27117dba4fac', 'data' => 'some soap data'];
        $actual = write_encoded_file($tempArray, $cache_dir, 'soap_array.txt');
        $this->assertFileExists($actual);
        unlink($actual);
    }

    public function testcreateCustomDirectory()
    {
        //execute the method and test if it created file/dir exists
...
//        $this->assertSame($expected, $actual);
    ...
    public function testmd5DirCompare()
    {
        ...
        $actual = md5DirCompare('include/MVC/', 'include/MVC/', ['views']);
        $this->assertSame($expected, $actual);
    }
    ...
    public function testsugarRename()
    {
    ...
    public function testgetMimeContentTypeFromFilename()
    {
        //execute the method and test if it returns expected values
