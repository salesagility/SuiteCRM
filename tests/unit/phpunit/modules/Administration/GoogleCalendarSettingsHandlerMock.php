...
class GoogleCalendarSettingsHandlerMock extends GoogleCalendarSettingsHandler
{
    ...
    protected $javascriptCalled = false;

    public function __construct($tplPath, $current_user, $request, $mod_strings, Configurator $config, Sugar_Smarty $sugar_smarty, javascript $js)
    {
