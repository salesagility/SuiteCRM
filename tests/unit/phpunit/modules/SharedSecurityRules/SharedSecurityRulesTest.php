...
class SharedSecurityRulesTest extends StateCheckerPHPUnitTestCaseAbstract {
    ...
    public function testCheckRulesWithFilledFetchedRowWithQueryResultsAndActionResultsWithBase64EncodedSerializedActionParametersWithEmailTargetTypeWithCorrectAccessLevelAndCorrectEmailWithSecurityGroup() {
        $state = new StateSaver();
        $state->pushTable('accounts');
        $state->pushTable('accounts_cstm');
        $state->pushTable('users');
    ...
    public function testCheckRulesWithFilledFetchedRowWithQueryResultsAndActionResultsWithBase64EncodedSerializedActionParametersWithEmailTargetTypeWithCorrectAccessLevelAndCorrectEmailAndFindAccess() {
        $state = new StateSaver();
        $state->pushTable('accounts');
        $state->pushTable('accounts_cstm');
        $state->pushTable('users');
