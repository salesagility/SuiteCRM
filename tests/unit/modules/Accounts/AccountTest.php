...
class AccountTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testget_list_view_data()
    {
        ...
        $expected = array(
            ...
            'EMAIL1' => '',
            'EMAIL1_LINK' => '<a class="email-link" href="javascript:void(0);"  onclick=" $(document).openComposeViewModal(this);" data-module="Accounts" data-record-id="" data-module-name=""  data-email-address="">',
            'ENCODED_NAME' => null,
            'CITY' => null,
