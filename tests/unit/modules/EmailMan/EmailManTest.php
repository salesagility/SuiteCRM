...
class EmailManTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testget_list_view_data()
    {
        ...
        $expected = array(
            ...
            'EMAIL1_LINK' => '<a class="email-link" href="javascript:void(0);"  onclick=" $(document).openComposeViewModal(this);" data-module="EmailMan" data-record-id="" data-module-name=""  data-email-address=""></a>',
        );
