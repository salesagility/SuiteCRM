...
class NotEqualsOperatorTest extends SuiteCRM\StateCheckerPHPUnitTestCaseAbstract
{
    /**
     * @var \UnitTester
     */
    ...
    public function _before()
    {
        ...
        self::$operator = new \SuiteCRM\API\JsonApi\v1\Filters\Operators\Comparators\NotEqualsOperator($containers);
    }
    ...
    public function testIsValidTagWithInvalidType()
    {
        $this->tester->expectException(
            new \SuiteCRM\Exception\InvalidArgumentException('[JsonApi][v1][Filters][Operators][Comparators][NotEqualsOperator][isValid][expected type to be string] $operator'),
            function() {
    ...
    {
        $tag = self::$operator->toFilterTag('ne');
