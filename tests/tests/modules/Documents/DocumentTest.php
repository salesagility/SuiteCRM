 ...
 * Class DocumentTest
 */
class DocumentTest extends \SuiteCRM\Tests\SuiteCRMFunctionalTest
{
    ...
    public function testget_list_view_data()
    {
        ...
        $expected = array(
            ...
            'IS_TEMPLATE'              => '0',
            'FILE_URL'                 => '~'
                . preg_quote('<a href=\'index.php?entryPoint=download&id=&type=Documents\' target=\'_blank\'><img src="themes/'
                             . $current_theme . '/images/def_image_inline.gif?v=')
                . '[\w-]+'
                . preg_quote('"    border="0" alt="View" /></a>')
                . '~',
