 ...
 * Class EmailManTest
 */
class EmailManTest extends \SuiteCRM\Tests\SuiteCRMFunctionalTest
{
    ...
    public function testcreate_export_query()
    {
        ...
        //test with valid string params
        $expected =
            'SELECT emailman.* FROM emailman where (emailman.user_id="") AND ( emailman.deleted IS NULL OR emailman.deleted=0 )';
    ...
    public function testcreate_ref_email()
    {
        ...
        $result =
            $emailMan->create_ref_email(0, 'test', 'test text', 'test html', 'test campaign', 'from@test.com', '1', '',
                                        array(), true, 'test from address');
