 ...
 */
class AdministrationTest extends \SuiteCRM\Tests\SuiteCRMFunctionalTest
{
    public function testAdministration()
    {
        ...
        $this->assertAttributeEquals(array('disclosure',
                                           'notify',
                                           'system',
                                           'portal',
                                           'proxy',
                                           ...
                                           'captcha',
                                           'sugarpdf',
                                     ), 'config_categories', $admin);
        $this->assertAttributeEquals(array('notify_send_by_default',
                                           'mail_smtpauth_req',
                                           'notify_on',
                                           'portal_on',
                                           'skypeout_on',
