 ...
 */
class InboundEmailTest extends \SuiteCRM\Tests\SuiteCRMFunctionalTest
{
    ...
    public function testsetSessionInboundFoldersString()
    {
        ...
        $result =
            $inboundEmail->setSessionInboundFoldersString('mail.google.com', 'test', 22, 'IMAP', 'foldersList string');
    ...
    public function testgetEncodingFromBreadCrumb()
    {
        ...
        $parts = array(
            (Object) array('encoding' => 'utf-8',
                           'parts'    => array((Object) array('encoding' => 'utf-8',
                                                              'parts'    => array((Object) array('encoding' => 'utf-8',
                                                                                                 'parts'    => 'dummy parts 2',
                                                              ),
                                                              ),
    ...
    public function testgetCharsetFromBreadCrumb()
    {
        ...
        $parts = array(
            (Object) array('ifparameters' => 1,
                           'attribute'    => 'charset',
                           'value'        => 'test',
                           'parts'        => array((Object) array('ifparameters' => 1,
                                                                  'attribute'    => 'charset',
                                                                  'value'        => 'test',
                                                                  'parts'        => array((Object) array('ifparameters' => 1,
                                                                                                         'attribute'    => 'charset',
    ...
    public function testretrieveAttachmentNameFromStructure()
    {
        ...
        $part = (Object) array('dparameters' => array((Object) array('attribute' => 'filename', 'value' => 'test1.txt'),
                                                      (Object) array('attribute' => 'filename', 'value' => 'test2.txt'),
        ),
                               'parameters'  => array((Object) array('attribute' => 'name', 'value' => 'test1'),
    ...
    public function testgetConnectString()
    {
        ...
        $this->assertEquals('{:/service=mail.google.com}', $inboundEmail->getConnectString('mail.google.com', 'INBOX',
                                                                                           false));//test with includeMbox false
    }
    ...
    public function testcreate_export_query()
    {
        ...
        $expected =
            " SELECT  inbound_email.*  , jt0.user_name created_by_name , jt0.created_by created_by_name_owner  , 'Users' created_by_name_mod FROM inbound_email   LEFT JOIN  users jt0 ON jt0.id=inbound_email.created_by AND jt0.deleted=0\n AND jt0.deleted=0 where inbound_email.deleted=0";
    ...
    public function testdisplayOneEmail()
    {
        ...
        $expected = array(
            'meta' => array('type'          => 'archived',
                            'uid'           => 1,
                            'ieId'          => 1,
                            'email'         => array('name'          => 'test',
                                                     'from_name'     => '',
                                                     'from_addr'     => 'from',
                                                     'date_start'    => ' ',
                                                     'time_start'    => '',
