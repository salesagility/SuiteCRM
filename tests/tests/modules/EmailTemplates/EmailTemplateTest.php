 ...
 */
class EmailTemplateTest extends \SuiteCRM\Tests\SuiteCRMFunctionalTest
{
    ...
    public function testcreate_export_query()
    {
        ...
        $expected =
            " SELECT  email_templates.*  , jt0.user_name assigned_user_name , jt0.created_by assigned_user_name_owner  , 'Users' assigned_user_name_mod FROM email_templates   LEFT JOIN  users jt0 ON email_templates.assigned_user_id=jt0.id AND jt0.deleted=0\n\n AND jt0.deleted=0 where email_templates.deleted=0";
    ...
    public function testparse_email_templateAndParse_tracker_urls()
    {
        ...
        $actual = $emailTemplate->parse_email_template(array('subject'   => 'test subject',
                                                             'body_html' => 'test html',
                                                             'body'      => 'test body text',
                                                       ), 'Accounts', $account, $macro_nv);
        $this->assertSame($expected, $actual);
        ...
        $result =
            $emailTemplate->parse_tracker_urls($actual, $tracker_url_template, $tracker_urls, $removeme_url_template);
