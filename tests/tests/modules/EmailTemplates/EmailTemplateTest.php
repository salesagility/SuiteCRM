...
class EmailTemplateTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testparse_email_templateAndParse_tracker_urls()
    {
        ...
        $actual = $emailTemplate->parse_email_template(array(
            'subject' => 'test subject',
            'body_html' => 'test html',
            'body' => 'test body text'
        ...
        $result = $emailTemplate->parse_tracker_urls($actual, $tracker_url_template, $tracker_urls,
            $removeme_url_template, $addme_url_template);
