 ...
 * Class LeadTest
 */
class LeadTest extends \SuiteCRM\Tests\SuiteCRMFunctionalTest
{
    ...
    public function testcreate_list_query()
    {
        ...
        $expected = "SELECT leads.*, users.user_name assigned_user_name, leads_cstm.* FROM leads 			LEFT JOIN
    ...
    public function testbuild_generic_where_clause()
    {
        ...
        //test with empty string params
        $expected =
            "leads.last_name like '%' or leads.account_name like '%' or leads.first_name like '%' or ea.email_address like '%'";
