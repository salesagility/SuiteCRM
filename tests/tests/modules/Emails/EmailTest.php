 ...
 * Class EmailTest
 */
class EmailTest extends \SuiteCRM\Tests\SuiteCRMFunctionalTest
{
    ...
    public function testemail2ParseAddresses()
    {
        ...
        $expected = array(array('email' => 'abc@xyz.com', 'display' => 'abc'),
    ...
    public function testgetForwardHeader()
    {
        ...
        $expected =
            '<br /><br />>  from test<br />>  2016-01-01<br />>  to@email.com<br />>  cc@email.com<br />>  test<br />> <br />';
    ...
    public function testparse_addrs()
    {
        ...
        $expected = array(array('email' => 'abc@email.com', 'display' => 'abc', 'contact_id' => '1'),
    ...
    public function testgetStartPage()
    {
        ...
        $url =
            'index.php?module=Users&offset=6&stamp=1453274421025259800&return_module=Users&action=DetailView&record=seed_max_id';
        $expected = array(
            'module'        => 'Users',
            'action'        => 'DetailView',
            'group'         => '',
        ...
        $url =
            'index.php?module=Users&offset=6&stamp=1453274421025259800&return_module=Users&action=DetailView&record=seed_max_id&assigned_user_id=1';
        $expected = array(
            'module'           => 'Users',
            'action'           => 'DetailView',
            'group'            => '',
    ...
    public function testget_list_view_data()
    {
        ...
        $expected = array(
            ...
            'STATUS'           => null,
            'CREATE_RELATED'   => '~'
                . preg_quote('<a href="index.php?module=Cases&action=EditView&inbound_email_id=1" ><img src="themes/'
                             . $current_theme . '/images/CreateCases.gif?v=') . '[\w-]+'
                . preg_quote('"    border="0" alt="Create Cases" />Create Case</a>') . '~',
    ...
    public function testquickCreateForm()
    {
        ...
        $expected = '~'
            . preg_quote("Quick Create&nbsp;<a id='' onclick='return quick_create_overlib(\"\", \"$sugar_theme\", this);' href=\"#\" ><img src=\"themes/"
                         . $sugar_theme . "/images/advanced_search.gif?v=")
            . '[\w-]+'
