 ...
 * Class CurrencyTest
 */
class CurrencyTest extends \SuiteCRM\Tests\SuiteCRMFunctionalTest
{
    ...
    public function testgetCurrencySymbolDropDown()
    {
        ...
        //test with view = EditView
        $expected =
        $expected = "<select name=\"currency_name\" id=\"currency_name\" />\n<OPTION value='\$'>\$</OPTION></select>";
