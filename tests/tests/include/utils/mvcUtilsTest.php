 ...
 * Class mvc_utilsTest
 */
class mvc_utilsTest extends \SuiteCRM\Tests\SuiteCRMFunctionalTest
{
    ...
    public function testgetPrintLink()
    {
        ...
        $expected =
            "javascript:void window.open('index.php?','printwin','menubar=1,status=0,resizable=1,scrollbars=1,toolbar=0,location=1')";
        $actual = getPrintLink();
