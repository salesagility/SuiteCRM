...
private function generateSoapServer()
    {
        if ($this->server == null) {
            ...
            $this->server = new SoapServer($this->getWSDLPath(true),
                array('soap_version' => SOAP_1_2, 'encoding' => 'ISO-8859-1'));
        }
    }
    ...
    public function registerType(
        ...
        $this->nusoap_server->wsdl->addComplexType($name, $typeClass, $phpType, $compositor, $restrictionBase,
