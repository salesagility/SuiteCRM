...
class SugarWebServiceUtilv4 extends SugarWebServiceUtilv3_1
{
    ...
    function get_field_list($value, $fields, $translate = true)
    {
        ...
        $GLOBALS['log']->info('Begin: SoapHelperWebServices->get_field_list(too large a struct, ' . print_r($fields,
                true) . ", $translate");
        $module_fields = array();
        $link_fields = array();
    ...
    function checkSessionAndModuleAccess(
        ...
        return parent::checkSessionAndModuleAccess($session, $login_error_key, $module_name, $access_level,
