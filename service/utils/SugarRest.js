...
if (typeof SugarRest == "undefined") {
  ...
  SugarRest.prototype.login = function(user_name, password) {
    ...
    var loginData = [{ user_name: user_name, password: password, encryption: encryption }, this.application_name];
  ...
  SugarRest.prototype.get_entry_list = function(
    module_name,
    query,
    order_by,
    select_fields,
  ...
  SugarRest.prototype.rss_get_entry_list = function(
    module_name,
    query,
    order_by,
    select_fields,
  ...
  SugarRest.prototype.rss_popup_get_entry_list = function(
    module_name,
    query,
    order_by,
    select_fields,
