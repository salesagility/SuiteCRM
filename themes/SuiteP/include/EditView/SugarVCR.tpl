        ...
        <td nowrap class="paginationWrapper">
                ...
                <script>
                  SUGAR.saveAndContinue = function (elem) {ldelim}
                    ...
                    if (check_form('EditView')) {
                      ldelim}sendAndRedirect('EditView', '{$app_strings.LBL_SAVING} {$module}...', '{$list_link}');{rdelim}
                      {rdelim}
                </script>
                &nbsp;&nbsp;&nbsp;&nbsp;{else}
            ...
            <span class="pagination">
                {if !empty($previous_link)}
                    <button type="button" class="button btn-pagination" title="{$app_strings.LNK_LIST_PREVIOUS}"
...
{else}
                ...
                {/if}
                &nbsp;&nbsp;
                <span class="pagination-range-label">({$offset}{if !empty($total)} {$app_strings.LBL_LIST_OF} {$total}{$plus}{/if}
                    )</span>
                &nbsp;&nbsp;
                {if !empty($next_link)}
                    <button type="button" class="button btn-pagination" title="{$app_strings.LNK_LIST_NEXT}"
