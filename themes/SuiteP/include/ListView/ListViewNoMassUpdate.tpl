...
<table cellpadding='0' cellspacing='0' width='100%' border='0' class='list View'>
    ...
    <tr height='20'>
        ...
        {foreach from=$displayColumns key=colHeader item=params}
            ...
            <span sugar="sugar{$colCounter}"><div style='white-space: nowrap;' width='100%'
                ...
                <td width='1%' nowrap>
                    {if $pageData.access.edit && $pageData.bean.moduleDir != "Employees"}
                        <a title='{$editLinkString}' id="edit-{$rowData.ID}"
                           ...
                           title="{sugar_translate label="LBL_EDIT_INLINE"}">{sugar_getimage name="edit_inline.gif" attr='border="0" '}</a>
                    {/if}
                </td>
            {/if}
            {counter start=0 name="colCounter" print=false assign="colCounter"}
