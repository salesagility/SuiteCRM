<ul class="dropdown-menu">
    ...
    <li>{{sugar_button module="$module" id="DUPLICATE" view="$view" form_id="formDetailView"}}</li>
    ...
    {{counter print=false}}
    <li>{{sugar_button module="$module" id="$button" view="DetailView" form_id="formDetailView"}}</li>
    {{/if}}
    {{/foreach}}
    ...
    {{sugar_button module="$module" id="Audit" view="DetailView" form_id="formDetailView"}}
    {{/if}}
    {{/if}}
</ul>
