...
<div id="footer">
    {if $AUTHENTICATED}
    <div class="companyLogo"><img src="{$COMPANY_LOGO_URL}" width="{$COMPANY_LOGO_WIDTH}" height="{$COMPANY_LOGO_HEIGHT}" alt="{sugar_translate label='LBL_COMPANY_LOGO'}" border="0"/></div>
    <div id="links">
