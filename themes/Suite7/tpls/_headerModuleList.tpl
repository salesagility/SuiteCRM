                            ...
                            {/foreach}
                                ...
                                {if $name == 'Home' and !$lock_homepage}
                                    ...
                                    <li style="margin-top:5px; margin-bottom:5px;"><a href=""
                                                                                      onclick="addDashboardForm();return false">{$APP.LBL_ADD_TAB}</a></li>
                                    <li style="margin-top:5px; margin-bottom:5px;"><a href=""
                                                                                      onclick="return SUGAR.mySugar.showDashletsDialog();">{$APP.LBL_ADD_DASHLETS}</a></li>
                                {/if}
...
{else}
                    ...
                    <li>
                        ...
                        <span class="notCurrentTab">{sugar_link id="moduleTab_$name" module=$name data=$module}</span><span
