...
background: -moz-linear-gradient(top,  #<?php echo $sugar_config['colourselector']['buttontop']; ?> 0%,#<?php echo $sugar_config['colourselector']['buttonmid']; ?> 51%, #<?php echo $sugar_config['colourselector']['buttonbottom']; ?> 100%); /* FF3.6+ */
background: -webkit-gradient(linear, left top, left bottom, color-stop(0%,<?php echo $sugar_config['colourselector']['buttontop']; ?>), color-stop(50%,#<?php echo $sugar_config['colourselector']['buttonmid']; ?>), color-stop(51%,#<?php echo $sugar_config['colourselector']['buttonbottom']; ?>), color-stop(100%,#<?php echo $sugar_config['colourselector']['button4']; ?>)); /* Chrome,Safari4+ */
background: -webkit-linear-gradient(top,  #<?php echo $sugar_config['colourselector']['buttontop']; ?> 0%,#<?php echo $sugar_config['colourselector']['buttonmid']; ?> 51%,#<?php echo $sugar_config['colourselector']['buttonbottom']; ?> 100%); /* Chrome10+,Safari5.1+ */
background: -o-linear-gradient(top,  #<?php echo $sugar_config['colourselector']['buttontop']; ?> 0%,#<?php echo $sugar_config['colourselector']['buttonmid']; ?> 51%,#<?php echo $sugar_config['colourselector']['buttonbottom']; ?> 100%); /* Opera 11.10+ */
background: -ms-linear-gradient(top,  #<?php echo $sugar_config['colourselector']['buttontop']; ?> 0%,#<?php echo $sugar_config['colourselector']['buttonmid']; ?> 51%,#<?php echo $sugar_config['colourselector']['buttonbottom']; ?> 100%); /* IE10+ */
background: linear-gradient(to bottom,  #<?php echo $sugar_config['colourselector']['buttontop']; ?> 0%,#<?php echo $sugar_config['colourselector']['buttonmid']; ?> 51%,#<?php echo $sugar_config['colourselector']['buttonbottom']; ?> 100%); /* W3C */
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#<?php echo $sugar_config['colourselector']['buttontop']; ?>', endColorstr='#<?php echo $sugar_config['colourselector']['buttonbottom']; ?>',GradientType=0 ); /* IE6-8 */
...
filter:none !important;
background: #<?php echo $sugar_config['colourselector']['button_hover']; ?>;
...
background:#<?php echo $sugar_config['colourselector']['modlinkhover']; ?>;
}
