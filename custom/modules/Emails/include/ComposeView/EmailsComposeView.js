...
(function ($) {
  ...
  $.fn.EmailsComposeView = function (options) {
    ...
    self.isToValid = function () {
      "use strict";
      // STIC-Custom 20211124 MHP - Remove spaces between email addresses
      // STIC#714
      // var emailAddresses = $(self).find('[name=to_addrs_names]').val().split('/[,;]/');
      var emailAddresses = $(self).find('[name=to_addrs_names]').val().trim().split("/[,;]/");
      // STIC-Custom 
    ...
    self.isCcValid = function () {
      ...
      var emailAddresses = cc.trim().split("/[,;]/");
      // STIC-Custom 
    ...
    self.isBccValid = function () {
      ...
      var emailAddresses = bcc.trim().split("/[,;]/");
      // STIC-Custom 
  ...
  // STIC 22/06/2021 MHP - Config the TinyMCE Editor of Compose view of the Email module
  // STIC#866
