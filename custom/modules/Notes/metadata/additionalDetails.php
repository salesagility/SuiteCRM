...
function additionalDetailsNote($fields, SugarBean $bean = null, $params = array())
{
    ...
    if (file_exists('custom/modules/' . $bean->module_name . '/metadata/customAdditionalDetails.php')) {
        ...
        return customAdditionalDetails::customAdditionalDetailsNote($fields, $bean, $mod_strings);
