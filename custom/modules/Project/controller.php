...
class CustomProjectController extends SugarController {
    ...
    function action_generate_chart(){
        ...
        include_once('custom/modules/Project/gantt.php');
        include_once('custom/modules/Project/project_table.php');
...
<?php
   ...
   //returns tasks for predecessor in the add task pop-up form
    ...
    function action_update_chart(){
        global $db;
        include('custom/modules/Project/chart.php');
