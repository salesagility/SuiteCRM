...
/* SinergiaCRM - 02/03/2021 - The commented code is replaced by the code below 
in order to avoid launching the campaign wizard when editing an EmailMarketing record
...
// SinergiaCRM - 02/03/2021 - The above commented code is replaced by the following single if statement
// This will force to always go to EmailMarketing edit view and avoid launching the campaign wizard
if (isset($_REQUEST['record']) && $_REQUEST['record']) {
	$focus->retrieve($_REQUEST['record']);
}
// SinergiaCRM - 02/03/2021 - End of the patch
...
$xtpl=new XTemplate('custom/modules/EmailMarketing/EditView.html');
