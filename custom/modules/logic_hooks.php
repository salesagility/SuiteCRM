...
/**
 * LogicHook file with line added for Sales Stage tracking file. 
 * Should be added to custom/modules/Opportunities/
 */
...
$hook_array['before_save'][] = Array(78, 'UpdateOppDates', 'custom/modules/Opportunities/SetOppDates.php', 'Calc', 'setTime'); // This line calls function within file to update sales stage date/duration fields.
