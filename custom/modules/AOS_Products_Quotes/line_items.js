...
function calculateTotal(key)
{
  ...
  //overall_discount_amount = parseFloat($("#overall_discount_amount").val()) || 0;
  //other_charges_amount = parseFloat($("#other_charges_amount").val()) || 0;
  overall_discount_amount = get_value('overall_discount_amount');
  other_charges_amount = get_value('other_charges_amount');
  ...
  //console.log(subtotal + tax + shipping + other_charges_amount);
  set_value(key+'subtotal_tax_amount',subtotal + tax);
  set_value(key+'total_amount',subtotal + tax + shipping + other_charges_amount);
}
