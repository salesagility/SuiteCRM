...
function additionalDetailsFP_Event_Locations($fields, SugarBean $bean = null, $params = array())
{
    if (file_exists('custom/modules/' . $bean->module_name . '/metadata/customAdditionalDetails.php')) {
        ...
        return customAdditionalDetails::customAdditionalDetailsFP_Event_Locations($fields, $bean, $mod_strings);
