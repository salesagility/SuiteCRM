...
$xtpl=new XTemplate('custom/modules/Campaigns/WebToLeadCreation.html');
// END STIC-Custom
...
// STIC-Custom 20230823 JBL - Add reCAPTCHA validation to forms
// STIC#1180
// Find reCAPTCHA configurations
$xtpl->assign("RECAPTCHA_CHECKED", 0);
require_once "modules/stic_Web_Forms/sticUtils.php";
$recaptchaConfigs = SticWebFormsUtils::getRecaptchaConfigurations();
$xtpl->assign("RECAPTCHA_CONFIG_LIST", json_encode($recaptchaConfigs));
$xtpl->assign("REDIRECT_URL_KO_RECAPTCHA_DEFAULT", 'https://');
// END STIC-Custom
