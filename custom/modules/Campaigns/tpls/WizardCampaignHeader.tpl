...
*}
	...
	<div class="template-panel">
		...
		<!-- STIC CUSTOM 20211229 MHP - Add start and end date to step 1 of the campaign wizard 
			 STIC#518 -->	
		<tr>
			<td width="15%" scope="col"><span>{$MOD.LBL_CAMPAIGN_START_DATE}</span></td>
			<td width="35%" >
				<input class="date_input" autocomplete="off" type="text" name="start_date" id="start_date" value="{$CAMP_START_DATE}" title="" tabindex="0" size="11" maxlength="10">
				<button type="button" id="start_date_trigger" class="btn btn-danger" onclick="return false;" title="{$APP.LBL_ENTER_DATE}"><span class="suitepicon suitepicon-module-calendar" alt="{$APP.LBL_ENTER_DATE}"></span></button>
			</td>

			<td width="15%" scope="col"><span>{$MOD.LBL_CAMPAIGN_END_DATE}</span></td>
			<td width="35%" >
				<input class="date_input" autocomplete="off" type="text" name="end_date" id="end_date" value="{$CAMP_END_DATE}" title="" tabindex="0" size="11" maxlength="10">
				<button type="button" id="end_date_trigger" class="btn btn-danger" onclick="return false;" title="{$APP.LBL_ENTER_DATE}"><span class="suitepicon suitepicon-module-calendar" alt="{$APP.LBL_ENTER_DATE}"></span></button>
			</td>
		</tr>
		<!-- END STIC -->	
    ...
    function validate_step1(){
        ...
        fields[0] = 'name'; 
        fields[1] = 'status';
        // STIC-CUSTOM 20220323 MHP - Remove date_end as required field in wizard
        // STIC#664
        // fields[2] = 'end_date';
        {/literal}
        {if $campaign_type == "survey"}
