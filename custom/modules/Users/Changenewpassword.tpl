...
<form action="index.php" method="post" name="ChangePasswordForm" id="ChangePasswordForm"
    ...
    {* STIC-custom 202201 JCH - Mejoras visuales
    STIC#555 *}
    {* <table cellpadding="0" align="center" width="100%" cellspacing="0" border="0"> *}
    <table id="main_table" cellpadding="0" align="center" width="100%" cellspacing="0" border="0">
        {* END STIC *}
        <tr>
            <td>
                <table cellpadding="0" cellspacing="0" border="0" align="center">
                    <tr>
                        ...
                        <td id="company_logo" style="padding-bottom: 10px;">
                            <img src="custom/themes/default/images/company_logo.png" alt="SinergiaCRM" />
                            {* END STIC *}
                        </td>
                    </tr>
                    <tr>
                            ...
                            <table cellpadding="0" cellspacing="2" border="0" align="center" width="100%"
                                ...
                                <tr>
                                    <td colspan="2" width="100%"
                                        style="font-size: 12px; padding-bottom: 5px; font-weight: normal;">
                                        {$INSTRUCTION}</td>
                                </tr>
                                <tr>
                                    <td colspan="2" width="100%"
                                        style="font-size: 12px; padding-bottom: 5px; font-weight: normal; color: red;">
                                        {$ERRORS}</td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td width="30%">
                                        ...
                                        <input type="password" tabindex="2" id="new_password" name="new_password"
                                            value="" {* END STIC *}
                                ...
                                <tr>
                                    ...
                                    <td width="30%">
                                        ...
                                        <input type="password" tabindex="2" id="confirm_pwd" name="confirm_pwd" value=""
                                            onkeyup="password_confirmation();" />
                                        {* END STIC *}
                                        <div id="comfirm_pwd_match" class="error" style="display: none;">
                                            {$MOD.LBL_PASSWORD_MIS_MATCH}</div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>{$CAPTCHA}</td>
