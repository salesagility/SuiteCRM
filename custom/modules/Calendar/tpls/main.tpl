...
{* STIC-Custom 20211015 - Adds the filters TPL, the Javascript file and the Cross to remove filters, if necessary *}
{* STIC#438 *}
{if $filters}
	<input id='applied_filters' type='hidden' value='{$applied_filters}'>
	{sugar_include type="smarty" file=$filters}
	{sugar_getscript file="custom/modules/Calendar/SticUtils.js"}
{/if}
{* END STIC *}
...
{* STIC-Custom 20210927 AAM - Adding Shared Day option
STIC#422  
STIC-Custom 20230811 Adding color to Sessions and FollowUps
STIC#1192 *}
