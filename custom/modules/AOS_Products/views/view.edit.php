...
class CustomAOS_ProductsViewEdit extends AOS_ProductsViewEdit
{
    public function __construct()
    {
        ...
        $this->moduleName = 'AOS_Products';
    }

    public function preDisplay()
    {
        // Hide 'Save and continue' button when is a new Product (editing a bean without id)
        $GLOBALS['sugar_config']['disable_vcr'] = is_null($this->bean) || is_null($this->bean->id);
        parent::preDisplay();
