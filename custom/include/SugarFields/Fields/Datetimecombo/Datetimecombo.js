 ...
 */
// STIC-Custom 20231203 AAM - Setting sensibility (minuteSteps) to 1 when default value is now
// STIC#949
...
function Datetimecombo (datetime, field, timeformat, tabindex, showCheckbox, checked, allowEmptyHM, defaultValue = "") {
	...
	// STIC Custom 20220422 JCH - Allow use custom minute interval in datetimecombo fields
    // STIC#708
...
Datetimecombo.prototype.html = function(callback) {
	...
	// STIC-Custom 20231203 AAM - Setting sensibility (minuteSteps) to 1 when default value is now
	// STIC#949
	// STIC-Custom 20231106 MHP - Setting sensibility (minuteSteps) to 1 when  now is contains in default value
	// STIC#1275	
	...
	var minuteSteps = parseInt(SUGAR.config.stic_datetime_combo_minute_interval); 
