							...
							<div id="subpanel_settings_settings" class="panel-body panel-collapse collapse in">
								...
								<table class='table-responsive'>
									...
									<tr>
										...
										<td>
											<select size="1" name="show_work_calendar" tabindex="102">
												<option value='' {if !$show_work_calendar}selected{/if}>{$MOD.LBL_NO}</option>
												<option value='1' {if $show_work_calendar}selected{/if}>{$MOD.LBL_YES}</option>
											</select>
										</td>
									</tr>
									<tr>
							...
							<div id="subpanel_settings_color" class="panel-body panel-collapse collapse in">
								<table class="table-responsive">
									...
									{foreach from=$activity key=name item=def}
										...
										{else}
											<tr>
												<td>{$def.label_working}</td>
												<td>
													<input type="text" id="{$name}" name="activity[{$name}][body_working]" class="color" value="{$def.body_working}" size="8" />
												</td>
												<td>
													<input type="text" id="{$name}" name="activity[{$name}][border_working]" class="color" value="{$def.border_working}" size="8" />
												</td>
												<td>
													<input type="text" id="{$name}" name="activity[{$name}][text_working]" class="color" value="{$def.text_working}" size="8" />
												</td>
											</tr>
											<tr>
												<td>{$def.label_noworking}</td>
												<td>
													<input type="text" id="{$name}" name="activity[{$name}][body_noworking]" class="color" value="{$def.body_noworking}" size="8" />
												</td>
												<td>
													<input type="text" id="{$name}" name="activity[{$name}][border_noworking]" class="color" value="{$def.border_noworking}" size="8" />
												</td>
												<td>
													<input type="text" id="{$name}" name="activity[{$name}][text_noworking]" class="color" value="{$def.text_noworking}" size="8" />
												</td>
											</tr>											
										{/if}
                                        <!-- STIC-Custom -->
