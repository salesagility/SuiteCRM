        ...
        <div class="mobile-bar">
                        ...
                        {foreach from=$GCLS item=GCL name=gcl key=gcl_key}
                            <li role="presentation">
                                <a id="{$gcl_key}_link" href="{$GCL.URL}" {if !empty($GCL.ONCLICK)} onclick="{$GCL.ONCLICK}"
                                        {/if} {if !empty($GCL.TARGET)} target="{$GCL.TARGET}" {/if}>{$GCL.LABEL}</a>
                                </li>
                            {/foreach}
            ...
            {if $THEME_CONFIG.display_sidebar}
                ...
                <div id='sidebar_container' class="container-fluid sidebar_container">
                    ...
                    <div {if $smarty.cookies.sidebartoggle|default:'' == 'collapsed'}style="display:none" {/if} class="sidebar">
                    ...
                    <div id="favoritesSidebar" class="favoritesSidebar">
                        ...
                        STIC#720
                        *}
                        {include file='custom/themes/SuiteP/tpls/SticUpdateAlert.tpl'}
                        {* END STIC *}
                        {if is_array($favoriteRecords) && count($favoriteRecords) > 0}
