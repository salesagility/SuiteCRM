...
{if $AUTHENTICATED}
    ...
    <footer>
        <div id="copyright_data" class="footer_left">
            <div id="dialog3" title="{$APP.LBL_SINERGIACRM_NONPROFITIZED}" style="display: none">
                <p>{$APP.LBL_SINERGIACRM_NONPROFITIZED_DESC1}</p>
                <br>
                <p>{$APP.LBL_SINERGIACRM_NONPROFITIZED_DESC2}</p>
                <br>
                <p>{$APP.LBL_SINERGIACRM_NONPROFITIZED_DESC3}</p>
                <br>
            </div>
            ...
            <div id="copyrightbuttons">
                <a id="nonprofitized_by">&copy; {$APP.LBL_SINERGIACRM_NONPROFITIZED}</a>
