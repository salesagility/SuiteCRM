...
/*
SinergiaCRM - Since the original cron.php file only works with php-cli and we don't have this environment available in the current SinergiaCRM installations, this SticCron.php file has been created, where we avoid this protection so that the file can be invoked via http (s).
This implies that the cron that call the servers, have to call this file, and not cron.php.
*/
...
// Comment the following lines in order to allow cron execution from URL
