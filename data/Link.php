...
class Link
{
    ...
    public function getQuery($return_as_array = false, $sort_array = [], $deleted = 0, $optional_where = '', $return_join = false, $bean_filter = '', $role = '', $for_subpanels = false)
    {
        $select = '';
        $from = '';
        $join = '';
    ...
    public function getBeans($template, $sort_array = [], $begin_index = 0, $end_index = -1, $deleted = 0, $optional_where = '')
    {
