...
class PackageManagerDisplay
{
     ...
     */
    public static function buildPackageDisplay($form1, $hidden_fields, $form_action, $types = ['module'], $active_form = 'form1', $install = false)
    {
     ...
     * @return string - a string of html which will be used to display the forms
     */
    public function buildPatchDisplay($form1, $hidden_fields, $form_action, $types = ['module'], $active_form = 'form1')
    {
        global $current_language;
        $mod_strings = return_module_language($current_language, 'Administration');
        $ss = new Sugar_Smarty();
    ...
    public static function buildInstalledGrid($mod_strings, $types = ['modules'])
    {
        $descItemsInstalled = $mod_strings['LBL_UW_DESC_MODULES_INSTALLED'];
     ...
     * @param mixed $license_file
     * @param mixed $form_action
     * @param mixed $next_step
     * @param mixed $zipFile
     * @param mixed $type
     * @param mixed $manifest
     * @param mixed $modify_field
     *
     ...
     * @param mixed $install
     * @param mixed $type
     * @param null|mixed $releases
     * @param mixed $types
     * @param mixed $isAlive
     *
     * @return string - the javascript required for the page
     */
    public static function getDisplayScript($install = false, $type = 'module', $releases = null, $types = [], $isAlive = true)
    {
        global $sugar_version, $sugar_config;
        global $current_language;
