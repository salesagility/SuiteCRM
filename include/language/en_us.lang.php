...
$app_strings = array(
    ...
    'DEFAULT' => 'BASIC',  //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    'LBL_SORT' => 'Sort',
    ...
    'LBL_LINK_ACTIONS' => 'ACTIONS', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    ...
    'LBL_COUNTRY' => 'Country:',
    'LBL_CREATE_BUTTON_LABEL' => 'CREATE', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    ...
    'LBL_OR' => 'OR',
    'LBL_PANEL_OVERVIEW' => 'OVERVIEW', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    'LBL_PANEL_ASSIGNMENT' => 'OTHER', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    'LBL_PANEL_ADVANCED' => 'MORE INFORMATION', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
...
"5. Click on the Import option from the Actions menu in the application and choose the file to upload"
   ',
    ...
    'LBL_BULK_ACTION_BUTTON_LABEL' => 'BULK ACTION', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    'LBL_BULK_ACTION_BUTTON_LABEL_MOBILE' => 'ACTION', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
...
$app_strings['LBL_SUITE_DASHBOARD'] = 'SUITECRM DASHBOARD'; //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
...
$app_strings['LBL_SUITE_DASHBOARD_ACTIONS'] = 'ACTIONS'; //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
