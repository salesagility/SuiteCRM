...
$app_strings = array (
  ...
  'LBL_JS_CALENDAR' => 'Календарь' /*for 508 compliance fix*/,
   ...
   'LBL_EMAIL_ADDRESS_BOOK_ADD'			    => 'Готово',
    ...
    'LBL_PORTAL_WELCOME_TITLE' => 'Welcome to Suite Portal',
    'LBL_PORTAL_WELCOME_INFO' => 'Suite Portal is a framework which provides real-time view of cases, bugs & newsletters etc to customers. This is an external facing interface to SuiteCRM that can be deployed within any website.',
    'LBL_LIST' => 'List',
    'LBL_CREATE_CASE' => 'Создать обращение',
