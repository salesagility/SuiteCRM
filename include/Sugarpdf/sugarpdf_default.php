...
$sugarpdf_default = [
    ...
    'PDF_PAGE_FORMAT_LIST' => implode(',', ['4A0', '2A0', 'A0', 'A1', 'A2', 'A3', 'A4', 'A5', 'A6', 'A7', 'A8', 'A9', 'A10',
    ...
    'PDF_ENCODING_TABLE_LIST' => implode(',', ['cp1250', 'cp1251', 'cp1252', 'cp1253', 'cp1254', 'cp1255', 'cp1257',
        'cp1258', 'cp874', 'iso-8859-1', 'iso-8859-2', 'iso-8859-4', 'iso-8859-5',
        'iso-8859-7', 'iso-8859-9', 'iso-8859-11', 'iso-8859-15', 'iso-8859-16',
        'koi8-r', 'koi8-u']),
    'PDF_ENCODING_TABLE_LABEL_LIST' => implode(',', ['cp1250 (Central Europe)', 'cp1251 (Cyrillic)', 'cp1252 (Western Europe)',
