...
class MysqliManager extends MysqlManager
{
    ...
    public function connect(array $configOptions = null, $dieOnError = false)
    {
        ...
        if (!isset($this->database)) {
            ...
            $dbsocket = isset($configOptions['db_unix_socket']) ? $configOptions['db_unix_socket'] : ini_get('mysqli.default_socket');
            $this->database = @mysqli_connect($dbhost, $configOptions['db_user_name'], $configOptions['db_password'],
                isset($configOptions['db_name']) ? $configOptions['db_name'] : '', $dbport, $dbsocket);
            if (empty($this->database)) {
