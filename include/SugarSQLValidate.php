...
class SugarSQLValidate
{
    ...
    public function validateQueryClauses($where, $order_by = '')
    {
        ...
        if (count($parsed['FROM']) != 1 || $parsed['FROM'][0] !== ['table' => 'dummytable', 'alias' => 'dummytable', 'join_type' => 'JOIN', 'ref_type' => '', 'ref_clause' => '', 'base_expr' => false, 'sub_tree' => false]) {
     ...
     * @param mixed $allow_some_subqueries
     *
     * @return bool
     */
     ...
     *
     * @return bool True if column name is deemed safe, false otherwise
     */
