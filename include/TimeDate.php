...
class TimeDate
{
     ...
     *
     * @param DateTime $date
     * @param bool $tz Perform TZ conversion?
     *
     * @return string
     */
     ...
     *
     * @param DateTime|string $date Date in any suitable format
     * @param User $user
     *
     ...
     *
     * @param DateTimeZone|string $name TZ name
     *
     * @return string
     */
     ...
     *
     * @param null|int $ts Null means current ts
     *
     * @return string
     */
