...
class TimeDate
{
    ...
    public function fromUser($date, User $user = null)
    {
        ...
        if (!($res instanceof DateTime)) {
            ...
            // Stic-Custom 20220221 MHP - Change log level to Debug to avoid showing the message in Error log level, 
            ...
            $GLOBALS['log']->debug("fromUser: Conversion of $date from user format $uf failed");
            //END Stic-Custom
