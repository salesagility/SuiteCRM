...
class json_config
{
     ...
     * @param bool $getStrings
     * @param null $module
     * @param null $record
     * @param bool $scheduler
     * @return string
     */
    ...
    public function getAppMetaJSON($scheduler = false)
    {
        ...
        $str .= "\n" . $this->global_registry_var_name . ".config = {\"site_url\":\""
    ...
    public function getFocusData($module, $record)
    {
        ...
        if (empty($module)) {
            ...
            return "\n" . $this->global_registry_var_name . '["focus"] = {"module":"' . $module
                . '",users_arr:[],fields:{"id":"-1"}}' . "\n";
        }
    ...
    public function populateBean(&$focus)
    {
        ...
        // MEETING SPECIFIC
        $all_fields = array_merge($all_fields, array(
            'required',
            'accept_status',
            'name'
        ));
