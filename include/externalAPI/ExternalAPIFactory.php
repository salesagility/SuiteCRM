...
class ExternalAPIFactory
{
    ...
    public static function loadFullAPIList($forceRebuild = false, $ignoreDisabled = false)
    {
        ...
        $optionList = ['supportedModules', 'useAuth', 'requireAuth', 'supportMeetingPassword', 'docSearch', 'authMethod', 'oauthFixed', 'needsUrl', 'canInvite', 'sendsInvites', 'sharingOptions', 'connector', 'oauthParams', 'restrictUploadsByExtension'];
