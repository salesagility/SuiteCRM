    ...
    public function display($showContainer = true, $forceTabless = false)
    {
        ...
        foreach ($tabs as $t => $tab) {
            ...
            if (empty($this->show_tabs)) {
                ...
                $max_min = "<a name=\"$tab\"> </a><span id=\"show_link_".$tab. "current_child_field = '" .$tab."';showSubPanel('".$tab."',null,true,'".$layout_def_key."');document.getElementById('show_link_".$tab."').style.display='none';document.getElementById('hide_link_".$tab."').style.display='';return false;\">"
