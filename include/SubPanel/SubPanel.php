...
class SubPanel
{
    ...
    public $subpanel_define;  // contains the layout_def.php
    public $subpanel_defs;
    public $subpanel_query;
    public $layout_def_key = '';
    public $search_query = '';
    public $collections = [];

    public function __construct($module, $record_id, $subpanel_id, $subpanelDef, $layout_def_key = '', $collections = [])
    {
    ...
    public function getSubPanelDefine($module, $subpanel_id)
    {
        ...
        if (empty($subpanel_define)) {
            echo 'Could not load subpanel definition for: ' . $subpanel_id;
        }
    ...
    public function get_searchdefs($module)
    {
        ...
        if (isset($subpanel_defs['searchdefs'])) {
            ...
            $searchdefs[$module]['templateMeta'] = ['maxColumns' => 3, 'maxColumnsBasic' => 4, 'widths' => ['label' => 10, 'field' => 30]];
    ...
    public function getSearchForm()
    {
        ...
        if ($subpanel_searchMetaData = $this->get_searchdefs($module)) {
            ...
            if (!empty($this->collections)) {
                $searchForm->searchFields['collection'] = [];
            }
