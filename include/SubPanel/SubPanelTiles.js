...
function get_module_name() {
    if (typeof((typeof(window.document.forms['DetailView']) != "undefined" ? window.document.forms['DetailView'] : window.document.forms['EditView'])) == 'undefined') {
        return '';
    } else {
        if (typeof((typeof(window.document.forms['DetailView']) != "undefined" ? window.document.forms['DetailView'] : window.document.forms['EditView']).elements['subpanel_parent_module']) != 'undefined' && (typeof(window.document.forms['DetailView']) != "undefined" ? window.document.forms['DetailView'] : window.document.forms['EditView']).elements['subpanel_parent_module'].value != '') {
            return (typeof(window.document.forms['DetailView']) != "undefined" ? window.document.forms['DetailView'] : window.document.forms['EditView']).elements['subpanel_parent_module'].value;
        }
        return (typeof(window.document.forms['DetailView']) != "undefined" ? window.document.forms['DetailView'] : window.document.forms['EditView']).elements['module'].value;
    }
}
...
function get_record_id() {
    return (typeof(window.document.forms['DetailView']) != "undefined" ? window.document.forms['DetailView'] : window.document.forms['EditView']).elements['record'].value;
}

function get_layout_def_key() {
    if (typeof((typeof(window.document.forms['DetailView']) != "undefined" ? window.document.forms['DetailView'] : window.document.forms['EditView']).elements['layout_def_key']) == 'undefined') return '';
    return (typeof(window.document.forms['DetailView']) != "undefined" ? window.document.forms['DetailView'] : window.document.forms['EditView']).elements['layout_def_key'].value;
}
    ...
    if (force_load || typeof(child_field_loaded[child_field]) == 'undefined') {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                request_id++;
                console.log('PPWK -> list table loaded -> subpanel [#subpanel_' + child_field + '] "list-loaded" event triggered');
                $('#' + 'subpanel_' + child_field).trigger('list-loaded');
            }
        });
    } else {
    ...
    return {
        getLayout: function (asString, ignoreHidden) {
            ...
            var success = function (data) {
                ...
                if (typeof(result) != 'undefined' && result != null && result['status'] == 'dupe') {
                    ...
                    for (var i = 0; i < subPanels.length; i++) {
                        ...
                        console.log('PPWK -> quickcreate form saved -> subpanel [#' + 'subpanel_' + subPanels[i] + '] "form-saved" event triggered');
                        $('#' + 'subpanel_' + subPanels[i]).trigger('form-saved');
                    }
            ...
            function success(data) {
                ...
                console.log('PPWK -> quickcreate form loaded -> subpanel [#' + theDiv + '] "form-loaded" event triggered');
                $('#' + theDiv).trigger('form-loaded');
            }
            ...
            } while (!element.className.split(' ').includes('quickcreate') /*element.className != 'quickcreate'*/ && element.parentNode);
            ...
            console.log('PPWK -> quickcreate form closed -> subpanel [#' + theDiv + '] "form-closed" event triggered');
            $('#' + theDiv).trigger('form-closed');
