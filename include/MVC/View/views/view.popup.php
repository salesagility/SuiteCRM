...
class ViewPopup extends SugarView
{
    ...
    public function display()
    {
        ...
        // Stic-Custom 20220215 MHP - STIC#585
        ...
        {
            require_once $path . $classAndFileName . '.php';
            // Checks if handleSave() method exists
            if (method_exists($classAndFileName,'handleSave')){
                $popupMeta['create'] = array(
                    'formBase' => $popupMeta['moduleMain'] . 'FormBase.php',
                    'formBaseClass' => $popupMeta['moduleMain'] . 'FormBase',
                    'getFormBodyParams' => array(
                        0 => '',
                        1 => '',
                        2 => $popupMeta['moduleMain'] . 'Save',
                    ),
