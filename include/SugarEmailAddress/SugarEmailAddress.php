            ...
            if (empty($this->addresses) || !isset($_REQUEST['massupdate'])) {
                ...
                for ($i = 1; $i <= 10; $i++) {
                    ...
                    if (isset($bean->$email) && !empty($bean->$email)) {
                        ...
                        $this->addAddress($bean->$email, $isPrimary, false, $field_invalid, $field_optOut, null,
                            $field_optIn);
                        $isPrimary = false;
                    }
                }
        ...
        if (isset($_REQUEST) && isset($_REQUEST[$module . '_email_widget_id'])) {
            ...
            while (isset($_REQUEST[$module . $widget_id . "emailAddress" . $widgetCount])) {
                ...
                if (isset($_REQUEST[$eId . 'emailAddressOptInFlag'])) {
                    ...
                    if (isset($_REQUEST[$module . 'emailAddressOptInFlag'])) {
            ...
            if (isset($_REQUEST['full_form']) && !empty($_REQUEST['emailAddressWidget'])) {
                ...
                while (isset($_REQUEST[$key])) {
                    ...
                    $prefillDataArr[] = array(
                        ...
                        'opt_in' => isset($_REQUEST['emailAddressOptInFlag']) && in_array($key,
                                $_REQUEST['emailAddressOptInFlag']),
