...
class SearchForm
{
    ...
    public function __construct($module, &$seedBean, $tpl = null)
    {
        ...
        $this->bean = $seedBean;
        $this->tabs = [['title' => $app_strings['LNK_BASIC_FILTER'],
    ...
    public function setup()
    {
        ...
        if (isset($this->searchFields['current_user_only'], $this->searchFields['current_user_only']['value'])) {
