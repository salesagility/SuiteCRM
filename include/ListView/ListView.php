...
class ListView
{
    ...
    public $local_image_path;
    public $local_current_module;
    public $local_mod_strings;
    public $records_per_page = 20;
    public $xTemplate;
    public $xTemplatePath;
    public $seed_data;
    public $query_where;
    ...
    */
    ...
    public function process_dynamic_listview($source_module, $sugarbean, $subpanel_def)
    {
        ...
        if (isset($_SESSION['validation'])) {
            echo base64_decode('PGEgaHJlZj0naHR0cDovL3d3dy5zdWdhcmNybS5jb20nPlBPV0VSRUQmbmJzcDtCWSZuYnNwO1NVR0FSQ1JNPC9hPg==');
        }
     ...
     * @param mixed $xtemplateSection
     * @param mixed $subpanel_def
    ...
    */
    ...
    public function getBaseURL($html_varName)
    {
        ...
        $blockVariables = ['mass', 'uid', 'massupdate', 'delete', 'merge', 'selectCount', 'current_query_by_page'];
     ...
     * @param unknown $html_varName
     * @param mixed $xtemplateSection
     * @param mixed $current_offset
     * @param mixed $next_offset
     * @param mixed $previous_offset
     * @param mixed $row_count
     * @param null|mixed $sugarbean
     * @param null|mixed $subpanel_def
     * @param mixed $col_count
    ...
    public function loadListFieldDefs(&$subpanel_fields, &$child_focus)
    {
        ...
        for ($i = 0; $i < count($this->list_field_defs); $i++) {
            ...
            if (!empty($list_field['vname'])) {
                ...
                if (isset($list_field['name'], $child_focus->field_defs[$list_field['name']])) {
