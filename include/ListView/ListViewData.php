...
class ListViewData
{
    ...
    public function getAdditionalDetailsAjax($id)
    {
        ...
        // STIC-Custom - 20230707 - PCS - Show additional details in list view with qtip.
        // STIC#1137
        ...
        $infoIcon ='<span class="inline-help glyphicon glyphicon-info-sign data-hasqtip"></span> ';


        $extra = "<span id='adspan_" . $id . "' "
                . "onmouseover=\"lvg_dtails('$id')\" "
                . " style='position: relative;'><!--not_in_theme!-->$infoIcon</span>";
        // END-STIC
