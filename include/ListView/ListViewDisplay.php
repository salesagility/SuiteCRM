...
class ListViewDisplay {
	...
	protected function buildBulkActionButton($loc = 'top') {
		global $app_strings;
		return "<a href='javascript:void(0)' id=\"delete_listview_". $loc ."\" onclick=\"return false;\" class=\"parent-dropdown-handler\"><label class=\"selected-actions-label hidden-mobile\">{$app_strings['LBL_BULK_ACTION_BUTTON_LABEL_MOBILE']}</label><label class=\"selected-actions-label hidden-desktop\">{$app_strings['LBL_BULK_ACTION_BUTTON_LABEL']}</label></a>";
	}
