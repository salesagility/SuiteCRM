...
HTML;
    ...
    public function getElementHTML($contents = '', $textareaId = null, $elementId = 'mozaik', $width = '100%', $thumbs = array(), $tinyMCESetup = 'tinyMCE: {}') {
        if(is_numeric($width)) {
            $width .= 'px';
        }
        if(!$thumbs) {
...
HTML;
    ...
    public function getAllHTML($contents = '', $textareaId = null, $elementId = 'mozaik', $width = '100%', $group = '', $tinyMCESetup = 'tinyMCE: {}') {
        if(is_numeric($width)) {
            $width .= 'px';
        }
