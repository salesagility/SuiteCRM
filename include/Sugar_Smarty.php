...
class Sugar_Smarty extends Smarty
{
    ...
    public function fetch($resource_name, $cache_id = null, $compile_id = null, $display = false)
    {
        ...
        if (strpos($resource_name, "themes" . DIRECTORY_SEPARATOR . $theme_directory) === false) {
            $test_path = SUGAR_PATH . DIRECTORY_SEPARATOR . "themes" . DIRECTORY_SEPARATOR
                . $theme_directory . DIRECTORY_SEPARATOR . $resource_name;
            if (file_exists($test_path)) {
                $resource_name = "themes" . DIRECTORY_SEPARATOR . $theme_directory
