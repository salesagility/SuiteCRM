...
function open_popup(module_name,width,height,initial_filter,close_popup,hide_clear_button,popup_request_data,popup_mode,create,metadata){"use strict";if(typeof(popupCount)==="undefined"||popupCount==0){popupCount=1;}
