...
sugarListView.get_num_selected=function(){let selectCount=$("input[name='selectCount[]']:first");if(selectCount.length>0){return parseInt(selectCount.val().replace("+",""));}
return 0;}
...
sugarListView.prototype.check_item=function(cb,form){debugger;if(cb.checked){sugarListView.update_count(1,true);}else{sugarListView.update_count(-1,true);if(typeof form!='undefined'&&form!=null){sugarListView.prototype.updateUid(cb,form);}}
