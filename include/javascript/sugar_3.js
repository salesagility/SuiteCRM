...
sugarListView.prototype.toggleSelected=function(){var numSelected=sugarListView.get_num_selected();var selectedRecords=document.getElementById("selectedRecordsTop");var selectActions=document.getElementById("actionLinkTop");var selectActionsDisabled=document.getElementById("select_actions_disabled_top");var selectActionsBottom=document.getElementById("actionLinkBottom");var selectActionsDisabledBottom=document.getElementById("select_actions_disabled_bottom");if(numSelected>0){$(selectedRecords).removeAttr("style").addClass("show");$(".selectActionsDisabled").hide();jQuery('ul[name=selectActions]').each(function(){jQuery(this).removeAttr("style").addClass("show");});jQuery('ul[name=selectActionsBottom]').each(function(){jQuery(this).removeAttr("style").addClass("show");});$(selectActionsDisabled).removeAttr("style").removeClass("show");$(selectActionsDisabled).removeAttr("style").addClass("hide");$(selectActionsDisabledBottom).removeAttr("style").removeClass("show");$(selectActionsDisabledBottom).removeAttr("style").addClass("hide");jQuery('div[id=selectActionsDisabled]').each(function(){jQuery(this).removeAttr("style").addClass("hide");});jQuery('div[id=selectActionsDisabledBottom]').each(function(){jQuery(this).removeAttr("style").addClass("hide");});}else{$(selectedRecords).hide();$(selectActions).removeAttr("style").removeClass("show");$(selectActions).removeAttr("style").addClass("hide");$(selectActionsBottom).removeAttr("style").removeClass("show");$(selectActionsBottom).removeAttr("style").addClass("hide");$(".selectActionsDisabled").removeAttr("style").addClass("show");jQuery('ul[name=selectActions]').each(function(){jQuery(this).removeAttr("style").addClass("hide");});jQuery('ul[name=selectActions]').each(function(){jQuery(this).removeAttr("style").addClass("hide");});$(selectActionsDisabled).removeAttr("style").removeClass("hide");$(selectActionsDisabled).removeAttr("style").addClass("show");$(selectActionsDisabledBottom).removeAttr("style").removeClass("hide");$(selectActionsDisabledBottom).removeAttr("style").addClass("show");jQuery('div[id=selectActionsDisabled]').each(function(){jQuery(this).removeAttr("style").addClass("show");});jQuery('div[id=selectActionsDisabledBottom]').each(function(){jQuery(this).removeAttr("style").addClass("show");});}}
