...
var module=module_sugar_grp1;var id=$("input[name=record]").attr("value");if(typeof id == 'undefined'){id=$(form).closest('tr').find('[type=checkbox]').attr( "value" )}var jsonrules='{"rules":[';for(var i=0;i<uniquecheck[formname].length;i++){var ruleName=uniquecheck[formname][i][nameIndex];if(i>0)
