        ...
        getAndRemove: function (el) {
            ...
            go = function () {
                oReturn = function (body, caption, width, theme) {
                    ...
                    var rightTopPosition = 'right top 15';
                    var leftPosition = 'left 0 top';


                    if ($('.sidebar').is(':visible')) {
                        rightTopPosition = 'right top-45';
                        leftPosition = 'left-215 top';
                    }
                    var $dialog = $('<div class="open"></div>').html(body).dialog({
                        autoOpen: false,
                        title: caption,
                        width: 300,
                        position: {my: rightTopPosition, at: leftPosition, of: $(el),}
                    });
                    ...
                    $('#buttontoggle').click(function () {
                        ...
                        $dialog.dialog("option", "position", {my: 'right top', at: 'left top', of: $(el)});
                    });
                    if (show_buttons) {
                        $(".ui-dialog").find('.ui-dialog-titlebar-close').css("display", "none");
                        $(".ui-dialog").find('.ui-dialog-title').css("width", "100%");
