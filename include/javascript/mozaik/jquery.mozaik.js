...
var mozaik = {
    getThumbnailListHTML: function(id, thumbs, base) {
        ...
        html += '<li style="margin-bottom: 8px; padding-bottom: 4px; border-bottom: 1px solid rgb(221, 221, 221);"><h3>'+SUGAR.language.translate('Campaigns', 'LBL_CLICK_TO_ADD')+'</h3></li>';
