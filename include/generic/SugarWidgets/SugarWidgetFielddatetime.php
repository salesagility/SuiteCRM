...
class SugarWidgetFieldDateTime extends SugarWidgetReportField
{
     ...
     *
     * @param bool $timestamp format of return value, if set to true, return unix like timestamp , else a formatted date
     */
    ...
    public function queryOrderBy($layout_def)
    {
        ...
        return parent :: queryOrderBy($layout_def) . "\n";
    }
    ...
    public function displayListPlain($layout_def)
    {
        ...
        if (substr_count($layout_def['type'], 'date') > 0) {
            // if date time field
...
//        }
     ...
     * @param DateTime|string $arg2 2nd arg - value to be converted
     * @param string $op
     * @param string $type
     */
