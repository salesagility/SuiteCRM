...
class SugarWidgetSubPanelRemoveButtonProjects extends SugarWidgetField
{
    ...
    function displayList(&$layout_def)
    {
        ...
        $icon_remove_html = SugarThemeRegistry::current()->getImage('delete_inline', 'align="absmiddle" border="0"',
            null, null, '.gif', '');//setting alt to blank on purpose on subpanels for 508
