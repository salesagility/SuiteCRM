...
class SugarChart
{
     ...
     * @param null|mixed $keycolname1
     * @param mixed $translate1
     * @param null|mixed $keycolname2
     * @param mixed $translate2
     * @param mixed $ifsort2
