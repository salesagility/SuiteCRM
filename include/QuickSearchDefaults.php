...
class QuickSearchDefaults
{
     ...
     * @param $nameKey
     * @param $idKey
     * @param null $billingKey
     * @param null $shippingKey
     * @param null $additionalFields
     * @return array
     */
     ...
     * @param $name
     * @param $idName
     * @return array The JSON format of a QuickSearch definition for the Contacts module
     */
     ...
     * @param string $nameField the name of the field to populate
     * @param string $idField the id of the field to populate
     * @return array
     */
    public function loadQSObject($module, $object, $relationName, $nameField, $idField)
    {
        ...
        if (isset($GLOBALS['dictionary'][$object]['relationships'])
            && array_key_exists($relationName, $GLOBALS['dictionary'][$object]['relationships'])) {
    ...
    {
        $qsScripts = '<script type="text/javascript">sqsWaitGif = "' . SugarThemeRegistry::current()->getImageURL(
                'sqsWait.gif'
            ) . '";</script>
    ...
    {
        $qsScriptsJSONAlreadyDefined = '<script type="text/javascript">sqsWaitGif = "' . SugarThemeRegistry::current()
                ->getImageURL('sqsWait.gif') . '";</script><script type="text/javascript" src="' . getJSPath(
