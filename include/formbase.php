 ...
 * @param $prefix string the prefix of value to be checked
...
function buildRedirectURL($return_id = '', $return_module = '')
{
    ...
    if (!isset($isDuplicate) || !$isDuplicate) {
        $url = "index.php?action=$return_action&module=$return_module&record=$return_id&return_module=" .
            "$return_module&return_action=$return_action{$add}";
        ...
        $standard = "action=$return_action&module=$return_module&record=$return_id&isDuplicate=true&return_module=" .
            "$return_module&return_action=$return_action&status=$status";
