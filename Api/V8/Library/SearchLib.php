...
class SearchLib
{
    ...
    public $additionalDetailsFieldToAdd = 'NAME';
    public $returnData = array();

    public $mergeDisplayColumns = false;

    public function getSearchResults($userId)
    {
    ...
    public function doSearchBasic($userId, $queryString)
    {
    ...
    public function setVariableName($baseName, $where, $listviewName = null)
    {
    ...
    public function getListViewData($seed, $where, $offset = -1, $limit = -1, $filter_fields = array(), $params = array(), $id_field = 'id', $singleSelect = true)
    {
        global $current_user;
...
*/
    ...
    public function setup($seed, $file, $where, $params = array(), $offset = 0, $limit = -1,  $filter_fields = array(), $id_field = 'id')
    {
        $this->should_process = true;
    ...
    public function doSearchAdvanced($userId, $queryString, $start = 0, $amount = 20)
    {
    ...
    public function doSearch($queryString, $currentUser, $start, $amount)
    {
        $index = \BeanFactory::getBean('AOD_Index')->getIndex();
    ...
    public function getRecordSummary(SugarBean $bean)
    {
        global $listViewDefs;
    ...
    public function cacheQuery($queryString, $resArray)
    {
