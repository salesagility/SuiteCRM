...
$dictionary['linked_documents'] = ['table' => 'linked_documents', 'fields' => [
    ['name' => 'id', 'type' => 'varchar', 'len' => '36'], ['name' => 'parent_id', 'type' => 'varchar', 'len' => '36'], ['name' => 'parent_type', 'type' => 'varchar', 'len' => '25'], ['name' => 'document_id', 'type' => 'varchar', 'len' => '36'], ['name' => 'document_revision_id', 'type' => 'varchar', 'len' => '36'], ['name' => 'date_modified', 'type' => 'datetime'], ['name' => 'deleted', 'type' => 'bool', 'len' => '1', 'default' => '0', 'required' => false]
], 'indices' => [
