...
'help'=>array(
	...
	'studioWizard'=>array(
		...
		'viewBtnDashlet' => 'Customize the module\'s <b>Suite Dashlet</b>, including the Suite Dashlet\'s ListView and Search.<br><br>The Suite Dashlet will be available to add to the pages in the Home module.',
	    ...
	    'dashletHelp' =>'The <b>Suite Dashlet</b> layouts that can be customized appear here.<br><br>The Suite Dashlet will be available to add to the pages in the Home module.',
	    'DashletListViewBtn' =>'The <b>Suite Dashlet ListView</b> displays records based on the Suite Dashlet search filters.',
	    'DashletSearchViewBtn' =>'The <b>Suite Dashlet Search</b> filters records for the Suite Dashlet listview.',
...
'LBL_CUSTOM' => 'Custom',
'LBL_DASHLET'=>'Suite Dashlet',
'LBL_DASHLETLISTVIEW'=>'Suite Dashlet ListView',
'LBL_DASHLETSEARCH'=>'Suite Dashlet Search',
'LBL_POPUP'=>'PopupView',
'LBL_POPUPLIST'=>'Popup ListView',
'LBL_POPUPLISTVIEW'=>'Popup ListView',
'LBL_POPUPSEARCH'=>'Popup Search',
'LBL_DASHLETSEARCHVIEW'=>'Suite Dashlet Search',
