	...
	ModuleBuilder = {
		...
		submitForm: function(formname, successCall){
			...
			if (typeof(successCall) == 'undefined') {
				...
				//Fix for issue #1091: check if action is not clone. This condition is for 'Add Field' button.
				...
				//Fix for issue #1091: This condition is for ListView
				} else if (typeof document.popup_form == 'undefined') {
