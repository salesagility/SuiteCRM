...
class ViewResetmodule extends SugarView
{
    function display()
    {
        ...
        $ajax->addCrumb(translate($moduleName),
    ...
    function handleSave()
    {
        ...
        $ajax->addCrumb(translate('LBL_STUDIO'), 'ModuleBuilder.main("studio")');
        $ajax->addCrumb(translate($this->module),
            'ModuleBuilder.getContent("module=ModuleBuilder&action=wizard&view_module=' . $this->module . '")');
