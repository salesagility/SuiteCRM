...
class ViewRelationship extends SugarView
{
    ...
    public function display()
    {
        ...
        $cardinality = [MB_ONETOONE => translate('LBL_ONETOONE'), MB_ONETOMANY => translate('LBL_ONETOMANY'), MB_MANYTOONE => translate('LBL_MANYTOONE'), MB_MANYTOMANY => translate('LBL_MANYTOMANY')];
        ...
        if (empty($_REQUEST['relationship_name'])) {
            ...
            if (isset($definition['lhs_module']) && $definition['lhs_module'] == 'Campaigns') {
                unset($cardinality[MB_MANYTOMANY], $cardinality[MB_ONETOMANY]);
            }
            if (isset($definition['rhs_module']) && $definition['rhs_module'] == 'Campaigns' && isset($cardinality[MB_MANYTOMANY])) {
                unset($cardinality[MB_MANYTOMANY], $cardinality[MB_MANYTOONE]);
            }
