...
class ViewRelationship extends SugarView
{
    function display()
    {
        ...
        switch ($relationship->relationship_type) {
            ...
            case MB_ONETOMANY :
                ...
                if (!empty ($relationship->relationship_role_column_value)) {
                    $this->smarty->assign('relationship_role_column_value',
                        $relationship->relationship_role_column_value);
                }
                break;
            case MB_MANYTOMANY :
                if (!empty ($relationship->relationship_role_column_value)) {
        ...
        if (isset ($_REQUEST ['json']) && $_REQUEST ['json'] == 'false') {
            ...
            $ac->addSection('east', $module->name . ' ' . $GLOBALS ['mod_strings'] ['LBL_RELATIONSHIPS'],
                $this->smarty->fetch('modules/ModuleBuilder/tpls/studioRelationship.tpl'));
