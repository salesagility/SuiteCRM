    ...
    function fetch(
        ...
        */
        ...
        if (empty($_REQUEST['view_package']) || $_REQUEST['view_package'] == 'studio') {
            ...
            $GLOBALS['log']->warn('view.modulefield: hidelevel ' . $fv->ss->get_template_vars('hideLevel') . " " . print_r($vardef,
                    true));
            ...
            if (empty($vardef['name'])) {
                ...
                if (!empty($module->mbvardefs->vardef['fields'][$vardef['name']])) {
                    ...
                    $fv->ss->assign('hideLevel',
                        3); // tyoung bug 17350 - effectively mark template derived fields as readonly
                }
            }
