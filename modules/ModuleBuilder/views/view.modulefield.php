...
class ViewModulefield extends SugarView
{
        ...
        )
    {
		...
		*/
		...
		//if (isset($field_types['encrypt']))	/* Undo removal of encrypted fields feature which occurred in Sugar 6.3 */
		//  unset($field_types['encrypt']);	/*Chris Coleman, ESPACEnetworks.com */
