...
//    }
    ...
    function display(
        ...
        if ($preview) {
            ...
            $ajax->addSection('center', translate('LBL_POPUP'),
    ...
    function constructAjax()
    {
        ...
        if ($this->fromModuleBuilder) {
            ...
            $ajax->addCrumb(translate('LBL_POPUP', 'ModuleBuilder'),
                'ModuleBuilder.getContent("module=ModuleBuilder&action=wizard&view=popup&MB=1&view_package=' . $this->editPackage . '&view_module=' . $this->editModule . '")');
            ...
            $ajax->addCrumb(translate('LBL_POPUP', 'ModuleBuilder'),
                'ModuleBuilder.getContent("module=ModuleBuilder&action=wizard&view=popup&view_module=' . $this->editModule . '")');
            $ViewLabel = ($this->editLayout == MB_POPUPLIST) ? 'LBL_POPUPLISTVIEW' : 'LBL_POPUPSEARCH';
            $ajax->addCrumb(translate($ViewLabel, 'ModuleBuilder'), '');
        }
