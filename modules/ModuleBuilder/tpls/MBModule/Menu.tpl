...
if(ACLController::checkAccess('{$moduleName}', 'edit', true)){literal}{{/literal}
    $module_menu[]=array('index.php?module={$moduleName}&action=EditView&return_module={$moduleName}&return_action=DetailView', $mod_strings['LNK_NEW_RECORD'], 'Create{$moduleName}', '{$moduleName}');
{literal}}{/literal}
{if $showvCard}if(ACLController::checkAccess('{$moduleName}', 'edit', true)){literal}{{/literal}
    $module_menu[]=array('index.php?module={$moduleName}&action=ImportVCard', $mod_strings['LNK_IMPORT_VCARD'], 'Create{$moduleName}', '{$moduleName}');
{literal}}{/literal}{/if}
if(ACLController::checkAccess('{$moduleName}', 'list', true)){literal}{{/literal}
    $module_menu[]=array('index.php?module={$moduleName}&action=index&return_module={$moduleName}&return_action=DetailView', $mod_strings['LNK_LIST'],'{$moduleName}', '{$moduleName}');
{literal}}{/literal}
