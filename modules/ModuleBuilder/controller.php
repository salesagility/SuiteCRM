...
class ModuleBuilderController extends SugarController
{
    ...
    public function action_SaveField()
    {
        ...
        if (!isset($_REQUEST['view_package'])) {
            ...
            if (!empty($_REQUEST['view_module'])) {
                ...
                $repair->repairAndClearAll(['rebuildExtensions', 'clearVardefs', 'clearTpls'], [$class_name], true, false);
                if ($module == 'Users') {
                    $repair->repairAndClearAll(['rebuildExtensions', 'clearVardefs', 'clearTpls'], ['Employee'], true, false);
                }
            ...
            $module = &$mb->getPackageModule($_REQUEST['view_package'], $_REQUEST['view_module']);
            if (isset($_REQUEST['label'], $_REQUEST['labelValue'])) {
    ...
    public function action_saveSugarField()
    {
        ...
        $repair = new RepairAndClear();
        $repair->repairAndClearAll(['clearVardefs', 'clearTpls'], [$class_name], true, false);
        //#28707 ,clear all the js files in cache
        $repair->module_list = [];
        $repair->clearJsFiles();
    ...
    public function action_DeleteField()
    {
        ...
        if (isset($GLOBALS['current_language'], $_REQUEST['label'], $_REQUEST['labelValue'], $_REQUEST['view_module'])
                  ) {
    ...
    public function action_savetablesort()
    {
        ...
        if (!empty($current_user) && isset($_REQUEST['column'], $_REQUEST['direction'])) {
