...
class ParserDropDown extends ModuleBuilderParser
{
    ...
    function saveDropDown($params)
    {
        ...
        $list_value = str_replace('&quot;&quot;:&quot;&quot;', '&quot;__empty__&quot;:&quot;&quot;',
            $params['list_value']);
        ...
        if (is_array($temp)) {
            foreach ($temp as $item) {
                $dropdown[SugarCleaner::stripTags(from_html($item [0]),
                    false)] = SugarCleaner::stripTags(from_html($item [1]), false);
            }
        }
        ...
        if ($type != 'studio') {
            ...
            if (!empty($params['use_push'])) {
                ...
                foreach ($dropdown as $key => $value) {
                    ...
                    if (!isset($my_list_strings[$dropdown_name][$key]) || strcmp($my_list_strings[$dropdown_name][$key],
                            $value) != 0
                    ) {
