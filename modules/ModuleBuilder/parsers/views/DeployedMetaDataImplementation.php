...
class DeployedMetaDataImplementation extends AbstractMetaDataImplementation implements MetaDataImplementationInterface
{
        ...
        if ($loaded === null) {
            switch ($view) {
                case MB_QUICKCREATE:
                    ...
                    $loaded = $this->_loadFromFile($this->getFileName(MB_EDITVIEW, $this->_moduleName,
                        MB_BASEMETADATALOCATION));
                    ...
                    $this->_sourceFilename = $this->getFileName(MB_QUICKCREATE, $this->_moduleName,
                        MB_CUSTOMMETADATALOCATION);
    ...
    function save($defs)
    {
        ...
        if ($this->_sourceFilename == $this->getFileName($this->_view, $this->_moduleName,
                MB_HISTORYMETADATALOCATION)
        ) {
        ...
        $GLOBALS ['log']->debug(get_class($this) . "->save(): writing to " . $this->getFileName($this->_view,
                $this->_moduleName, MB_WORKINGMETADATALOCATION));
