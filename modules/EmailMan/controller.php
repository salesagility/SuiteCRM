...
class EmailManController extends SugarController
{
    public function action_Save()
    {
        ...
        $configurator->config['email_enable_confirm_opt_in'] = isset($_REQUEST['email_enable_confirm_opt_in']) ? $_REQUEST['email_enable_confirm_opt_in'] : '';
        $configurator->config['email_enable_auto_send_opt_in'] = (isset($_REQUEST['email_enable_auto_send_opt_in'])) ? true : false;
        $configurator->config['email_confirm_opt_in_email_template_id'] = isset($_REQUEST['email_confirm_opt_in_email_template_id']) ? $_REQUEST['email_confirm_opt_in_email_template_id'] : $configurator->config['aop']['confirm_opt_in_template_id'];
        ///////////////////////////////////////////////////////////////////////////////
        ////	SECURITY
        $security = array();
