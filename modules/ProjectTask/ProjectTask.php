...
class ProjectTask extends SugarBean
{
    ...
    function get_list_view_data()
    {
        ...
        $today = $timedate->handle_offset(date($GLOBALS['timedate']->get_db_date_time_format(), time()),
            $timedate->dbDayFormat, true);
        ...
        */
        ...
        $task_fields['CONTACT_NAME'] = $locale->getLocaleFormattedName($task_fields["FIRST_NAME"],
            $task_fields["LAST_NAME"]);
        $task_fields['TITLE'] = '';
