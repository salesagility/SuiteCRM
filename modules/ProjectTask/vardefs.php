...
$dictionary['ProjectTask'] = array('audited'=>true,
	...
	'fields' => array(
        ...
        'predecessors' => array(
            ...
            'required' => false,
            'type' => 'enum',
            'function' => array('name'=>'actionGetPredecessors',
                'returns'=>'html', 'include'=>'modules/ProjectTask/ProjectTask.php'),
			),
        'date_start' => array(
            'name' => 'date_start',
	  ...
	  array (
		...
		'utilization' => array(
    		...
    		'function' => array('name'=>'getUtilizationDropdown', 'returns'=>'html',
