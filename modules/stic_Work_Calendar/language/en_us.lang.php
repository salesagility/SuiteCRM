...
$mod_strings = array (
  ...
  'LBL_LIST_FORM_TITLE' => 'List of Work calendar',
  'LBL_MODULE_NAME' => 'Work Calendar',
  'LBL_MODULE_TITLE' => 'Work Calendar',
  'LBL_HOMEPAGE_TITLE' => 'My Work calendar',
  'LNK_NEW_RECORD' => 'Create a Work calendar',
  'LNK_LIST' => 'View Work calendar',
  'LNK_IMPORT_STIC_WORK_CALENDAR' => 'Import Work calendar',
  'LBL_SEARCH_FORM_TITLE' => 'Search Work calendar',
  ...
  'LBL_END_DATE_EXCEEDS_24_HOURS' => 'The difference between start and end must be less than 24 hours.',  
  'LBL_INCOMPATIBLE_TYPE_WITH_EXISTING_RECORDS' => 'There is at least one record with incompatible type with the current one for the same user and time range. Review it and make the appropriate changes.',
  'LBL_ERROR_REQUEST_INCOMPATIBLE_TYPE' => 'An error occurred while checking for work calendar records that are incompatible with the record being created. Ask your administrator.',
  'LBL_ERROR_CODE_REQUEST_INCOMPATIBLE_TYPE' => 'Error code: ',
  'LBL_DURATION' => 'Duration',
  'LBL_WEEKDAY' => 'Weekday',  
  'LBL_DEFAULT_PANEL' => 'Overview',
  'LBL_PANEL_RECORD_DETAILS' => 'Record details',
  'LBL_ALL_DAY_HELP' => 'If the type of registration is neither working nor punctual absence, the record will take the whole day so there is no need to indicate the start time or the end date and time, which will be determined automatically.',
  ...
  'LBL_PERIODIC_WORK_CALENDAR_TITLE' => 'Generate Work calendar',
  ...
  'LBL_MASS_UPDATE_VALIDATION_TEXT' => 'The following validations that are applied in the usual edit view will not apply right now:',
  'LBL_MASS_UPDATE_VALIDATION_1' => 'Check that start date and time is before the end date and time.',
  'LBL_MASS_UPDATE_VALIDATION_2' => 'Check that the duration is not longer than 24 hours.',
  'LBL_MASS_UPDATE_VALIDATION_3' => 'Check that there are no previously created records with incompatible types that may overlap the newly created ones.',
