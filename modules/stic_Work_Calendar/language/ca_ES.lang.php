...
$mod_strings = array (
  ...
  'LBL_LIST_FORM_TITLE' => 'Llista de Calendari laboral',
  'LBL_MODULE_NAME' => 'Calendari laboral',
  'LBL_MODULE_TITLE' => 'Calendari laboral',
  'LBL_HOMEPAGE_TITLE' => 'El meu Calendari laboral',
  'LNK_NEW_RECORD' => 'Crea un Calendari laboral',
  'LNK_LIST' => 'Mostra el Calendari laboral',
  'LNK_IMPORT_STIC_WORK_CALENDAR' => 'Importa Calendari laboral',
  'LBL_SEARCH_FORM_TITLE' => 'Cerca el Calendari laboral',
  'LBL_HISTORY_SUBPANEL_TITLE' => 'Historial',
  'LBL_ACTIVITIES_SUBPANEL_TITLE' => 'Activitats',
  'LBL_STIC_WORK_CALENDAR_SUBPANEL_TITLE' => 'Calendari laboral',
  'LBL_NEW_FORM_TITLE' => 'Nou Calendari laboral',
  'LBL_TYPE' => 'Tipus',  
  'LBL_START_DATE' => "Data i hora d'inici",
  ...
  'LBL_END_DATE_EXCEEDS_24_HOURS' => "La diferència entre l'inici i la finalització ha de ser inferior a 24 hores.",    
  'LBL_INCOMPATIBLE_TYPE_WITH_EXISTING_RECORDS' => "Hi ha almenys un registre de tipus incompatible amb l'actual per al mateix usuari i rang horari. Reviseu-ho i feu les modificacions oportunes.",
  'LBL_ERROR_REQUEST_INCOMPATIBLE_TYPE' => "S'ha produït un error al comprovar l'existència de registres de calendari laboral incompatibles amb el registre que s'està creant. Consulteu l'administrador.",
  'LBL_ERROR_CODE_REQUEST_INCOMPATIBLE_TYPE' => "Codi d'error: ",  
  'LBL_DURATION' => 'Durada',
  'LBL_WEEKDAY' => 'Día de la setmana',  
  'LBL_DEFAULT_PANEL' => 'Dades generals',
  'LBL_PANEL_RECORD_DETAILS' => 'Detalls del registre',
  'LBL_ALL_DAY_HELP' => "En cas que el tipus de registre no sigui ni laborable ni absència puntual, el registre afectarà tot el dia i no caldrà indicar l'hora d'inici ni la data i hora de finalització, que es determinaran automàticament.",

  // Assistent de creació de registres de Calendari laboral
  'LNK_CREATE_PERIODIC_RECORDS' => 'Crea registres periòdics',
  'LBL_PERIODIC_WORK_CALENDAR_BUTTON' => 'Genera el Calendari laboral', 
  ...
  'LBL_TIME_START' => "Data i hora d'inici del primer registre",
  'LBL_TIME_FINAL' => 'Data i hora final del primer registre',
  'LBL_PERIODIC_WORK_CALENDAR_TITLE' => 'Genera el Calendari laboral',
  'LBL_WORK_CALENDAR_DURATION' => 'Durada del registre de Calendari laboral',
  'LBL_ERROR_IN_VALIDATION' => 'Hi ha un error al valor indicat al camp Data i hora de finalització.',
  'LBL_END_DATE_ERROR' => "La data i hora de finalització ha de ser posterior a la data i hora d'inici.",
  ...
  'LBL_MASS_UPDATE_DATES_BUTTON_TITTLE' => "Actualitza l'hora d'inici i de finalització",
  ...
  'LBL_MASS_UPDATE_VALIDATION_TEXT' => "En aquest procés no s'apliquen les següents validacions que sí que s'apliquen a la vista d'edició convencional:",
  'LBL_MASS_UPDATE_VALIDATION_1' => "Comprovació que la data i hora d'inici sigui anterior a la data i hora de finalització.",
  'LBL_MASS_UPDATE_VALIDATION_2' => 'Comprovació que la durada no sigui superior a 24 hores.',
  'LBL_MASS_UPDATE_VALIDATION_3' => 'Comprovació que no existeixin registres creats prèviament amb tipus incompatibles i que se solapin amb els de nova creació.',
  'LBL_MASS_UPDATE_TEXT' => 'Indiqueu el valor que voleu sumar, restar o assignar a un o a ambdós camps: ',  
