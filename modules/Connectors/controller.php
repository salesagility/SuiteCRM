...
{
    public $admin_actions = ['ConnectorSettings', 'DisplayProperties', 'MappingProperties', 'ModifyMapping', 'ModifyDisplay', 'ModifyProperties',
    ...
    public function action_RetrieveSourceDetails()
    {
        ...
        $retArray['body'] = !empty($str) ? str_replace(["\rn", "\r", "\n"], ['', '', '<br />'], $str) : $GLOBALS['mod_strings']['ERROR_NO_ADDITIONAL_DETAIL'];
    ...
    public function action_CallConnectorFunc()
    {
        ...
        if (!empty($_REQUEST['source_id'])) {
            ...
            if (method_exists($source, $method)) {
                ...
                echo $json->encode(['error' => true, 'errorMessage' => 'Could Not Find Function: ' . $method . ' in class: ' . get_class($source)]);
            }
        } else {
