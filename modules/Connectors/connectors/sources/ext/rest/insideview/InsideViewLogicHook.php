    ...
    public function showFrame($event, $args)
    {
        ...
        if ($url != '') {
            ...
            if ($GLOBALS['current_user']->getPreference('allowInsideView', 'Connectors') != 1) {
                ...
                //echo "<div id='insideViewDiv' style='width:100%;height:400px;overflow:hidden'><iframe id='insideViewFrame' src='$url' style='border:0; width:100%;height:480px;overflow:hidden'></iframe></div>";
            }
