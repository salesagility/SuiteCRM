...
if(ACLController::checkAccess('AOS_Contracts', 'list', true))$module_menu[]=Array("index.php?module=AOS_Contracts&action=index&return_module=AOS_Contracts&return_action=DetailView", $mod_strings['LNK_LIST'],"AOS_Contracts", 'List');
