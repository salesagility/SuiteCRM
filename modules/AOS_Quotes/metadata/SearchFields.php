...
$searchFields['AOS_Quotes'] =
    [
        ...
        'range_expiration' => ['query_type' => 'default', 'enable_range_search' => true, 'is_date_field' => true],
        'start_range_expiration' => ['query_type' => 'default',  'enable_range_search' => true, 'is_date_field' => true],
        'end_range_expiration' => ['query_type' => 'default', 'enable_range_search' => true, 'is_date_field' => true],
    ];
