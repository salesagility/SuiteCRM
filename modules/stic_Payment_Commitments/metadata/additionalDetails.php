...
function additionalDetailsstic_Payment_Commitments($fields, SugarBean $bean = null, $params = array())
{
    if (file_exists('custom/modules/' . $bean->module_name . '/metadata/customAdditionalDetails.php')) {
        ...
        return customAdditionalDetails::customAdditionalDetailsstic_Payment_Commitments($fields, $bean, $mod_strings);
