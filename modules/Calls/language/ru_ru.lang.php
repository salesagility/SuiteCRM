...
'LBL_SYNCED_RECURRING_MSG' => 'Данный звонок был создан в другой программе и синхронизирован с SuiteCRM. Для изменения данной записи откройте первоначальную программу, внесите в соответствующий звонок необходимые изменения и вновь синхронизируйте его с SuiteCRM.',
'LBL_RELATED_TO' => 'Относится к:',
