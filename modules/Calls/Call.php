...
class Call extends SugarBean
{
    ...
    public $users_arr;
    public $leads_arr;
    public $default_call_name_values = array(
        'Assemble catalogs',
    ...
    function get_list_view_data()
    {
        ...
        if ($this->status == "Planned") {
            ...
            if ($this->ACLAccess('edit')) {
                $call_fields['SET_COMPLETE'] = $setCompleteUrl . SugarThemeRegistry::current()->getImage("close_inline",
    ...
    function set_notification_body($xtpl, $call)
    {
        ...
        $xOffset = $timedate->asUser($calldate, $notifyUser) . ' ' . $timedate->userTimezoneSuffix($calldate,
                $notifyUser);
        ...
        $xtpl->assign("CALL_STATUS",
            ((isset($call->status)) ? $app_list_strings['call_status_dom'][$call->status] : ""));
