...
class SugarMerge
{
     ...
     *
     * @param array|bool $merge - do we wish to perform the merge if false it will just return a list of files that can be merged.  If an array is passed, only those modules present in the array will be merged.
     * @param bool $save - do we wish to save the merged files to true - $merge must be true for this to apply - otherwise it will simulate merging so you can view the log files of the merge
     * @param bool $logHistory - do we wish to create history entries for any of the merges
     *
     ...
     * @param bool $merge - do we wish to perform the merge if false it will just return a list of files that can be merged
     * @param bool $save - do we wish to save the merged files to true - $merge must be true for this to apply - otherwise it will simulate merging so you can view the log files of the merge
     * @param bool $logHistory - do we wish to create history entries for any of the merges
     *
     ...
     * @param mixed $logHistory
     *
     * @return bool - success or failure of the merge
     */
