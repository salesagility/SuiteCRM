...
$mod_strings = array(
    ...
    'LBL_UW_START_DESC2' => 'Note: We highly recommend that you create a copy of the SuiteCRM instance you use in production, and test the upgrade package before deploying the new version to production. After the upgrade process has completed, please run <pre>composer update</pre> to ensure that you all the latest.',
