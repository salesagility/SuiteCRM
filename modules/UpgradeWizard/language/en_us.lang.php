...
$mod_strings = array(
    ...
    'LBL_UW_START_DESC2' => 'Note: We recommend that you backup the SuiteCRM database and the system files (all of the files in the SuiteCRM folder) before upgrading your production system. We highly recommend that you perform a test upgrade on a cloned instance of your production system first. You may also need to run "composer update" if you have customised the composer.json file',
