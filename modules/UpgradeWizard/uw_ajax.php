...
function preflightCheckJsonFindUpgradeFiles($persistence)
{
    ...
    $persistence['upgrade_files'] = uwFindAllFiles(clean_path("$unzip_dir/$zip_from_dir"), array(), true, array(),
        true);
...
function preflightCheckJsonGetSchemaErrors($persistence)
{
    ...
    if (isset($persistence['sql_errors'])) //unset($persistence['sql_errors']);
