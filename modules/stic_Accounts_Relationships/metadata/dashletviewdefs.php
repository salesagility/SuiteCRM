...
$dashletData['stic_Accounts_RelationshipsDashlet']['searchFields'] = array(
    'name' => array('default' => ''),
    'stic_accounts_relationships_accounts_name' => array('default' => ''),
    'relationship_type' => array('default' => ''),
    'start_date' => array('default' => ''),
    'end_date' => array('default' => ''),
    'stic_accounts_relationships_project_name' => array('default' => ''),
    'assigned_user_id' => array('type' => 'assigned_user_name',
        'default' => $current_user->name),
);

$dashletData['stic_Accounts_RelationshipsDashlet']['columns'] =
array(
    'NAME' => array(
        'width' => '32%',
        'label' => 'LBL_NAME',
