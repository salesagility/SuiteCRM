...
<form name="ConfigureSettings" enctype='multipart/form-data' method="POST" action="index.php"
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="0" class="edit view">
        ...
        <tr>
            <td width="25%" scope="row" valign='middle'>{$MOD.LBL_SKYPEOUT_ON}
                &nbsp{sugar_help text=$MOD.LBL_SKYPEOUT_ON_DESC WIDTH=400}</td>
            ...
            {/if}
            <td width="75%" align="left" valign='middle'><input type='hidden' name='system_skypeout_on' value='0'><input
                        name="system_skypeout_on" value="1" class="checkbox" tabindex='1'
                        type="checkbox" {$system_skypeout_on_checked}></td>
        </tr>
    </table>
