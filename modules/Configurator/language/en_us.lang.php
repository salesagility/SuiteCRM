...
//	'EXPORT_DELIMITER' => 'Export Delimiter',
	...
	'LBL_MAILMERGE_DESC' => 'This flag should be checked only if you have the SuiteCRM Plug-in for Microsoft&reg; Word&reg;.',
...
To configure additional system settings, click <a href="index.php?module=Administration&action=index" target="_blank">here</a>.',
    ...
    'LBL_MOBILE_MOD_REPORTS_RESTRICTION' => '* The Reports module is only available for the SuiteCRM Mobile iPhone client.',
    ...
    'LBL_MOBILE_MOD_REPORTS_RESTRICTION' => '* The Reports module is only available for the SuiteCRM Mobile native clients',
