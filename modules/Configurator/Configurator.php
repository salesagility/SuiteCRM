...
class Configurator
{
    ...
    public function getConfirmOptInEnumValue()
    {
        ...
        return isset($this->config['email_enable_confirm_opt_in']) ? $this->config['email_enable_confirm_opt_in'] : SugarEmailAddress::COI_STAT_DISABLED;
    }
}
