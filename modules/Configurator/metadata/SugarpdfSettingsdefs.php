...
$SugarpdfSettings = array(
    ...
    "sugarpdf_pdf_protection" => array(
        ...
        "selectList" => array(
            ...
            "modify" => "Modify",
            "copy" => "Copy",
            "annot-forms" => "Annotations and forms"
        ),
    ),
...
if (@getimagesize($logo) === false) {
    $SugarpdfSettings['sugarpdf_pdf_header_logo']['path'] = K_PATH_IMAGES .
        $SugarpdfSettings['sugarpdf_pdf_header_logo']['value'];
}
if (@getimagesize($small_logo) === false) {
    $SugarpdfSettings['sugarpdf_pdf_small_header_logo']['path'] = K_PATH_IMAGES .
        $SugarpdfSettings['sugarpdf_pdf_small_header_logo']['value'];
}
