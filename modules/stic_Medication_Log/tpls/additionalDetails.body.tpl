...
{/if}
{if !empty($FIELD.STIC_MEDICATION_LOG_STIC_PRESCRIPTIONSTIC_PRESCRIPTION_IDA)}
    <div>
        <strong>{$PARAM.LBL_STIC_MEDICATION_LOG_STIC_PRESCRIPTION_FROM_STIC_PRESCRIPTION_TITLE}</strong>
        <a href="index.php?module=stic_Prescription&action=DetailView&record={$FIELD.STIC_MEDICATION_LOG_STIC_PRESCRIPTIONSTIC_PRESCRIPTION_IDA}">{$FIELD.STIC_MEDICATION_LOG_STIC_PRESCRIPTION_NAME}</a>
    </div>
{/if}
...
{/if}
{if !empty($FIELD.DESCRIPTION) 
    || !empty($FIELD.STIC_MEDICATION_LOG_STIC_PRESCRIPTIONSTIC_PRESCRIPTION_IDA) 
    || !empty($FIELD.TIME) 
