...
function additionalDetailsstic_Group_Opportunities($fields, SugarBean $bean = null, $params = array())
{
    ...
    if (file_exists('custom/modules/' . $bean->module_name . '/metadata/customAdditionalDetails.php')) {
        ...
        return customAdditionalDetails::customAdditionalDetailsstic_Group_Opportunities($fields, $bean, $mod_strings);
