...
class Reminder extends Basic
{
     ...
     * @param bool $checkDecline (optional) Send email if user accept status is not decline. Default is TRUE.
     */
     ...
     * @param mixed $oldReminderEmailSent
     */
