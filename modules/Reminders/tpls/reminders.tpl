...
<div style="display:none;">
    ...
    {if !$REMINDERS_DISABLED}
        <div id="reminder_template">
            ...
            <div class="btns">
                <input class="add-btn" type="button" value="{$MOD.LBL_REMINDERS_ADD_ALL_INVITEES}"
                       onclick="Reminders.onAddAllClick(this);">
                <input class="remove-reminder-btn remove-btn" type="button" value="{$MOD.LBL_REMINDERS_REMOVE_REMINDER}"
...
<div id="reminders">
                        ...
                        <ul class="invitees_list disabled">
                            {foreach from=$reminder.invitees item=invitee}
                                <li class="invitees_item">
                                    <button class="invitee_btn" data-invitee-id="{$invitees.id}"
    ...
    {if !$REMINDERS_DISABLED}
        <input id="reminder_add_btn" class="add-btn" type="button" value="{$MOD.LBL_REMINDERS_ADD_REMINDER}"
