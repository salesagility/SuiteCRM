...
class RemindersController extends SugarController
{
    ...
    public function action_getInviteesPersonName()
    {
        ...
        foreach ($invitees as $invitee) {
            ...
            if (isset($invitee['personModule']) && $invitee['personModule'] && in_array($invitee['personModule'],
                    $personModules) && isset($invitee['personModuleId']) && $invitee['personModuleId'] && isset($invitee['personName']) && $invitee['personName']
            ) {
                $ret[] = $invitee;
            }
        }
