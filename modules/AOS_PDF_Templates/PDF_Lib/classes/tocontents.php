...
// Initiate, and Mark a place for the Table of Contents to be inserted
    ...
    function insertTOC()
    {
        ...
        for ($toci = 0; $toci < $notocs; $toci++) {
            ...
            $this->mpdf->AddPage($toc_orientation, '', '', '', "on", $toc_mgl, $toc_mgr, $toc_mgt, $toc_mgb, $toc_mgh,
                $toc_mgf, $toc_ohname, $toc_ehname, $toc_ofname, $toc_efname, $toc_ohvalue, $toc_ehvalue, $toc_ofvalue,
                $toc_efvalue, $toc_page_selector, $toc_sheet_size);
