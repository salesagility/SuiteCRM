...
var save=function(update){if($('#template_name').val()==''||$('#template_subject').val()==''){alert(SUGAR.language.translate('Campaigns','LBL_PROVIDE_WEB_TO_LEAD_FORM_FIELDS'));return}
...
var create=function(){if($('#template_name').val()==''||$('#template_subject').val()==''){alert(SUGAR.language.translate('Campaigns','LBL_PROVIDE_WEB_TO_LEAD_FORM_FIELDS'));return}
