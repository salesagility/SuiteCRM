...
var save=function(update){if($('#template_name').val()==''){alert(SUGAR.language.translate('Campaigns','LBL_PROVIDE_WEB_TO_LEAD_FORM_FIELDS'));return}
if($('#template_subject').val()==''){if(!confirm(SUGAR.language.translate('Campaigns','LBL_EMPTY_SUBJECT'))){return}}
