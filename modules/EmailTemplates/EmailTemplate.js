...
if($('#template_subject').val()==''){if(!confirm(SUGAR.language.translate('Campaigns','LBL_EMPTY_SUBJECT'))){$('#template_subject').focus();return;}}
if($('#template_id').val()!=''){if(!confirm(SUGAR.language.translate('Campaigns','LBL_OVERWRITE_QUESTION'))){return;}}
