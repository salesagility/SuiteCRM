...
class DocumentsViewDetail extends ViewDetail
{
    ...
    {
        // check to see if the file field is empty.
        // This should not occur and would only happen when an error has ocurred during upload,
        // or from db manipulation of record.
