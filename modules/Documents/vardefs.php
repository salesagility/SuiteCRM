...
$dictionary['Document'] = ['table' => 'documents',
    ...
    'relationships' => [
        'document_revisions' => ['lhs_module' => 'Documents', 'lhs_table' => 'documents', 'lhs_key' => 'id',
            ...
            'relationship_type' => 'one-to-many'], 'documents_modified_user' => ['lhs_module' => 'Users', 'lhs_table' => 'users', 'lhs_key' => 'id',
                'rhs_module' => 'Documents', 'rhs_table' => 'documents', 'rhs_key' => 'modified_user_id',
                'relationship_type' => 'one-to-many'], 'documents_created_by' => ['lhs_module' => 'Users', 'lhs_table' => 'users', 'lhs_key' => 'id',
                    'rhs_module' => 'Documents', 'rhs_table' => 'documents', 'rhs_key' => 'created_by',
                    'relationship_type' => 'one-to-many']
    ],
];
VardefManager::createVardef('Documents', 'Document', ['default', 'assignable', 'security_groups',
]);
