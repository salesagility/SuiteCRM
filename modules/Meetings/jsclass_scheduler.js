...
GLOBAL_REGISTRY.scheduler_attendees_obj.display();}
SugarWidgetSchedulerAttendees.form_add_attendees_from_selection_list=function(data){var conditions=[];var groupBy="or";if(typeof data.name_to_value_array!=='undefined'){conditions.push({"name":"id","op":"starts_with","value":data.name_to_value_array['subpanel_id']});var groupBy="and";}else if(typeof data.selection_list!=='undefined'){for(var property in data.selection_list){if(data.selection_list.hasOwnProperty(property)){conditions.push({"name":"id","op":"starts_with","value":data.selection_list[property]});}}}
...
SugarWidgetSchedulerAttendees.openSelectorPopup=function(module){var data={"call_back_function":"SugarWidgetSchedulerAttendees.form_add_attendees_from_selection_list","form_name":"","field_to_name_array":{"id":"subpanel_id"},"passthru_data":{"child_field":"contacts","return_url":"","link_field_name":"contacts","module_name":"contacts","refresh_page":0}};open_popup(module,600,400,"",true,true,data,"MultiSelect",true);}
