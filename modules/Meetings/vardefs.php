...
$dictionary['Meeting'] = ['table' => 'meetings',
    ...
    'relationships' => [
        'meetings_assigned_user' => ['lhs_module' => 'Users', 'lhs_table' => 'users', 'lhs_key' => 'id',
            ...
            'relationship_type' => 'one-to-many'], 'meetings_modified_user' => ['lhs_module' => 'Users', 'lhs_table' => 'users', 'lhs_key' => 'id',
                'rhs_module' => 'Meetings', 'rhs_table' => 'meetings', 'rhs_key' => 'modified_user_id',
                'relationship_type' => 'one-to-many'], 'meetings_created_by' => ['lhs_module' => 'Users', 'lhs_table' => 'users', 'lhs_key' => 'id',
                    'rhs_module' => 'Meetings', 'rhs_table' => 'meetings', 'rhs_key' => 'created_by',
                    'relationship_type' => 'one-to-many'], 'meetings_notes' => ['lhs_module' => 'Meetings', 'lhs_table' => 'meetings', 'lhs_key' => 'id',
                        'rhs_module' => 'Notes', 'rhs_table' => 'notes', 'rhs_key' => 'parent_id',
                        'relationship_type' => 'one-to-many', 'relationship_role_column' => 'parent_type',
                        'relationship_role_column_value' => 'Meetings']
    ], 'indices' => [
        ['name' => 'idx_mtg_name', 'type' => 'index', 'fields' => ['name']],
        ...
        ['name' => 'idx_meet_date_start', 'type' => 'index', 'fields' => ['date_start']],
    ]
    //This enables optimistic locking for Saves From EditView
    , 'optimistic_locking' => true,
];

VardefManager::createVardef('Meetings', 'Meeting', ['default', 'assignable', 'security_groups',
]);
