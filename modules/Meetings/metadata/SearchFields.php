...
$searchFields['Meetings'] =
    [
        ...
        'status' => ['query_type' => 'default', 'options' => 'meeting_status_dom', 'template_var' => 'STATUS_FILTER'],

        'open_only' => [
            'query_type' => 'default',
            'db_field' => ['status'],
            'operator' => 'not in',
            'closed_values' => ['Held', 'Not Held'],
            'type' => 'bool',
        ],
        'favorites_only' => [
            'query_type' => 'format',
        ...
        'range_date_end' => ['query_type' => 'default', 'enable_range_search' => true, 'is_date_field' => true],
        'start_range_date_end' => ['query_type' => 'default',  'enable_range_search' => true, 'is_date_field' => true],
        'end_range_date_end' => ['query_type' => 'default', 'enable_range_search' => true, 'is_date_field' => true],
        //Range Search Support
    ];
