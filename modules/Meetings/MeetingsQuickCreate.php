...
class MeetingsQuickCreate extends QuickCreate
{
    ...
    function process()
    {
        ...
        $this->ss->assign("STATUS_OPTIONS", get_select_options_with_id($app_list_strings['meeting_status_dom'],
            $app_list_strings['meeting_status_default']));
        ...
        if ($num_of_hours == 13) {
            ...
            if (strpos($time_pref, 'a')) {
                ...
                $this->ss->assign("TIME_MERIDIEM",
                    get_select_options_with_id($focus->meridiem_am_values, $time_start_hour < 12 ? 'am' : 'pm'));
