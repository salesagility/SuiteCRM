...
$dashletData['MyMeetingsDashlet']['searchFields'] = ['name' => ['default' => ''],
...
$dashletData['MyMeetingsDashlet']['columns'] = ['set_complete' => ['width' => '1',
    'label' => 'LBL_LIST_CLOSE',
    'default' => true,
    'sortable' => false,
    'related_fields' => ['status', 'recurring_source']],
    'name' => ['width' => '40',
        'label' => 'LBL_SUBJECT',
        'link' => true,
        'default' => true],
    'parent_name' => ['width' => '29',
