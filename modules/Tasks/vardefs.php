...
$dictionary['Task'] = [
    ...
    'fields' => [
        ...
        'date_start' => [
            ...
            'dbType' => 'datetime',
            'group' => 'date_start',
            'validation' => ['type' => 'isbefore', 'compareto' => 'date_due', 'blank' => false],
            'studio' => ['required' => true, 'no_duplicate' => true],
            'enable_range_search' => true,
            'options' => 'date_range_search_dom',
        ],
    ...
    'indices' => [
        ['name' => 'idx_tsk_name', 'type' => 'index', 'fields' => ['name']],
        ['name' => 'idx_task_con_del', 'type' => 'index', 'fields' => ['contact_id', 'deleted']],
        [
            'name' => 'idx_task_par_del',
            'type' => 'index',
            'fields' => ['parent_id', 'parent_type', 'deleted']
        ],
        ['name' => 'idx_task_assigned', 'type' => 'index', 'fields' => ['assigned_user_id']],
        ['name' => 'idx_task_status', 'type' => 'index', 'fields' => ['status']],
    ]
