...
function additionalDetailsstic_Job_Offers($fields, SugarBean $bean = null, $params = array())
{
    ...
    if (file_exists('custom/modules/' . $bean->module_name . '/metadata/customAdditionalDetails.php')) {
        ...
        return customAdditionalDetails::customAdditionalDetailsstic_Job_Offers($fields, $bean, $mod_strings);
