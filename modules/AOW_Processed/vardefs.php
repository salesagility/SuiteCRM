...
$dictionary['AOW_Processed'] = [
    ...
    'indices' => [
        [
            ...
            'type' => 'index',
            'fields' => ['aow_workflow_id', 'status', 'parent_id', 'deleted'],
        ],
        [
...
VardefManager::createVardef('AOW_Processed', 'AOW_Processed', ['basic']);
