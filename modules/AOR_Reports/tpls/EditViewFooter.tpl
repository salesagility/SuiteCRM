            ...
            <div class="row edit-view-row">
                <div class="col-sm-12">
                    <div class="col-sm-5">
                        ...
                        <div id="fieldTree" class="dragbox view aor_dragbox"></div>
                    </div>
                    ...
                    <div class="col-sm-5">
                        ...
                        <div class="view">
                            ...
                            <div class="edit508" id="detailpanel_fields_select"></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="edit view edit508 hidden" id="detailpanel_conditions">
                    ...
                    <table>
                        ...
                        <tr class="parentheses-btn">
                            <td class="condition-sortable-handle">{$MOD.LBL_ADD_PARENTHESIS}</td>
                        </tr>
                        </tbody>
                    </table>
                </div>
