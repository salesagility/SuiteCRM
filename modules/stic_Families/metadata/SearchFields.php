...
$searchFields[$module_name] = array(
    ...
    'start_range_code' => array(
        'query_type' => 'default',
        'enable_range_search' => true,
    ),
    'end_range_code' => array(
        'query_type' => 'default',
        'enable_range_search' => true,
    ),
    'range_members_amount' => array(
        'query_type' => 'default',
        'enable_range_search' => true,
    ),
    'start_range_members_amount' => array(
        'query_type' => 'default',
        'enable_range_search' => true,
    ),
    'end_range_members_amount' => array(
        'query_type' => 'default',
        'enable_range_search' => true,
    ),
    'range_income' => array(
    ...
    'start_range_income' => array(
        'query_type' => 'default',
        'enable_range_search' => true,
    ),
    'end_range_income' => array(
        'query_type' => 'default',
        'enable_range_search' => true,
    ),
    'favorites_only' => array(
        ...
        'subquery' => 'SELECT favorites.parent_id FROM favorites
                                  WHERE favorites.deleted = 0
                                      and favorites.parent_type = \'stic_Families\'
