 ...
 */
// created: 2020-06-03 10:36:53
$searchFields['stic_Sessions'] = array(
    'name' => array(
        'query_type' => 'default',
    ),
    ...
    'range_total_attendances' => array(
        'query_type' => 'default',
        'enable_range_search' => true,
    ),
    'start_range_total_attendances' => array(
        'query_type' => 'default',
        'enable_range_search' => true,
    ),
    'end_range_total_attendances' => array(
        'query_type' => 'default',
        'enable_range_search' => true,
    ),
    'range_validated_attendances' => array(
        'query_type' => 'default',
        'enable_range_search' => true,
    ),
    'start_range_validated_attendances' => array(
        'query_type' => 'default',
        'enable_range_search' => true,
    ),
    'end_range_validated_attendances' => array(
        'query_type' => 'default',
        'enable_range_search' => true,
    ),
    'range_weekday' => array(
    ...
    'favorites_only' => array(
        ...
        'subquery' => 'SELECT favorites.parent_id FROM favorites
			                    WHERE favorites.deleted = 0
			                        and favorites.parent_type = \'stic_Sessions\'
