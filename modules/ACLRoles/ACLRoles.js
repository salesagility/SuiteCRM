  ...
  return {
    view: function(role_id, role_module) {
      YAHOO.util.Connect.asyncRequest(
        "POST",
        "index.php",
        { success: aclviewer.display, failure: aclviewer.failed },
        "module=ACLRoles&action=EditRole&record=" +
          role_id +
          "&category_name=" +
          role_module
      );
      ajaxStatus.showStatus(
        SUGAR.language.get("app_strings", "LBL_REQUEST_PROCESSED")
      );
    },
    ...
    toggleDisplay: function(id) {
      if (
        aclviewer.lastDisplay != "" &&
        typeof aclviewer.lastDisplay != "undefined"
      ) {
