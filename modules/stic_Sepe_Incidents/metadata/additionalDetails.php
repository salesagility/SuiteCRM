...
function additionalDetailsstic_Sepe_Incidents($fields, SugarBean $bean = null, $params = array())
{
    ...
    if (file_exists('custom/modules/' . $bean->module_name . '/metadata/customAdditionalDetails.php')) {
        ...
        return customAdditionalDetails::customAdditionalDetailsstic_Sepe_Incidents($fields, $bean, $mod_strings);
