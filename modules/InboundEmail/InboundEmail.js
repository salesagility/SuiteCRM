...
function ie_test_open_popup_with_submit(module_name, action, pageTarget, width, height, mail_server, protocol, port, login, password, mailbox, ssl, personal, formName, ie_id) {
  ...
  if (typeof ie_id == "undefined" || ie_id == "") ie_id = typeof document.getElementById(formName).ie_id != "undefined" ? document.getElementById(formName).ie_id.value : "";
  URL =
    "index.php?" +
    "module=" +
    module_name +
  ...
  if (!SI.testDlg) {
    ...
    SI.testDlg._updateContent = function(o) {
      ...
      if (!SUGAR.isIE) this.body.style.width = w;
    };
  }
