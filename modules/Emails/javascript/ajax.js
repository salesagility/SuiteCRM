...
AjaxObject.accounts = {
	...
	callbackEditOutbound : {
		success	: function(o)
		{
			...
			document.getElementById("oe_from_name").value = ret.from_name;
			document.getElementById("oe_from_addr").value = ret.from_addr;
			document.getElementById("reply_to_addr").value = ret.reply_to_addr;
