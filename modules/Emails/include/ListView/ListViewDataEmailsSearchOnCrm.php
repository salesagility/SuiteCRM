...
class ListViewDataEmailsSearchOnCrm extends ListViewDataEmailsSearchAbstract
{
    ...
    public function search(
        ...
        if (!empty($params['overrideOrder']) && !empty($params['orderBy'])) {
            $order = $this->lvde->getOrderBy(strtolower($params['orderBy']),
        ...
        $pageData['queries'] = $this->lvde->callGenerateQueries($pageData['ordering']['sortOrder'], $offset,
            $prevOffset, $nextOffset, $endOffset, $totalCounted);
