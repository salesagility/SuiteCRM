...
class ListViewDataEmails extends ListViewData
{
     ...
     * to the IMap fields
     */
    protected static $mapServerFields = [
     ...
     */
    protected static $mapIgnoreFields = [
        'date_entered',
        'indicator',
        'flagged',
        'has_attachment',
     ...
     */
    protected static $alwaysIncludeSearchFields = [
        'id',
        'flagged',
        'name',
        'subject',
     ...
     */
    protected static $mapEmailFieldsToEmailTextFields = [
