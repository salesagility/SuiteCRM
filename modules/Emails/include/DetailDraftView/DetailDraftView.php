...
class DetailDraftView extends DetailView2
{
    ...
    )
    {
        ...
        if(!empty($this->metadataFile) && file_exists($this->metadataFile)){
            ...
            if(!file_exists("modules/$this->module/metadata/detaildraftviewdefs.php") &&
                ...
                $fp = sugar_fopen('modules/'.$this->module.'/metadata/detaildraftviewdefs.php', 'w');
            ...
            if(!file_exists("modules/$this->module/metadata/detaildraftviewdefs.php")) {
                global $app_strings;
                $error = str_replace("[file]", "modules/$this->module/metadata/detaildraftviewdefs.php", $app_strings['ERR_CANNOT_CREATE_METADATA_FILE']);
                $GLOBALS['log']->fatal($error);
                echo $error;
                die();
            }
            require("modules/$this->module/metadata/detaildraftviewdefs.php");
        }
