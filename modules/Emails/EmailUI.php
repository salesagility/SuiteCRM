...
class EmailUI {
    ...
    function displayEmailFrame($baseTpl = "modules/Emails/templates/_baseEmail.tpl") {
        ...
        $this->smarty->assign(
                'signatures', $user->getSignatures(false, $defaultSignatureId, false, 'signature_id')
        );
        $this->smarty->assign(
                'signaturesSettings', $user->getSignatures(false, $defaultSignatureId, false, 'signature_id')
        );
        $this->smarty->assign(
                'signaturesAccountSettings', $user->getEmailAccountSignatures(false, $defaultSignatureId, false, 'account_signature_id'));
...
eoq;
    ...
    function _generateComposeConfigData($type = "email_compose_light") {
        ...
        $this->smarty->assign('defaultSignature', $sigJson);
        $this->smarty->assign(
                'signatureDefaultId', isset($defaultSignature['id']) ? $defaultSignature['id'] : ''
        );
        //User Preferences
        $this->smarty->assign(
                'userPrefs', json_encode($this->getUserPreferencesJS($useRequestedRecord))
        );
    ...
    function getUserPrefsJS() {
         ...
         * @throws \RuntimeException
         */
        function getUserPreferencesJS($useRequestedRecord = false) {
            global $current_user;
...
eoq;
         ...
         */
        function createFolder($user, $folder_params) {
