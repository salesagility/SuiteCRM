        ...
        <tr class="toggleClass yui-hidden">
            <td class="advancedSearchTD">
                ...
                <a href="javascript:void(0);">
                    <img src="{sugar_getimagepath file='select.gif'}" align="absmiddle" border="0"
                         alt=$mod_strings.LBL_EMAIL_SELECTOR
                         onclick='open_popup("Users", 600, 400, "", true, false, {literal}{"call_back_function":"set_return","form_name":"advancedSearchForm","field_to_name_array":{"id":"assigned_user_id","name":"assigned_user_name"}}{/literal}, "single", true);'>
                </a>
            </td>
        </tr>
        <tr class="toggleClass yui-hidden">
        ...
        <tr class="toggleClass yui-hidden">
            <td NOWRAP class="advancedSearchTD">
                ...
                <input class="sqsEnabled" id="data_parent_name_search" name="data_parent_name_search" type="text"
                       value="">
                <a href="javascript:void(0);"><img src="{sugar_getimagepath file='select.gif'}" align="absmiddle"
