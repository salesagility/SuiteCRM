...
<div class="email-subject">
    {if $bean}
        ...
        {else}
            <a href="index.php?module=Emails&action=DisplayDetailView&folder={$bean.folder}&inbound_email_record={$bean.inbound_email_record}&uid={$bean.uid}&msgno={$bean.msgno}">{$subject}</a>
        {/if}
    {/if}
</div>