...
class aCase extends Basic
{
    ...
    public function set_notification_body($xtpl, $case)
    {
        ...
        $xtpl->assign(
            'CASE_PRIORITY',
            ($case->priority !== null ? $app_list_strings['case_priority_dom'][$case->priority] : '')
        );
        $xtpl->assign('CASE_STATUS', ($case->status !== null ? $app_list_strings['case_status_dom'][$case->status] : ''));
