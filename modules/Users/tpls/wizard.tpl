                            ...
                            <div class="bd">
                                                ...
                                                <div class="edit view">
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td scope="row" nowrap="nowrap"><span>{$MOD.LBL_STATE}
                                                                    :</span></td>
                                                        ...
                                                        <tr>
                                                            <td scope="row" nowrap="nowrap"><span>{$MOD.LBL_POSTAL_CODE}
                                                                    :</span></td>
                                                            <td><span><input name='address_postalcode' tabindex='9'
                                                                             size='10' maxlength='20'
                                                                             value='{$ADDRESS_POSTALCODE}'></span></td>
                                                            <td scope="row" nowrap="nowrap"><span>{$MOD.LBL_COUNTRY}
                                                                    :</span></td>
                                ...
                                <div id="locale" class="screen">
                                            ...
                                            <td>
                                                <div class="edit view">
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td scope="row" nowrap="nowrap"><span>{$MOD.LBL_TIMEZONE}
                                                                    :</span>&nbsp;{sugar_help text=$MOD.LBL_TIMEZONE_TEXT }
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td width="17%" scope="row" nowrap="nowrap">
                                                                <span>{$MOD.LBL_DATE_FORMAT}
                                                                    :</span>&nbsp;{sugar_help text=$MOD.LBL_DATE_FORMAT_TEXT }
                                                            </td>
                                                            <td width="33%"><span><select tabindex='14'
                                                                                          name='dateformat'>{$DATEOPTIONS}</select></span>
                                                            </td>
                                                            <td scope="row" nowrap="nowrap"><span>{$MOD.LBL_TIME_FORMAT}
                                                                    :</span>&nbsp;{sugar_help text=$MOD.LBL_TIME_FORMAT_TEXT }
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td width="17%" scope="row" nowrap="nowrap">
                                                                <span>{$MOD.LBL_CURRENCY}
                                                                    :</span>&nbsp;{sugar_help text=$MOD.LBL_CURRENCY_TEXT }
                                                            </td>
                                                            <td><span>
                                    ...
                                    <input type="text" disabled id="sigDigitsExample" name="sigDigitsExample">
                                                        ...
                                                        <tr>
                                                            <td width="17%" scope="row" nowrap="nowrap">
                                                                <span>{$MOD.LBL_DECIMAL_SEP}
                                                                    :</span>&nbsp;{sugar_help text=$MOD.LBL_DECIMAL_SEP_TEXT }
                                                            </td>
                                                            <td><span>
                                    <input tabindex='14' name='dec_sep' id='default_decimal_seperator'
                                           ...
                                           onkeydown='setSigDigits();' onkeyup='setSigDigits();'>
                                                            ...
                                                            <td width="17%" scope="row" nowrap="nowrap">
                                                                <span>{$MOD.LBL_NUMBER_GROUPING_SEP}
                                                                    :</span>&nbsp;{sugar_help text=$MOD.LBL_NUMBER_GROUPING_SEP_TEXT }
                                                            </td>
                                                                    ...
                                                                    {if $IS_ADMIN}
                                                                        ...
                                                                        <tr>
                                                                            <td><img src=include/images/university.png
                                                                                     style="margin-right: 5px;"></td>
                                                                            <td>
                                                                                <a href="http://www.suitecrm.com/forum/index"
                                                                    ...
                                                                    {else}
                                                                        ...
                                                                        <tr>
                                                                            <td><img src=include/images/docs.png
                                                                                     style="margin-right: 5px;"></td>
                                                                            <td>
                                                                                <a href="https://suitecrm.com/wiki/index.php/Userguide"
