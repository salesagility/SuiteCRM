        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="0" class="edit view">
            ...
            <tr>
                <td width="17%" scope="row">
                    ...
                    <td width="20%">
                    <slot>{$MOD.LBL_GOOGLE_API_TOKEN_TEXT}: <span style="color:{$GOOGLE_API_TOKEN_COLOR}">{$GOOGLE_API_TOKEN}</span> &nbsp;&nbsp;<input style="display:{$GOOGLE_API_TOKEN_ENABLE_NEW}" class="btn btn-primary btn-sm" id="google_gettoken" type="button" value="{$GOOGLE_API_TOKEN_BTN}" onclick="window.open('{$GOOGLE_API_TOKEN_NEW_URL}', '_self')" /></slot>
                </td>
                <td width="63%">
                    <slot>&nbsp;</slot>
                </td>
