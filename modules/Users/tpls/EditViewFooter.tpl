                ...
                <tr>
                    <td width='40%'>
                        ...
                        <table width='100%' cellspacing='0' cellpadding='0' border='0' >
                            <tr>
                                ...
                                <td class='dataField'>
                                    ...
                                    <input name='new_password' id= "new_password" type='password' tabindex='2' onkeyup="password_confirmation();" />
                                </td>
                                <td width='40%'>
                                </td>
                            </tr>
                        ...
                        <table width='17%' cellspacing='0' cellpadding='1' border='0'>
                            <tr>
                                <td width='50%'>
                                    <input title="{$APP.LBL_SAVE_BUTTON_TITLE}" accessKey='{$APP.LBL_SAVE_BUTTON_KEY}' class='button' id='save_new_pwd_button' LANGUAGE=javascript onclick="if (passwordCheck('{$PWDSETTINGS.hasMinumLength}',{$PWDSETTINGS.minpwdlength},{$PWDSETTINGS.hasMaximumLength},{$PWDSETTINGS.maxpwdlength},{$PWDSETTINGS.oneupper},{$PWDSETTINGS.nonalphaNumeric},{$PWDSETTINGS.onenumber},this.form)) window.close(); else return false;" type='submit' name='button' style='display:none;' value='{$APP.LBL_SAVE_BUTTON_LABEL}'>
                                </td>
                                <td width='50%'>
                                </td>
                            </tr>
