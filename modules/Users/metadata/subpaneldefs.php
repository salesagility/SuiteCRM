...
$layout_defs['Users']['subpanel_setup']['securitygroups'] = [
...
$layout_defs['UserRoles']['subpanel_setup']['securitygroups'] = [
    'top_buttons' => [['widget_class' => 'SubPanelTopSelectButton', 'popup_module' => 'SecurityGroups', 'mode' => 'MultiSelect']],
    'order' => 100,
    'sort_by' => 'name',
    'sort_order' => 'asc',
...
if (is_admin($current_user)) {
    ...
    $layout_defs['Users']['subpanel_setup']['securitygroups']['top_buttons'] = [];
}
