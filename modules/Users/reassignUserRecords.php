            ...
            <tr>
                <td>
                    ...
                    <select name="fromuser" id='fromuser'>
                        ...
                        echo get_select_options_with_id($all_users,
                            isset($_SESSION['reassignRecords']['fromuser']) ? $_SESSION['reassignRecords']['fromuser'] : '');
                        ?>
                    </select>
                    <BR>
                    <BR>
                    ...
                    <select name="touser" id="touser">
                        ...
                        echo get_select_options_with_id($active_users,
                            isset($_SESSION['reassignRecords']['touser']) ? $_SESSION['reassignRecords']['touser'] : '');
                        ?>
                    </select>
                    <?php
                    ?>
