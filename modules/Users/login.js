...
function toggleDisplay(id) {
  if (this.document.getElementById(id).style.display == "none") {
    ...
    document.getElementById(id + "_options").alt = LBL_HIDEOPTIONS;
  } else {
    this.document.getElementById(id).style.display = "none";
    if (this.document.getElementById(id + "link") != undefined) {
      this.document.getElementById(id + "link").style.display = "inline";
    }
    document.getElementById(id + "_options").src =
      "index.php?entryPoint=getImage&themeName=" + SUGAR.themes.theme_name + "&imageName=advanced_search.gif";
    document.getElementById(id + "_options").alt = LBL_SHOWOPTIONS;
  }
}
