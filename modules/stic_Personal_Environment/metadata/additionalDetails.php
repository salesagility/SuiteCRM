...
function additionalDetailsstic_Personal_Environment($fields, SugarBean $bean = null, $params = array())
{
    if (file_exists('custom/modules/' . $bean->module_name . '/metadata/customAdditionalDetails.php')) {
        ...
        return customAdditionalDetails::customAdditionalDetailsstic_Personal_Environment($fields, $bean, $mod_strings);
