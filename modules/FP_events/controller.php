...
class FP_eventsController extends SugarController
{
    ...
    public function action_sendinvitemails()
    {
        ...
        if ($error_count == $delegate_count) {
            $_SESSION['user_error_message'] = []; //clear the error message array
    ...
    public function sendEmail($emailTo, $emailSubject, $emailToname, $emailBody, $altemailBody, SugarBean $relatedBean = null, $attachments = [])
    {
        $emailObj = new Email();
