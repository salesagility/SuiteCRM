...
$mod_strings = array (
  ...
  'LBL_EMAIL_LINK_TYPE_HELP'			=> '<b>SuiteCRM Mail Client:</b> Send emails using the email client in the application.<br><b>External Mail Client:</b> Send email using an email client outside of the application, such as Microsoft Outlook.',
