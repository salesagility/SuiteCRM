...
$mod_strings = array (
  ...
  'LBL_SP_WELCOME' => 'Bienvenido al Estudio para el Portal de SuiteCRM. Puede elegir editar módulos aquí, o realizar una sincronización con una instancia de portal.<br> Por favor, selecciónelo de la siguiente lista.',
  'LBL_SP_SYNC' => 'Sincronización de Portal',
  'LBL_SYNCP_WELCOME' => 'Por favor, introduzca el URL de la instancia de portal que desea actualizar y haga clic en el botón Ir.<br> Tras esto, se le pedirá su nombre y contraseña.<br> Por favor, introduzca su nombre y contraseña de SuiteCRM y haga clic en el botón Iniciar Sincronización.',
