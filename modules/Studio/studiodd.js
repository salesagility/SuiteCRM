...
ygDDSlot.prototype.handleDelete = function(cur, curb) {
  ...
  ygDDSlot.prototype.handleSwap(
    cur,
    curb,
    document.getElementById("dyn_field_" + myfieldcount),
    document.getElementById("dyn_field_" + myfieldcount + "b"),
    true
  );
};
...
ygDDSlot.prototype.undo = function(transaction) {
  ygDDSlot.prototype.handleSwap(
    document.getElementById(transaction["el"]),
    document.getElementById(transaction["elb"]),
    document.getElementById(transaction["cur"]),
    document.getElementById(transaction["curb"]),
    false
  );
};
