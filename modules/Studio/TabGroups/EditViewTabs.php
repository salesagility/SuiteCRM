...
$modList = array_combine($modList,
    $modList); // Bug #48693 We need full list of modules here instead of displayed modules
...
$buttons [] = array(
    ...
    'actionScript' => "onclick='studiotabs.generateForm(\"edittabs\");document.edittabs.submit()'"
);
$html = "";
...
$recycleImage = SugarThemeRegistry::current()->getImage('icon_Delete', '', 48, 48, '.gif',
    $mod_strings['LBL_MB_DELETE']);
