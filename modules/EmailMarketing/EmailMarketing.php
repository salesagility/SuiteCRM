    ...
    public function get_list_view_data()
    {
        ...
        if ($temp_array['ALL_PROSPECT_LISTS']==1) {
            ...
            if ($this->mode=='test') {
                ...
                // STIC-Custom 20230721 MHP - Get only de default LPOs
                // STIC#1165
                // $query.=" AND prospect_lists.list_type!='test'";
                $query.=" AND prospect_lists.list_type='default'";
                // END STIC-Custom
            }
        } else {
            $query="SELECT name from prospect_lists ";
        ...
        // STIC-Custom 20210528- Following lines are commented in order to avoid converting subpanel links to wizard calls and stay in standard 
        // subpanel behaviour (go to Email Marketing and Email Templates detail view)
        // STIC#288
