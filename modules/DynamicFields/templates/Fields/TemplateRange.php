    ...
    public static function repairCustomSearchFields($vardefs, $module, $package = '')
    {
        ...
        if (!empty($fields)) {
            ...
            foreach ($fields as $field_name => $field) {
                ...
                $searchFields[$module][$field_name_range] = array(
                    'query_type' => 'default',
                ...
                $searchFields[$module][$field_name_start] = array(
                    'query_type' => 'default',
                    'enable_range_search' => true
                );
                if ($isDateField) {
                ...
                $searchFields[$module][$field_name_end] = array(
                    'query_type' => 'default',
                    'enable_range_search' => true
                );
                if ($isDateField) {
            ...
            write_array_to_file("searchFields['{$module}']", $searchFields[$module],
