...
class TemplateMultiEnum extends TemplateEnum
{
    ...
    public function save($df)
    {
        if (isset($this->default)) {
            ...
            $this->ext4 = (isset($this->dependency)) ? serialize(['default' => $this->default, 'dependency' => html_entity_decode($this->dependency)]) : $this->default;
        } else {
            if (isset($this->dependency)) {
                $this->ext4 = serialize(['dependency' => html_entity_decode($this->dependency)]);
            }
        }
        parent::save($df);
    }
