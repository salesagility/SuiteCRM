...
class TemplateMultiEnum extends TemplateEnum
{
    ...
    function get_xtpl_edit()
    {
        ...
        $returnXTPL[strtoupper('options_' . $this->name)] = get_select_options_with_id($app_list_strings[$this->ext1],
            unencodeMultienum($value));
    ...
    function save($df)
    {
        if (isset ($this->default)) {
            ...
            $this->ext4 = (isset ($this->dependency)) ? serialize(array(
                'default' => $this->default,
                'dependency' => html_entity_decode($this->dependency)
            )) : $this->default;
        } else {
