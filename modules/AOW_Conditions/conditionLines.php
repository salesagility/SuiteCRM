...
function display_condition_lines($focus, $field, $value, $view)
{
    ...
    if ($view == 'EditView') {
        ...
        if (isset($focus->flow_module) && $focus->flow_module != '') {
            ...
            $html .= "<script>";
            $html .= "flow_rel_modules = \"" . trim(preg_replace('/\s+/', ' ',
                    getModuleRelationships($focus->flow_module))) . "\";";
            ...
            if ($focus->id != '') {
                ...
                while ($row = $focus->db->fetchByAssoc($result)) {
                    ...
                    $html .= "flow_fields = \"" . trim(preg_replace('/\s+/', ' ',
                            getModuleFields(getRelatedModule($focus->flow_module,
            ...
            $html .= "flow_fields = \"" . trim(preg_replace('/\s+/', ' ',
                    getModuleFields($focus->flow_module))) . "\";";
            $html .= "</script>";
        }
