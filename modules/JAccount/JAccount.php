...
include_once 'modules/JAccount/JAccountException.php';
include_once 'modules/JAccount/JAccountInvalidUserDataException.php';
...
class JAccount extends Basic
{
    ...
    public function save($check_notify = false) {
        ...
        try {
            ...
            // DBManager drop an exception when duplicate index error on insert so de bean already there, retrieve it..
