...
class stic_Import_ValidationViewStep1 extends stic_Import_ValidationView
{
    ...
    private function getAllImportableExternalEAPMs()
    {
        ...
        return ExternalAPIFactory::getModuleDropDown('stic_Import_Validation', true, false);
    }

    private function getAuthenticatedImportableExternalEAPMs()
    {
        return ExternalAPIFactory::getModuleDropDown('stic_Import_Validation', false, false);
    }
    /**
...
YAHOO.util.Event.onDOMReady(function(){
    ...
    function openExtAuthWindow()
    {
        ...
        if (api.authMethod === "oauth2") {
            ...
            var url = api.loginUrl + "&return_module=stic_Import_Validation&return_action=" + import_module;
