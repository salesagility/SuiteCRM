    ...
    public function display()
    {
        ...
        if ($sugar_config['lead_conv_activity_opt'] == 'move') {
            ...
            if ($sugar_config['lead_conv_activity_opt'] == 'copy') {
                $smarty->assign('convertModuleListOptions',
                    get_select_options_with_id(array('Contacts' => $app_list_strings["moduleListSingular"]['Contacts']),
                        ''));
            }
        }
                            ...
                            if ($module == "Opportunities" && $field == 'name') {
                                ...
                                if ($field == "id") {
                                    ...
                                    if (is_a($focus, "Company") && $field == 'phone_office') {
                                        ...
                                        if (strpos($field,
                                                "billing_address") !== false && $focus->field_defs[$field]["type"] == "varchar"
                                        ) /* Bug 42219 fix */ {
                                            ...
                                            if (strpos($field,
                                                    "shipping_address") !== false && $focus->field_defs[$field]["type"] == "varchar"
                                            ) /* Bug 42219 fix */ {
