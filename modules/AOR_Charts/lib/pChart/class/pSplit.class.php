...
class pSplit
{
    ...
    function drawSplitPath($Object, $Values, $Format = "")
    {
        ...
        foreach ($Data["Series"][$DataSerie]["Data"] as $Key => $Value) {
            ...
            $Points = $Object->drawBezier($X1, $LeftY1, $X2, $RightY1, $VectorX1, $VectorY1, $VectorX2, $VectorY2,
                $Settings);
            ...
            $Points = $Object->drawBezier($X1, $LeftY2, $X2, $RightY2, $VectorX1, $VectorY1, $VectorX2, $VectorY2,
                $Settings);
            ...
            if ($TextPos == TEXT_POS_RIGHT) {
                $Object->drawText($X2 + $TextPadding, ($RightY2 - $RightY1) / 2 + $RightY1, $Label,
