...
/**
 * Class to check the following fields of Person Relations
 * - End date
 * - Type of relationship
 * - Registration Name
 * - With registration date after end date
 */
class checkCRBeanData extends DataCheckFunction 
{
    /**
     * DoAction function
    ...
    public function doAction($records, stic_Validation_Actions $actionBean) 
    {
        ...
        while ($row = array_pop($records)) {
            ...
            // If you have a end date, compare it with the end date
