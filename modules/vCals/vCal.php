...
class vCal extends SugarBean
{
    ...
    function create_sugar_freebusy($user_bean, $start_date_time, $end_date_time)
    {
        ...
        $acts_arr = CalendarActivity::get_activities($activityList, $user_bean->id, false, $start_date_time,
            $end_date_time, 'freebusy');
    ...
    public static function fold_ical_lines($key, $value)
    {
        ...
        $remainingchars = substr(chunk_split($end . $remainingchars, self::CHARSPERLINE + strlen(self::EOL), $end), 0,
