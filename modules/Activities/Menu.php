...
if (ACLController::checkAccess('Notes', 'edit', true)) {
    $module_menu[] = Array(
        "index.php?module=Notes&action=EditView&return_module=Notes&return_action=DetailView",
...
if (ACLController::checkAccess('Tasks', 'list', true)) {
    $module_menu[] = Array(
        "index.php?module=Tasks&action=index&return_module=Tasks&return_action=DetailView",
        $mod_strings['LNK_TASK_LIST'],
        "List"
    );
}
...
if (ACLController::checkAccess('Tasks', 'import', true)) {
    $module_menu[] = Array(
        "index.php?module=Import&action=Step1&import_module=Tasks&return_module=Tasks&return_action=index",
        $mod_strings['LNK_IMPORT_TASKS'],
        "Import",
        'Tasks'
    );
}
if (ACLController::checkAccess('Notes', 'import', true)) {
    $module_menu[] = Array(
        "index.php?module=Import&action=Step1&import_module=Notes&return_module=Notes&return_action=index",
        $mod_strings['LNK_IMPORT_NOTES'],
        "Import",
        'Notes'
    );
}
