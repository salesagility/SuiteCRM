...
class AOW_WorkFlowController extends SugarController {
    ...
    protected function action_getModuleOperatorField(){
        ...
        if($vardef){
            ...
            if($view == 'EditView'){
                echo "<select type='text' style='' name='$aow_field' id='$aow_field ' title='' tabindex='116'>". get_select_options_with_id($app_list_strings['aow_operator_list'], $value) ."</select>";
            }else{
    ...
    protected function action_getFieldTypeOptions(){
        ...
        if($view == 'EditView'){
            echo "<select type='text' style='' name='$aow_field' id='$aow_field' title='' tabindex='116'>". get_select_options_with_id($app_list_strings['aow_condition_type_list'], $value) ."</select>";
        }else{
    ...
    protected function action_getActionFieldTypeOptions(){
        ...
        if($view == 'EditView'){
            echo "<select type='text' style='' name='$aow_field' id='$aow_field' title='' tabindex='116'>". get_select_options_with_id($app_list_strings['aow_action_type_list'], $value) ."</select>";
        }else{
    ...
    protected function action_getModuleFieldType()
    {
        ...
        switch($_REQUEST['aow_type']) {
            case 'Field':
                ...
                if($view == 'EditView'){
                    echo "<select type='text' style='' name='$aow_field' id='$aow_field ' title='' tabindex='116'>". getModuleFields($module, $view, $value, getValidFieldsTypes($module, $fieldname)) ."</select>";
                }else{
    ...
    protected function action_getModuleFieldTypeSet()
    {
        ...
        switch($_REQUEST['aow_type']) {
            case 'Field':
                ...
                if(isset($_REQUEST['alt_module']) && $_REQUEST['alt_module'] != '') $module = $_REQUEST['alt_module'];
                if($view == 'EditView'){
                    echo "<select type='text' style='' name='$aow_field' id='$aow_field ' title='' tabindex='116'>". getModuleFields($module, $view, $value, $valid_fields) ."</select>";
                }else{
                    echo getModuleFields($module, $view, $value);
                }
                break;
    ...
    protected function action_getRelFieldTypeSet()
    {
        ...
        switch($_REQUEST['aow_type']) {
            case 'Field':
                if(isset($_REQUEST['alt_module']) && $_REQUEST['alt_module'] != '') $module = $_REQUEST['alt_module'];
                if($view == 'EditView'){
                    echo "<select type='text' style='' name='$aow_field' id='$aow_field ' title='' tabindex='116'>". getModuleFields($module, $view, $value) ."</select>";
                }else{
                    echo getModuleFields($module, $view, $value);
                }
                break;
    ...
    protected function action_getRelActionFieldTypeOptions(){
        ...
        if($view == 'EditView'){
            echo "<select type='text' style='' name='$aow_field' id='$aow_field' title='' tabindex='116'>". get_select_options_with_id($app_list_strings['aow_rel_action_type_list'], $value) ."</select>";
        }else{
    ...
    protected function action_getEmailField()
    {
        ...
        switch($_REQUEST['aow_type']) {
            ...
            case 'Related Field':
                ...
                if($view == 'EditView'){
                    echo "<select type='text' style='' name='$aow_field' id='$aow_field' title='' tabindex='116'>". get_select_options_with_id($rel_field_list, $value) ."</select>";
                }else{
