...
class AOW_WorkFlow extends Basic
{
    ...
    function load_flow_beans()
    {
        ...
        $app_list_strings['aow_moduleList'] = array_merge((array)array('' => ''),
            (array)$app_list_strings['aow_moduleList']);
                    ...
                    if ($params[0] == 'now') {
                        ...
                        if ($params[0] == 'today') {
                            ...
                            if ((isset($data['source']) && $data['source'] == 'custom_fields')) {
                                ...
                                $query = $this->build_flow_query_join($module->table_name . '_cstm', $module, 'custom',
                                    $query);
                            } else {
    ...
    function compare_condition($var1, $var2, $operator = 'Equal_To')
    {
        switch ($operator) {
            ...
            case "Starts_With" :
                return strrpos($var1, $var2, -strlen($var1));
            case "Ends_With" :
