...
class MyAccountsDashlet extends DashletGeneric
{
    ...
    {
        if (property_exists($this, 'displayColumns') && $this->displayColumns !== null && array_search('email1', $this->displayColumns, true) !== false) {
        ...
        if (property_exists($this, 'displayColumns') && $this->displayColumns !== null && array_search('parent_name', $this->displayColumns, true) !== false) {
