...
class ImportViewConfirm extends ImportView
{
     ...
     * @param mixed $showCancel
     * @param null|mixed $cancelLabel
     * @param mixed $display
     */
...
eoq;
     ...
     *
     * @param mixed $maxRecordsExceeded
     * @param mixed $maxRecordsWarningMessg
     * @param mixed $importMappingJS
     * @param mixed $importFileMap
     */
