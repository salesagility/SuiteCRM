...
class ImportViewStep3 extends ImportView
{
    ...
    public function display()
    {
        ...
        $importFile = new ImportFile($uploadFileName, $delimiter,
        ...
        $this->ss->assign("DELETE_INLINE_PNG", SugarThemeRegistry::current()->getImage('basic_search',
            'align="absmiddle" alt="' . $app_strings['LNK_DELETE'] . '" border="0"'));
        $this->ss->assign("PUBLISH_INLINE_PNG", SugarThemeRegistry::current()->getImage('advanced_search',
