...
{* STIC-Custom 20230920 MHP - Show button to validate the import file
   STIC#1086 *}
<br /><br />
<div class="hr"></div>
<br /><br />
{$MOD.LBL_INSTRUCTION_FILE_VALIDATION}
<br /><br />
<a href="?module=stic_Import_Validation&action=Step1&import_module={$IMPORT_MODULE}&return_module={$IMPORT_MODULE}&return_action=index">
    <button type='button' class='button'>{$MOD.LBL_FILE_VALIDATION_BUTTON}</button>
</a>
{* END STIC-Custom *}
