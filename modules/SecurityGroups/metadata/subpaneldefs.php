...
$layout_defs['SecurityGroups'] = [
    // list of what Subpanels to show in the DetailView
    'subpanel_setup' => [
        'users' => [
            'top_buttons' => [['widget_class' => 'SubPanelTopSelectButton', 'mode' => 'MultiSelect', 'popup_module' => 'Users']],
            'order' => 10,
            'module' => 'Users',
            'sort_by' => 'user_name',
            'sort_order' => 'asc',
        ...
        'aclroles' => [
            'top_buttons' => [['widget_class' => 'SubPanelTopSelectButton', 'popup_module' => 'ACLRoles']],
            'order' => 20,
            'sort_by' => 'name',
            'sort_order' => 'asc',
            'module' => 'ACLRoles',
...
$layout_defs['SecurityGroupRoles'] = [
...
if (is_admin($current_user)) {
    ...
    $layout_defs['SecurityGroups']['subpanel_setup']['aclroles']['top_buttons'] = [];

    $layout_defs['SecurityGroupRoles']['subpanel_setup']['aclroles']['top_buttons'] = [];
}
