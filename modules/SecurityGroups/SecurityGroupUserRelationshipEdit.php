...
$sqs_objects = ['user_name' => $qsd->getQSParent()];
$sqs_objects['user_name']['populate_list'] = ['user_name', 'user_id'];
...
$xtpl->assign('SECURITYGROUP', $securityGroup = ['NAME' => $focus->securitygroup_name, 'ID' => $focus->securitygroup_id]);
$xtpl->assign('USER', $user = ['NAME' => $focus->user_name, 'ID' => $focus->user_id]);
