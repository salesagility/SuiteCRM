...
echo get_module_title($mod_strings['LBL_MODULE_NAME'],
    $mod_strings['LBL_SECURITYGROUP_USER_FORM_TITLE'] . ": " . $securityGroup['NAME'] . " - " . $user['NAME'], true);
echo "\n</p>\n";
...
$javascript->addToValidateBinaryDependency('user_name', 'alpha',
    $app_strings['ERR_SQS_NO_MATCH_FIELD'] . $mod_strings['LBL_USER_NAME'], 'false', '', 'user_id');
