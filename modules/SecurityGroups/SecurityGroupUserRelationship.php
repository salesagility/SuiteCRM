...
class SecurityGroupUserRelationship extends SugarBean
{
    ...
    public $column_fields = ['id', 'securitygroup_id', 'user_id', 'noninheritable', 'primary_group', 'date_modified'
    ];
    ...
    public $field_defs = [
        'id' => ['name' => 'id', 'type' => 'char', 'len' => '36', 'default' => ''], 'securitygroup_id' => ['name' => 'securitygroup_id', 'type' => 'char', 'len' => '36'], 'user_id' => ['name' => 'user_id', 'type' => 'char', 'len' => '36'], 'noninheritable' => ['name' => 'noninheritable', 'type' => 'bool', 'len' => '1'], 'primary_group' => ['name' => 'primary_group', 'type' => 'bool', 'len' => '1'], 'date_modified' => ['name' => 'date_modified', 'type' => 'datetime'], 'deleted' => ['name' => 'deleted', 'type' => 'bool', 'len' => '1', 'default' => '0', 'required' => true]
    ];
