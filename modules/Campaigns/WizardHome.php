...
if (isset($_REQUEST['record']) && !empty($_REQUEST['record'])) {
    ...
    */
    ...
    if ($focus->campaign_type == 'NewsLetter') {
        echo getClassicModuleTitle($mod_strings['LBL_MODULE_NAME'], [$mod_strings['LBL_NEWSLETTER_WIZARD_START_TITLE'] . $focus->name], true, false);
    } else {
        echo getClassicModuleTitle($mod_strings['LBL_MODULE_NAME'], [$mod_strings['LBL_CAMPAIGN_WIZARD_START_TITLE'] . $focus->name], true, false);
    }
    ...
    */
    ...
    //if (!is_admin($current_user)) sugar_die("Unauthorized access to administration.");
    //account for use within wizards
    echo getClassicModuleTitle($mod_strings['LBL_MODULE_NAME'], [$mod_strings['LBL_CAMPAIGN_WIZARD'] . $focus->name], true, false);
