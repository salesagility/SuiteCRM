...
if ($test) {
    echo getClassicModuleTitle('Campaigns', [$current_module_strings['LBL_MODULE_SEND_TEST']], false);
} else {
    echo getClassicModuleTitle('Campaigns', [$current_module_strings['LBL_MODULE_SEND_EMAILS']], false);
}
