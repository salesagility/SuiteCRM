...
function additionalDetailsstic_Payments($fields, SugarBean $bean = null, $params = array())
{
    if (file_exists('custom/modules/' . $bean->module_name . '/metadata/customAdditionalDetails.php')) {
        ...
        return customAdditionalDetails::customAadditionalDetailsstic_Payments($fields, $bean, $mod_strings);
