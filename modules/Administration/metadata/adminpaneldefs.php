...
//users and security.
$admin_option_defs = [];
$admin_option_defs['Users']['user_management'] = ['UserManagement', 'LBL_MANAGE_USERS_TITLE', 'LBL_MANAGE_USERS', './index.php?module=Users&action=index', 'user-management'];
...
$admin_option_defs['Administration']['global_search'] = ['icon_SearchForm', 'LBL_GLOBAL_SEARCH_SETTINGS', 'LBL_GLOBAL_SEARCH_SETTINGS_DESC', './index.php?module=Administration&action=GlobalSearchSettings', 'global-search'];
...
//bugs.
$admin_option_defs = [];
$admin_option_defs['Bugs']['bug_tracker'] = ['Releases', 'LBL_MANAGE_RELEASES', 'LBL_RELEASE', './index.php?module=Releases&action=index', 'releases'];
