                ...
                while (($file = readdir($dh)) !== false) {
                    if ($file != "." && $file != ".." && $file != "sprites_config.php") {
                        ...
                        if ($info = $this->getFileInfo($dir, $file)) {
                            ...
                            // skip excluded files
                            if (isset($this->sprites_config[$dir]['exclude']) && array_search($file,
                                    $this->sprites_config[$dir]['exclude']) !== false
                            ) {
                                global $mod_strings;
                                $msg = string_format($mod_strings['LBL_SPRITES_EXCLUDING_FILE'],
                                    array("{$dir}/{$file}"));
