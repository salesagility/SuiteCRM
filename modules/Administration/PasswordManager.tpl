                        ...
                        <td>
										        <span>
													...
													<input type="button" class="button"
                                                           onclick="open_email_template_form('generatepasswordtmpl')"
                                                           value="{$MOD.LBL_PASSWORD_CREATE_TEMPLATE}" {$IE_DISABLED}>
													<input type="button" value="{$MOD.LBL_PASSWORD_EDIT_TEMPLATE}"
                                                           class="button"
                                                           onclick="edit_email_template_form('generatepasswordtmpl')"
                    ...
                    <tr>
                        ...
                        <td>
							        			<span>
													...
													<input type="button" class="button"
                                                           onclick="open_email_template_form('lostpasswordtmpl')"
                                                           value="{$MOD.LBL_PASSWORD_CREATE_TEMPLATE}" {$IE_DISABLED}>
													<input type="button" value="{$MOD.LBL_PASSWORD_EDIT_TEMPLATE}"
                                                           class="button"
                                                           onclick="edit_email_template_form('lostpasswordtmpl')"
