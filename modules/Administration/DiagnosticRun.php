...
function finishDiag()
{
    ...
    echo "<a href=\"index.php?module=Administration&action=DiagnosticDownload&guid={$sod_guid}&time={$curdatetime}&to_pdf=1\">" . $mod_strings['LBL_DIAGNOSTIC_DOWNLOADLINK'] . '</a><BR>';
