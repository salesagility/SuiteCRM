...
$mod_strings = array (
    ...
    'ERR_CREDENTIALS_MISSING'   => 'Your credentials are missing.',
    ...
    'ERR_SUGAR_DEPOT_DOWN'    => 'The system is unable to connect to Exchange for browsing and downloading packages.',
...
///    'FATAL_VALIDATION_REQUIRED' => "Fatal: Your validation key information is required .<br>   Please go to the <a href='index.php?action=LicenseSettings&module=Administration'>'\"License Management\"</a>  in the Admin screen to update your license information and restore full functionality.<br>Either re-save your license information to have it authenticated or export the key and import the validation key. " ,
   'HDR_LOGIN_PANEL'          => 'Please enter your Login credentials.',
...
///    'LBL_MANUAL_VALIDATION5'=> 'After you import the validation key, you have completed the manual validation process.  Your system will update the validation key expiration date, which is the date when you need re-validate.',
    ...
    'LBL_PLUGINS' => 'Get plug-ins and other extensions.',
    ...
    'LBL_PROXY_ON_DESC'=>'Use a proxy to access external information such as updates.',
    ...
    'LBL_REBUILD_DASHLETS_DESC_SHORT' => 'Rebuilds the Suite Dashlets cache file',
    'LBL_REBUILD_DASHLETS_DESC_SUCCESS' => 'Suite Dashlets cache file rebuilt.',
    'LBL_REBUILD_DASHLETS_DESC' => 'Removing Suite Dashlets cache and scanning known directories for SuiteCRM Dashlet files.',
    'LBL_REBUILD_DASHLETS_TITLE' => 'Rebuild Suite Dashlets',
...
//END SUGARCRM flav=een
    ...
    'LBL_SUGAR_NETWORK_DESC' => 'Connect to the various SuiteCRM services where you can access the SuiteCRM forums and Sugar Wiki, search FAQs (Frequently Asked Questions), download the latest SuiteCRM version, file and research reported bugs and request new features and more.',
	...
	'LBL_QUICK_REPAIR_AND_REBUILD_DESC'=>'Repairs and rebuilds DB, Extensions, Vardefs, Suite Dashlets etc.',
