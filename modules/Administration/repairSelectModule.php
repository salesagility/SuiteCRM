 ...
 */
        ...
        $smarty = new Sugar_Smarty();
            ...
            //sort($output);
            //sort($values);
            $values = array_merge([$mod_strings['LBL_ALL_MODULES']], $values);
            $output = array_merge([$mod_strings['LBL_ALL_MODULES']], $output_local);
            $checkbox_values = [
                'clearTpls',
                'clearJsFiles',
                'clearVardefs',
            ...
            $checkbox_output = [$mod_strings['LBL_QR_CBOX_CLEARTPL'],
