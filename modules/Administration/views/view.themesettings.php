...
class AdministrationViewThemesettings extends SugarView
{
    ...
    public function process()
    {
        ...
        if (isset($_REQUEST['default_theme']) && !in_array($_REQUEST['default_theme'],
                array_keys(SugarThemeRegistry::allThemes()))
        ) {
    ...
    public function display()
    {
        ...
        $this->ss->assign("THEMES",
            get_select_options_with_id(SugarThemeRegistry::allThemes(), $GLOBALS['sugar_config']['default_theme']));
