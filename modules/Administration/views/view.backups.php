...
class ViewBackups extends SugarView
{
    ...
    public function display()
    {
        ...
        if ($run == 'done') {
            ...
            echo $mod_strings['LBL_BACKUP_FILE_STORED'] . " {$backup_dir}/{$backup_zip} ({$size} bytes).<br>\n";
            echo '<a href="index.php?module=Administration&action=index">' . $mod_strings['LBL_BACKUP_BACK_HOME'] . "</a>\n";
        } else {
            ?>
            ...
            <tr>
                ...
                <td><input size="100" type="input" name="backup_dir" <?php echo $input_disabled; ?> value="<?php echo $backup_dir; ?>"/></td>
            </tr>
            <tr>
                <td><?php echo $mod_strings['LBL_BACKUP_FILENAME']; ?></td>
                <td><input type="input" name="backup_zip" <?php echo $input_disabled; ?> value="<?php echo $backup_zip; ?>"/></td>
            </tr>
            </table>
