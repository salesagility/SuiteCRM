...
/**
* @package Module Activity Dashlet:
*
* @author Rick Timmis <Rick.Timmis@Abazander.com>
* 
* Enables reporting of records created by a selected set of users on a selected set of modules
