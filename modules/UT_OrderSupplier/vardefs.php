...
$dictionary['UT_OrderSupplier'] = array(
    'table' => 'ut_ordersupplier',
    'audited' => true,
    'fields' => array(
        'billing_account_id' =>
            array(
        ...
        'aos_invoices_ut_ordersupplier' =>
            array(
                'name' => 'aos_invoices_ut_ordersupplier',
                'vname' => 'LBL_AOS_INVOICES_UT_ORDERSUPPLIER',
                'type' => 'link',
                'relationship' => 'aos_invoices_ut_ordersupplier',
                'source' => 'non-db',
                'module' => 'AOS_Invoices',
            ),
        'aos_products_quotes' =>
            array(
                ...
                'type' => 'link',
                'relationship' => 'ut_ordersupplier_aos_product_quotes',
        ...
        'aos_line_item_groups' =>
            array(
                ...
                'type' => 'link',
                'relationship' => 'ut_ordersupplier_aos_line_item_groups',
    ...
    'relationships' => array(
        'ut_ordersupplier_aos_product_quotes' =>
            array(
                'lhs_module' => 'UT_OrderSupplier',
                'lhs_table' => 'ut_ordersupplier',
                'lhs_key' => 'id',
        ...
        'ut_ordersupplier_aos_line_item_groups' =>
            array(
                'lhs_module' => 'UT_OrderSupplier',
                'lhs_table' => 'ut_ordersupplier',
                'lhs_key' => 'id',
...
VardefManager::createVardef('UT_OrderSupplier', 'UT_OrderSupplier', array('basic', 'assignable', 'security_groups'));
