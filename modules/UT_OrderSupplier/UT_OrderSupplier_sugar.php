...
class UT_OrderSupplier_sugar extends Basic
{
    public $new_schema = true;
    public $module_dir = 'UT_OrderSupplier';
    public $object_name = 'UT_OrderSupplier';
    public $table_name = 'ut_ordersupplier';
