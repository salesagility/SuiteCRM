...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <!-- Ici correction lien CSS. -->
  <link rel="stylesheet" type="text/css" href="cache/themes/<?php echo $GLOBALS['theme']; ?>/css/Dawn/style.css" />
...
<?php
    ...
    $num_markers = count($this->bean->map_markers);
		...
		//Ici change pth car l'ancien été faux...
...
function setClusterControl() {
    ...
    controlUI.title = 'Cliquez pour basculer le regroupement'; //Ici changement traduction FR
    ...
    controlText.innerHTML = 'Regroupement'; //Ici changement traduction FR
...
function setDrawingControls() {
    ...
    controlUI.style.cursor = 'pointer';
    controlUI.style.textAlign = 'center';
    controlUI.title = 'Cliquez pour supprimer la forme sélectionnée'; //Ici changement traduction FR
    ...
    controlText.innerHTML = 'Supprimer'; //Ici changement traduction FR
    controlUI.appendChild(controlText);
...
function setODataTable() {
    ...
    if (num_markers > 0) {
        ...
        oDataTable = $('#displayDataTable').dataTable({
			...
			//ICI Fait a l'aide de : https://datatables.net/extensions/buttons/examples/
			buttons: [
