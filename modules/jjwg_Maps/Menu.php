...
if(ACLController::checkAccess('jjwg_Maps', 'list', true)) $module_menu[]=Array("index.php?module=jjwg_Maps&action=quick_radius&return_module=jjwg_Maps&return_action=index", $GLOBALS['mod_strings']['LBL_MAP_QUICK_RADIUS'], "Quick_Radius_Map", 'jjwg_Maps');
