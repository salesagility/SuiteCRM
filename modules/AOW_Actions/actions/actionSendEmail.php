...
class actionSendEmail extends actionBase
{
     ...
     * @return array
     */
    private function getEmailsFromParams(SugarBean $bean, array $params)
    {
     ...
     */
    public function parse_template(SugarBean $bean, EmailTemplate &$template, $object_override = array())
    {
        global $sugar_config;
