...
<script type="text/javascript">
	...
	SUGAR.util.doWhen(check_cal_loaded, function(){literal}{{/literal}
        ...
        CAL.lbl_missing_subect = "{$APP.LBL_MISSING_SUBJECT}";
        CAL.lbl_missing_start_date = "{$APP.LBL_MISSING_START_DATE}";
        CAL.lbl_missing_end_date = "{$APP.LBL_MISSING_END_DATE}";
        CAL.lbl_invalid_dates = "{$APP.LBL_INVALID_DATES}";
        CAL.lbl_missing_duration = "{$APP.LBL_MISSING_DURATION}";
