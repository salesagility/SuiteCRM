...
if(module_name=="Tasks"){$('.modal-cal-tasks-edit .modal-body .container-fluid').html('<span class="title"><strong>'+SUGAR.language.get('Calendar','LBL_DATE')+'</strong></span>: '+(cal_event.start.format(global_datetime_format))+'<br><span class="title"><strong>'+SUGAR.language.get('Calendar','LBL_SUBJECT')+': </strong></span>'+((cal_event.title)?cal_event.title:''));$('.modal-cal-tasks-edit').modal('show');$('#btn-view-task').unbind().click(function(){window.location.assign('index.php?module='+cal_event.module+'&action=DetailView&record='+cal_event.record);});$('#btn-tasks-full-form').unbind().click(function(){window.location.assign('index.php?module='+cal_event.module+'&action=EditView&record='+cal_event.record);});}
...
+'<a href="index.php?action=EditView&module='+event.module+'&record='+event.id+'" class="btn btn-xs"><span class="glyphicon glyphicon-pencil"></span></a></div>';var body='<span class="title">'
