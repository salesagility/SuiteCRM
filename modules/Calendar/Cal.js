...
if($(view.target).hasClass('fc-day-top')&date_duration<=86400000){var jsDate=date._d;var url='index.php?module=Calendar&action=index&view=agendaDay&year='+date.format('YYYY')+'&month='+date.format('MM')+'&day='+date.format('DD')+'&hour=0';window.location.href=url;return false;}
