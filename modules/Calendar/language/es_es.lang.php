...
// DISYTEL: Additional Tanslation
$mod_list_strings['dom_cal_weekdays'][0] = 'Dom';
$mod_list_strings['dom_cal_weekdays'][1] = 'Lun';
$mod_list_strings['dom_cal_weekdays'][2] = 'Mar';
$mod_list_strings['dom_cal_weekdays'][3] = 'Mie';
$mod_list_strings['dom_cal_weekdays'][4] = 'Jue';
$mod_list_strings['dom_cal_weekdays'][5] = 'Vie';
$mod_list_strings['dom_cal_weekdays'][6] = 'Sab';
$mod_list_strings['dom_cal_weekdays_long'][0] = 'Domingo';
$mod_list_strings['dom_cal_weekdays_long'][1] = 'Lunes';
$mod_list_strings['dom_cal_weekdays_long'][2] = 'Martes';
$mod_list_strings['dom_cal_weekdays_long'][3] = 'Miércoles';
$mod_list_strings['dom_cal_weekdays_long'][4] = 'Jueves';
$mod_list_strings['dom_cal_weekdays_long'][5] = 'Viernes';
$mod_list_strings['dom_cal_weekdays_long'][6] = 'Sábado';
$mod_list_strings['dom_cal_month'][0] = '';
$mod_list_strings['dom_cal_month'][1] = 'Ene';
$mod_list_strings['dom_cal_month'][2] = 'Feb';
$mod_list_strings['dom_cal_month'][3] = 'Mar';
$mod_list_strings['dom_cal_month'][4] = 'Abr';
$mod_list_strings['dom_cal_month'][5] = 'May';
$mod_list_strings['dom_cal_month'][6] = 'Jun';
$mod_list_strings['dom_cal_month'][7] = 'Jul';
$mod_list_strings['dom_cal_month'][8] = 'Ago';
$mod_list_strings['dom_cal_month'][9] = 'Sep';
$mod_list_strings['dom_cal_month'][10] = 'Oct';
$mod_list_strings['dom_cal_month'][11] = 'Nov';
$mod_list_strings['dom_cal_month'][12] = 'Dic';
$mod_list_strings['dom_cal_month_long'][0] = '';
$mod_list_strings['dom_cal_month_long'][1] = 'Enero';
$mod_list_strings['dom_cal_month_long'][2] = 'Febrero';
$mod_list_strings['dom_cal_month_long'][3] = 'Marzo';
$mod_list_strings['dom_cal_month_long'][4] = 'Abril';
$mod_list_strings['dom_cal_month_long'][5] = 'Mayo';
$mod_list_strings['dom_cal_month_long'][6] = 'Junio';
$mod_list_strings['dom_cal_month_long'][7] = 'Julio';
$mod_list_strings['dom_cal_month_long'][8] = 'Agosto';
$mod_list_strings['dom_cal_month_long'][9] = 'Septiembre';
$mod_list_strings['dom_cal_month_long'][10] = 'Octubre';
$mod_list_strings['dom_cal_month_long'][11] = 'Noviembre';
$mod_list_strings['dom_cal_month_long'][12] = 'Diciembre';