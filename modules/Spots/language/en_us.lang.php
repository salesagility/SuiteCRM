...
$mod_strings = array(
    ...
    'LBL_RENDERERS_TABLE' =>'ENTable',
    'LBL_RENDERERS_TABLE_BARCHART' =>'ENTable Barchart',
    'LBL_RENDERERS_HEATMAP' =>'ENHeatmap',
    'LBL_RENDERERS_ROW_HEATMAP' =>'ENRow Heatmap',
    'LBL_RENDERERS_COL_HEATMAP' =>'ENCol Heatmap',
    'LBL_RENDERERS_LINE_CHART' =>'ENLine Chart',
    'LBL_RENDERERS_BAR_CHART' =>'ENBar Chart',
    'LBL_RENDERERS_STACKED_BAR_CHART' =>'ENStacked Bar',
    'LBL_RENDERERS_AREA_CHART' =>'ENArea Chart',
    'LBL_RENDERERS_SCATTER_CHART' =>'ENScatter Chart',

    'LBL_AGGREGATORS_COUNT' => 'ENCount',
    'LBL_AGGREGATORS_COUNT_UNIQUE_VALUES' => 'ENCount Unique Values',
    'LBL_AGGREGATORS_LIST_UNIQUE_VALUES' => 'ENList Unique Values',
    'LBL_AGGREGATORS_SUM' => 'ENSum',
    'LBL_AGGREGATORS_INTEGER_SUM' => 'ENInteger Sum',
    'LBL_AGGREGATORS_AVERAGE' => 'ENAverage',
    'LBL_AGGREGATORS_MINIMUM' => 'ENMinimum',
    'LBL_AGGREGATORS_MAXIMUM' => 'ENMaximum',
    'LBL_AGGREGATORS_SUM_OVER_SUM' => 'ENSum over Sum',
    'LBL_AGGREGATORS_80%_UPPER_BOUND' => 'EN80% Upper Bound',
    'LBL_AGGREGATORS_80%_LOWER_BOUND' => 'EN80% Lower Bound',
    'LBL_AGGREGATORS_SUM_AS_FRACTION_OF_TOTAL' => 'ENSum as Fraction of Total',
    'LBL_AGGREGATORS_SUM_AS_FRACTION_OF_ROWS' => 'ENSum as Fraction of Rows',
    'LBL_AGGREGATORS_SUM_AS_FRACTION_OF_COLUMNS' => 'ENSum as Fraction of Columns',
    'LBL_AGGREGATORS_COUNT_AS_FRACTION_OF_TOTAL' => 'ENCount as Fraction of Total',
    'LBL_AGGREGATORS_COUNT_AS_FRACTION_OF_ROWS' => 'ENCount as Fraction of Rows',
    'LBL_AGGREGATORS_COUNT_AS_FRACTION_OF_COLUMNS' => 'ENCount as Fraction of Columns',

    'LBL_LOCALE_STRINGS_RENDER_ERROR' => 'ENAn error occurred rendering the PivotTable results.',
    'LBL_LOCALE_STRINGS_COMPUTING_ERROR' => 'ENAn error occurred computing the PivotTable results.',
    'LBL_LOCALE_STRINGS_UI_RENDER_ERROR' => 'ENAn error occurred rendering the PivotTable UI.',
    'LBL_LOCALE_STRINGS_SELECT_ALL' => 'ENSelect All',
    'LBL_LOCALE_STRINGS_SELECT_NONE' => 'ENSelect None',
    'LBL_LOCALE_STRINGS_TOO_MANY' => 'EN(too many to list)',
    'LBL_LOCALE_STRINGS_FILTER_RESULTS' => 'ENFilter results',
    'LBL_LOCALE_STRINGS_TOTALS' => 'ENTotals',
    'LBL_LOCALE_STRINGS_VS' => 'ENvs',
    'LBL_LOCALE_STRINGS_BY' => 'ENby',
);
