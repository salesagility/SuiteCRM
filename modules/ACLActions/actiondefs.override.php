 ...
 */
 ...
 $GLOBALS['ACLActionAccessLevels'] = [
     ...
     // BEGIN - SECURITY GROUPS
     ACL_ALLOW_GROUP => ['color' => '#0000A0', 'label' => 'LBL_ACCESS_GROUP', 'text_color' => 'white'], //securitygroup
     // END - SECURITY GROUPS
 ];
/*
 * $GLOBALS['ACLActions
...
$GLOBALS['ACLActions'] = [
    'module' => ['actions' => [
        ...
        'view' => [
            'aclaccess' => [ACL_ALLOW_ALL, ACL_ALLOW_GROUP, ACL_ALLOW_OWNER, ACL_ALLOW_DEFAULT, ACL_ALLOW_NONE],
