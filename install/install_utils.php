    ...
    if ($uninstall) {
        ...
        if (isset($_SESSION['INSTALLED_LANG_PACKS']) && is_array($_SESSION['INSTALLED_LANG_PACKS'])) {
            foreach ($_SESSION['INSTALLED_LANG_PACKS'] as $k => $langPack) {
                if ($langPack == $zipFile) {
                    unset($_SESSION['INSTALLED_LANG_PACKS'][$k], $_SESSION['INSTALLED_LANG_PACKS_VERSION'][$k], $_SESSION['INSTALLED_LANG_PACKS_MANIFEST'][$k]);
...
function getSugarConfigLanguageArray($langZip)
{
    ...
    $ret = '';
    if (isset($installdefs['id'], $manifest['name'])) {
...
function handleSugarConfig()
{
    ...
    $sugar_config['filter_module_fields'] = [
        'Users' => [
            'show_on_employees',
            'portal_only',
            'is_group',
...
function handleWebConfig()
{
    ...
    $config_array = [
        ['1' => $prefix . str_replace('.', '\\.', $setup_site_log_file) . '\\.*', '2' => 'log_file_restricted.html'],
        ['1' => $prefix . 'install.log', '2' => 'log_file_restricted.html'],
        ['1' => $prefix . 'upgradeWizard.log', '2' => 'log_file_restricted.html'],
        ['1' => $prefix . 'emailman.log', '2' => 'log_file_restricted.html'],
        ['1' => 'not_imported_.*.txt', '2' => 'log_file_restricted.html'],
        ['1' => 'XTemplate/(.*)/(.*).php', '2' => 'index.php'],
        ['1' => 'data/(.*).php', '2' => 'index.php'],
        ['1' => 'examples/(.*).php', '2' => 'index.php'],
        ['1' => 'include/(.*).php', '2' => 'index.php'],
        ['1' => 'include/(.*)/(.*).php', '2' => 'index.php'],
        ['1' => 'log4php/(.*).php', '2' => 'index.php'],
        ['1' => 'log4php/(.*)/(.*)', '2' => 'index.php'],
        ['1' => 'metadata/(.*)/(.*).php', '2' => 'index.php'],
        ['1' => 'modules/(.*)/(.*).php', '2' => 'index.php'],
        ['1' => 'soap/(.*).php', '2' => 'index.php'],
        ['1' => 'emailmandelivery.php', '2' => 'index.php'],
        ['1' => 'cron.php', '2' => 'index.php'],
        ['1' => $sugar_config['upload_dir'] . '.*', '2' => 'index.php'],
    ];
...
function print_debug_comment()
{
    ...
    if (!empty($_SESSION['debug']) && ($_SESSION['debug'] == 'true')) {
        echo "<!-- debug is on (to turn off, hit any page with 'debug=false' as a URL parameter.\n";
...
function pullSilentInstallVarsIntoSession()
{
    ...
    $needles = ['demoData', 'setup_db_create_database', 'setup_db_create_sugarsales_user', 'setup_license_key_users',
 ...
 * @param mixed $uninstallable
 * @param mixed $showButtons
 *
 ...
 *
 * @param mixed $display_commit
 * @param mixed $types
 * @param mixed $notice_text
 *
...
{
    return 'https://docs.suitecrm.com/user/';
}
