...
$mod_strings = array(
	...
	'LBL_DBCONF_DB_ADMIN_PASSWORD'      => 'كلمة مرور المسؤول قاعدة البيانات',
...
<li>/upload</b></li></ul></li></ul>
	...
	'advanced_password_new_account_email' => array(
		...
		'txt_body' =>
			'هنا اسم المستخدم وكلمة المرور المؤقته الخاصة بحسابك:
اسم المستخدم: $contact_user_user_name
كلمة المرور: $contact_user_user_hash

$config_site_url

بعد الدخول مستخدما كلمة المرور أعلاه، ينبغي عليك تعيين كلمة مرور من اختيارك',
		'name' => 'كلمة السر المولدة بواسطة نظام البريد الإلكتروني',
	),
	'advanced_password_forgot_password_email' => array(
		'subject' => 'إعادة تعيين كلمة مرور الحساب الخاص بك',
		'description' => "يتم استخدام هذا القالب لإرسال رابط لمستخدم للنقر وإعادة تعيين كلمة مرور لحساب المستخدم.",
...
$contact_user_link_guid',
		'name' => 'نسيت كلمة مرور البريد الإلكتروني',
	),
