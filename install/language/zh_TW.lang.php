...
$mod_strings = array(
	...
	'ERR_CHECKSYS_CALL_TIME'            => 'Allow Call Time Pass Reference 是 On (此屬性在 php.ini 檔案中應設置為 Off)',
	'ERR_CHECKSYS_CURL'					=> '找不到: SuiteCRM 排程器將以有限的功能運行。',
	'ERR_CHECKSYS_IMAP'					=> '找不到: InboundEmail 和 Campaigns (Email) 需要 IMAP 函式庫。兩者都無法使用。',
	'ERR_CHECKSYS_MSSQL_MQGPC'			=> '使用 MS SQL Server時 Magic Quotes GPC 無法被打開。',
	...
	'ERR_LOG_DIRECTORY_REQUIRED'		=> '如果你想要自己指定，日誌目錄是必需的。',
	...
	'ERR_PERFORM_NO_TCPIP'				=> '<b>我們無法檢測到網際網路連線。</b>當你有連線時，請訪問 <a href="http://www.suitecrm.com/"> http://www.suitecrm.com/</a> 與 SuiteCRM 註冊。讓我們知道一點點關於你公司計畫如何使用 SuiteCRM，我們可以確保我們為您的業務需求提供正確的應用程式。',
	...
	'ERR_SI_NO_CONFIG'					=> '你沒有包含 config_si.php 在文檔根目錄，或是沒有在 config.php 中定義 $sugar_config_si',
	...
	'LBL_CHECKSYS_SESSION'				=> '可寫入的session路徑 (',
	'LBL_CHECKSYS_STATUS'				=> '狀態',
	'LBL_CHECKSYS_TITLE'				=> '系統檢查驗收',
	'LBL_CHECKSYS_VER'					=> '發現: ( ver ',
	...
	'LBL_DBCONF_SUGAR_DB_USER'          => 'SuiteCRM 資料庫使用者',
	...
	'LBL_DISABLED_TITLE'				=> 'SuiteCRM 安裝被禁用',
