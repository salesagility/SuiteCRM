...
'LBL_SITECFG_CUSTOM_ID'=> 'Укажите ваш личный ID приложения' ,
...
'LBL_WELCOME_PLEASE_READ_BELOW' => 'Пожалуйста, прочтите следующую информацию перед началом установки. Данная информация поможет вам определить, готовы ли вы к установке Suite.',
