...
$mod_strings = array(
	...
	'LBL_SYSOPTS_2'                     => 'Ce baza de date vreti sa instalati pt a fi folosit de SuiteCRM?',
	...
	'ERR_ADMIN_PASS_BLANK'				=> 'Furnizaţi parola pentru utilizatorul admin SuiteCRM.',

	//'ERR_CHECKSYS_CALL_TIME'			=> 'Allow Call Time Pass Reference is Off (please enable in php.ini)',
	'ERR_CHECKSYS'                      => 'Au fost detectate erori in timpul verificarii compatibilitatii. Pentru ca aplicatia dumneavoastra SuiteCRM sa functioneze corect, va rugam urmati urmatorii pasi pentru a rezolva problemele aparute si fie apasati butonul de reverificare, fie reinstalati aplicatia.',
	'ERR_CHECKSYS_CALL_TIME'            => 'Setarea "Allow Call Time Pass Reference" este activa. (Ar trebui sa fie setat ca oprit in php.ini)',
	'ERR_CHECKSYS_CURL'					=> 'Nu a fost găsit: SuiteCRM Scheduler va rula cu funcţionalitate limitată',
	...
	'ERR_CHECKSYS_PHP_INVALID_VER'		=> 'Versiunea dumneavoastra de PHP nu este suportata de SuiteCRM. Este necesar sa instalati o versiune compatibila cu aplicatia SuiteCRM. Pentru Versiuni PHP suportate va rugam sa consultati Matricea de Compatibilitate din cadrul Notelor. Versiunea dumneavoastra este',
	'ERR_CHECKSYS_IIS_INVALID_VER'      => 'Versiunea dvs. din IIS nu este susţinută de SuiteCRM. Veţi avea nevoie pentru a instala o versiune care este compatibilă cu aplicatia SuiteCRM. Va rugam sa consultati Compatibility Matrix în Notele de lansare pentru versiunile acceptate IIS. Versiunea ta este',
	'ERR_CHECKSYS_FASTCGI'              => 'Am detectat ca nu sunt folosite handler FastCGI pentru PHP. Veţi avea nevoie pentru a instala / configura o versiune care este compatibilă cu cererea SuiteCRM. Va rugam sa consultati Matrix compatibilitate în Notele de lansare pentru versiunile acceptate. Vă rugăm să consultaţi http://www.iis.net/php/ pentru detalii',
	...
	'LBL_CHECKSYS_XML_NOT_AVAILABLE'        => 'Functiile asociate cu Librariile de parsare XML care sunt necesare aplicatiei SuiteCRM nu au fost gasite. S-ar putea sa fie nevoie sa scoateti extensia in fisierul php.ini, sau sa recompilati cu fisierul binar corect, in functie de versiunea dumneavoastra de PHP. Va rugam sa reveniti la manualul PHP pentru mai multe informatii.',
	'ERR_CHECKSYS_MBSTRING'             => 'Functii asociate cu extensia "Multibyte Strings" (mbstring) care sunt necesare pentru SuiteCRM nu au fost gasite pe server. <br />In general modulul mbstring nu este activat in mod implicit si trebuie activat cu directiva --enable-mbstring cand binarul Php este construit. Va rugam consultati manualul Php pentru mai multe informatii asupra modului in care poate fi activat suportul pentru mbstring',
	...
	'ERR_CHECKSYS_ZLIB'					=> 'Nu a fost găsit: SuiteCRM culege beneficii enorme de performanţă cu compresie zlib.',
	'ERR_CHECKSYS_ZIP'					=> 'Suportul Zip nu a fost gasit: SuiteCRM are nevoie de suport ZIP pt a procesa fisierele comprimate',
	...
	'ERR_DB_MYSQL_VERSION'				=> 'MySQL versiune (% s) nu este suportat de SuiteCRM. Veţi avea nevoie pentru a instala o versiune care este compatibilă cu cererea de zahăr. Va rugam sa consultati Matrix de compatibilitate în notele de lansare pentru versiunile sprijinite de MySQL.',
	...
	'ERR_DB_PASSWORD'					=> 'Parolele furnizatde administratorul bazei de date pentru SuiteCRM nu se potrivesc. Vă rugăm să reintroduceţi aceleasi  parole în domeniile parola.',
	...
	'ERR_DB_USER_EXISTS'				=> 'Numele de utilizator pt baza de date SuiteCRM exista deja -- nu poate crea altul cu acelasi nume.Va rugam introduceti un nume de utilizator nou',
	'ERR_DB_USER'						=> 'Introduceti numele utilizatorului pentru administratorul bazei de date SuiteCRM.',
	'ERR_DBCONF_VALIDATION'				=> 'Te rog corecteaza urmatoarele erori inainte:',
	'ERR_DBCONF_PASSWORD_MISMATCH'      => 'Parolele furnizate pentru baza de date SuiteCRM nu corespund. Va rugam sa introduceti aceleasi parole in campurile de parola.',
	...
	'ERR_PASSWORD_MISMATCH'				=> 'Parolele furnizate pentru utilizatorul administrator SuiteCRM nu se potrivesc. Te rog sa reintroduci aceleasi parole in campurile pentru parole.',
	...
	'ERR_URL_BLANK'						=> 'Furnizeaza URL pentru instanta SuiteCRM.',
	...
	'ERROR_VERSION_INCOMPATIBLE'		=> 'Fisierul incarcat nu este compatibil cu aceasta versiune SuiteCRM:',

	'LBL_BACK'							=> 'Inapoi',
	'LBL_CANCEL'                        => 'Anulare',
	'LBL_ACCEPT'                        => 'Acceptat',
	'LBL_CHECKSYS_1'					=> 'Pentru ca instanta dumneavoastra SuiteCRM sa functioneze corect va rugam sa va asigurati ca toate itemele de mai jos sunt verzi. Daca exista iteme rosii va rugam sa faceti pasii necesari pentru a-i indrepta<br />Pentru ajutor in aceste verificari de sistem va rugam vizitati SuiteCRM Wiki.',
	...
	'LBL_CHECKSYS_CONFIG_OVERRIDE'		=> 'Scriere fişier de configurare SuiteCRM (config_override.php)',
	...
	'LBL_DBCONF_DB_DROP_CREATE'			=> 'Stergeti si recreati tabelele existente pentru SuiteCRM?',
	'LBL_DBCONF_DB_DROP'                => 'Sterge Tabele',
	'LBL_DBCONF_DB_NAME'				=> 'Nume baza de date',
	'LBL_DBCONF_DB_PASSWORD'			=> 'Parola Utilizator Baza de Date SuiteCRM',
	'LBL_DBCONF_DB_PASSWORD2'			=> 'Reintroduceti parola pentru userul bazei de date SuiteCRM',
	'LBL_DBCONF_DB_USER'				=> 'Utilizator Baza de Date SuiteCRM',
	'LBL_DBCONF_SUGAR_DB_USER'          => 'Utilizator Baza de Date SuiteCRM',
	...
	'LBL_DBCONFIG_MSG3'                 => 'Numele bazei de date care va contine informatiile pentru instanta SuiteCRM pe care o veti instala.',
	'LBL_DBCONFIG_MSG3_LABEL' => 'Nume baza de date',
	'LBL_DBCONFIG_B_MSG1'               => 'Userul si parola unui administrator al bazei de date care poate crea tabele si useri si care poate scrie in baza de date sunt necesare pentru a crea baza de date SuiteCRM',
	'LBL_DBCONFIG_B_MSG1_LABEL' => '',
	'LBL_DBCONFIG_SECURITY'             => 'Din motive de securitate trebuie sa specificati un user pentru baza de date exclusiv pentru conectarea la SuiteCRM. Acest user trebuie sa aibe drept de scriere, de modificare si de extragere a datelor din SuiteCRM. Acest user poate fi administratorul specificat mai sus sau puteti introduce informatii noi.',
	...
	'LBL_DISABLED_HELP_1'				=> 'Pentru ajutor la instalare va rugam vizitati SuiteCRM',
	'LBL_DISABLED_HELP_LNK'             => 'http://www.sugarcrm.com/forumuri/',
	'LBL_DISABLED_HELP_2'				=> 'forum de suport',
	'LBL_DISABLED_TITLE_2'				=> 'Instalarea SuiteCRM a fost oprita',
	'LBL_DISABLED_TITLE'				=> 'Instalarea SuiteCRM oprita',
	...
	'LBL_LANG_1'						=> 'Pentru a folosi o limba in SuiteCRM alta decat cea implicita (US-English) puteti uploada si instala pachetul limbii in acest moment. Veti putea instala pachete de limbi si din SuiteCRM. Daca doriti sa sariti peste acest pas va rugam apasati "Inainte"',
	...
	'LBL_LAUNCHING_SILENT_INSTALL'     => 'Se instaleaza SuiteCRM acum. Aceasta poate dura cateva minute.',
	...
	'LBL_LICENSE_TITLE_2'				=> 'Licenta SuiteCRM',
	...
	'LBL_LOCALE_DESC'					=> 'Setarile locale specificate se vor reflecta global in instanta SuiteCRM.',
	...
	'LBL_PERFORM_CONFIG_PHP'			=> 'Creaza fisierul de configurare SuiteCRM',
	...
	'LBL_PERFORM_CREATE_DEFAULT'		=> 'Creaza date SuiteCRM implicite',
	'LBL_PERFORM_CREATE_LOCALHOST'		=> 'Creaza usernameul si parola bazei de date pentru localhost...',
	'LBL_PERFORM_CREATE_RELATIONSHIPS'	=> 'Creaza legaturile tabelelor SuiteCRM',
	...
	'LBL_PERFORM_TABLES'				=> 'Creaza tabelele aplicatiei SuiteCRM, tabelele de audit si metadatele realtionale',
	'LBL_PERFORM_TITLE'					=> 'Efectueaza Setup',
	'LBL_PRINT'							=> 'Imprimare',
	'LBL_REG_CONF_1'					=> 'Va rugam completati formularul de mai jos pentru a primi anunturi, stiri despre training, oferte speciale si invitatii de la SuiteCRM. Nu vindem, inchiriem sau distribuim in alt fel catre terti informatia colectata aici.',
	...
	'LBL_REG_CONF_3'					=> 'Va multumim pentru inregistrare. Apasati butonul pentru a va loga in SuiteCRM. Va trebui sa va logati pentru prima data folosind usernamul "admin" si parola pe care ati introdus-o la pasul 2.',
	...
	'LBL_SITECFG_ADMIN_Name'            => 'Userul pentru administratorul SuiteCRM.',
	'LBL_SITECFG_ADMIN_PASS_2'			=> 'Reintroduceti parola de admin pentru SuiteCRM',
	'LBL_SITECFG_ADMIN_PASS_WARN'		=> 'Atenţie: Aceasta va suprascrie parola de admin a oricarei instalari anterioare.',
	'LBL_SITECFG_ADMIN_PASS'			=> 'Parola de administrator pentru SuiteCRM',
	'LBL_SITECFG_APP_ID'				=> 'ID-ul aplicatiei',
	'LBL_SITECFG_CUSTOM_ID_DIRECTIONS'	=> 'Daca va fi selectat, trebuie sa furnizati un ID pt a trece peste id-ul generat.Id-ul asigura ca instanta SuiteCRM nu este utilizat ade alta instanta',
	'LBL_SITECFG_CUSTOM_ID'				=> 'Furnizaţi propriul ID pentru aplicatie',
	'LBL_SITECFG_CUSTOM_LOG_DIRECTIONS'	=> 'Daca este selectat trebuie sa specificati un director pentru a suprascrie directorul implicit pentru loguri al lui SuiteCRM. Oriunde ar fi localizat fisierul de loguri accesul printr-un browser web va fi restrictionat printr-un redirect de tip .htaccess',
	'LBL_SITECFG_CUSTOM_LOG'			=> 'Folositi un director pentru loguri personalizat.',
	'LBL_SITECFG_CUSTOM_SESSION_DIRECTIONS'	=> 'Daca este selectat trebuie sa indicati un director securizat pentru a stoca informatiile de sesiune ale SuiteCRM. Acest lucru poate fi facut pentru a preveni vulnerabilitatile dintr-un mediu comun.',
	...
	'LBL_SITECFG_SUGAR_UPDATES'			=> 'Actualizări SuiteCRM Config',
	...
	'LBL_SITECFG_URL'					=> 'URL-ul Instantei SuiteCRM',
	'LBL_SITECFG_USE_DEFAULTS'			=> 'Utilizare Implicita?',
	'LBL_SITECFG_ANONSTATS'             => 'Trimiteti statistici anonime?',
	'LBL_SITECFG_ANONSTATS_DIRECTIONS'  => 'Daca este selectat SuiteCRM va trimite statisitici anonime despre instanta dumneavoastra catre SuiteCRM Inc. de fiecare data cand sistemul verifica existanta a unei noi versiuni. Informatia ne va ajuta sa intelegem mai bine cum se foloseste aplicatia si va ajuta la imbunatatirea produsului.',
	'LBL_SITECFG_URL_MSG'               => 'Introduceţi URL-ul care vor fi folosite pentru a accesa instanţă SuiteCRM după instalare. URL-ul va fi de asemenea utilizat ca bază pentru adresele URL în paginile aplicatiei SuiteCRM. URL-ul ar trebui să includă pe serverul web nume de masina sau adresa IP.',
	'LBL_SITECFG_SYS_NAME_MSG'          => 'Introduceţi un nume pentru sistemul dvs.. Acest nume va fi afişat în bara de titlu browser-ului atunci când utilizatorii vizitează aplicatia SuiteCRM',
	'LBL_SITECFG_PASSWORD_MSG'          => 'După instalare, va trebui să utilizaţi utilizator SuiteCRM admin (nume de utilizator implicit = admin) pentru a intra în instanţă la SuiteCRM. Introduceţi o parolă pentru acest utilizator administrator. Aceasta parola poate fi modificata dupa autentificare iniţială. Puteţi introduce, de asemenea, un alt nume de utilizator admin să folosească în afară de valoarea implicită furnizata.',
...
//	'LBL_NO_THANKS'						=> 'Continue to installer',
	...
	'LBL_WELCOME_1'						=> 'Aceasta instalare creeaza tabelele SuiteCRM baza de date şi seturi de variabile de configurare de care aveţi nevoie pentru a incepe. Întregul proces ar trebui să ia aproximativ zece minute.',
	...
	'REQUIRED_SYS_COMP_MSG' =>
		'Inainte sa incepeti va rugam verificati ca aveti versiunile suportate din urmatoarele compeonente:<br />- Sistem de management al bazelor de date (Exemple: MySql, SQL Server, Oracle)<br />- Server web (Apache, IIS)<br />Consultati matricea de compatibilitati pentru sistemele compatibile cu versiunea de SuiteCRM pe care o instalati',
	'REQUIRED_SYS_CHK' => 'Sistem de control initial',
	'REQUIRED_SYS_CHK_MSG' =>
		'Cand incepeti procesul de instalare webserverul pe care instalati SuiteCRM va fi verificat pentru a fi siguri ca sistemul pe care instalati aplicatia este configurat corect si are toate componentele necesare pentru a termina cu succes instalarea.<br /><br />Sistemul va verifica urmatoarele componente:<br />- Versiunea Php - trebuie sa fie una compatibila cu aplicatia<br />- Variabilele de sesiune - trebuie sa functionze corespunzator<br />-MB Strings - trebuie sa fie instalat si functional in php.ini<br />-Suport pentru baza de date - trebuie sa existe MySql, Sql Server sau Oracle<br />- Config.php - trebuie sa existe si trebuie sa aibe permisiunile necesare pentru a se putea scrie<br />-Urmatoarele fisiere din SuiteCRM trebuie sa aibe drepturi de scriere:<br />- /custom<br />- /cache<br />- /modules<br /><br />Daca verificarile nu se termina cu succes nu puteti incepe instalarea. Un mesaj de eroare va fi afisat explicand de ce sistemul dumneavoastra nu a trecut verificarea. Dupa ce faceti schimbarile necesare puteti verifica sistemul din nou si continua instalarea.',
	'REQUIRED_INSTALLTYPE' => 'Instalare tipica sau particularizata',
	'REQUIRED_INSTALLTYPE_MSG' =>
		'Dupa ce verificarea sistemului este completa, puteti alege intre instalare Standard sau Personalizata<br /><br />Atat pentru instalare Standard cat si pentru Personalizata, va trebui sa stiti urmatoarele:<br /><br />    * Tipul de baza de date care va gazdui datele SuiteCRM<br />          o Bazele de date comnpatibile: MySQL, MS SQL Server, Oracle.<br /><br />    * Numele serverului web, sau a gazdei unde va fi situata baza de date<br />          o Acesta poate fi localhost daca baza de date este pe calculatorul dumneavoastra sau este pe acelasi server sau gazda ca si fisierele SuiteCRM<br /><br />    * Numele bazei de date pe care doriti sa o folositi pentru a gazdui datele SuiteCRM<br />          o S-ar putea sa aveti deja o baza de date pe care doriti sa o folositi. Daca furnizati numele unei baze de date deja existente tabelele vor fi scoase in timpul instalarii cand schema pentru baza de date SuiteCRM e definita.<br />          o Daca nu aveti deja o baza de date, numele pe care il furnizati va fi folosit pentru baza de date noua, creata in timpul instalarii.<br /><br />    * Nume de utilizator si parola pentru administratorul bazei de date<br />          o Administratorul bazei de date ar trebui sa poata crea tabele, utilizatori si sa modifice baza de date.<br />          o S-ar putea sa fie nevoie sa contactati administratorul bazei de date pentru aceasta informatie, daca baza de date nu e situata pe calculatorul dumneavoastra si/sau nu sunteti administratorul bazei de date.<br /><br />    * Nume de utilizator si parola SuiteCRM<br />          o Utilizatorul poate fi administratorul bazei de date sau puteti furniza numele altui utilizator existent.<br />          o Daca doriti sa creati un nou utilizator al bazei de date in acest scop, veti putea furniza un nou nume de utilizator si parola in timpul procesului de instalare, si utilizatorul va fi creat in timpul instalarii.<br /><br />Pentru setarea Personalizata, s-ar putea sa fie nevoie sa stiti si urmatoarele:<br /><br />    * URL-ul care va fi folosit pentru a accesa instanta SuiteCRM dupa ce este instalata. Acest URL ar trebui sa includa serverul web sau numele gazdei sau IP-ul.<br /><br />    * [Optional] Adresa catre directorul sesiune daca doriti sa utilizati un director sesiune personalizat pentru informatiile SUgar, pentru a impiedica datele sesiunii de a fi vulnerabile pe servere impartite.<br /><br />    * [Optional] Adresa catre un director jurnal Personalizat daca doriti sa inlocuiti directorul standard pentru Jurnalul SuiteCRM<br /><br />    * [Optional] ID-ul aplicatiei, daca doriti sa suprascrieti ID-ul generat automat care asigura ca sesiunile unei instante SuiteCRM nu sunt folosite de alte instante.<br /><br />    * Setul de caractere folosit cel mai des pe plan local.<br /><br />Pentru informatii mai detaliate, va rugam consultati Ghidul de Instalare.',
	...
	'LBL_WIZARD_TITLE'					=> 'Setari SuiteCRM',
	'LBL_YES'							=> 'Da',
	...
	'LBL_WIZARD_SMTP_DESC' => 'Furnizeti contul de e-mail care va fi folosit pentru a trimite email-uri, cum ar fi notificările şi atribuirea unei noi parole de utilizator. Utilizatorii vor primi e-mailuri de la SuiteCRM, ca fiind trimis de la contul de e-mail specificată.',
	...
	'LBL_WIZARD_SYSTEM_DESC' => 'Furnizaţi numele organizaţiei dvs. şi logo-ul pentru a marca SuiteCRM dumneavoastră.',
	...
	'CURRENT_LOGO_HELP'=>'Acest logo este afişat în colţul din stânga-sus al aplicatiei SuiteCRM.',
	...
	'LBL_WIZARD_LOCALE_DESC' => 'Specificaţi cum doriţi date în SuiteCRM pentru a fi afişate, în funcţie de locaţia dvs. geografică. Setările pe care le furnizaţi aici vor fi setările implicite. Utilizatorii vor putea stabili propriile lor de pre',
