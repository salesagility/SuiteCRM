...
$mod_strings = array(
	...
	'ERR_PERFORM_NO_TCPIP'				=> 'Неможливо підключитися до інтернету. Коли з&#039;єднання буде доступне, будь ласка, зареєструйтеся в SuiteCRM за посиланням: <a href="http://www.suitecrm.com/">http://www.suitecrm.com/</a>.',
	...
	'ERROR_VERSION_INCOMPATIBLE'		=> 'Завантажуваний файл не сумісний з встановленою версією SuiteCRM:',

	'LBL_BACK'							=> 'Назад',
	'LBL_CANCEL'                        => 'Скасування',
	'LBL_ACCEPT'                        => 'Приймаю',
	'LBL_CHECKSYS_1'					=> 'Для того, щоб установка SuiteCRM працювала правильно, будь ласка, переконайтеся, що всі розташовані нижче пункти пофарбовані в зелений колір. Якщо в списку присутні пункти, пофарбовані в червоний колір, будь ласка, виконайте необхідні дії для усунення зазначених помилок.<br / > За додатковою довідкою з цього питання Ви можете звернутися до <a href="http://www.suitecrm.com" target="_blank">SuiteCRM Wiki</a>.',
	...
	'LBL_DBCONF_DB_DROP_CREATE_WARN'	=> 'Обережно: всі дані SuiteCRM будуть видалені, <br / > якщо встановити цей параметр.',
	'LBL_DBCONF_DB_DROP_CREATE'			=> 'Видалити і створити заново таблиці SuiteCRM?',
	...
	'LBL_DISABLED_TITLE'				=> 'Можливість установки SuiteCRM відключена',
	...
	'LBL_LOCALE_DESC'					=> 'Позначені локальні установки будуть відображені глобально всередині екземпляра SuiteCRM.',
	...
	'LBL_PERFORM_CREATE_RELATIONSHIPS'	=> 'Створення таблиць відносин SuiteCRM',
	...
	'LBL_SITECFG_SUGAR_UPDATES'			=> 'Конфігурація оновлень SuiteCRM',
...
//	'LBL_NO_THANKS'						=> 'Continue to installer',
	...
	'LBL_WELCOME_1'						=> 'Цей установщик створює базу даних SuiteCRM і встановлює конфігурацію змінних, які необхідні для початку. Весь процес займе близько 10 хвилин.',
...
Більш детальну інформацію Ви можете знайти у Посібнику по установці.',
	...
	'LBL_WELCOME_TITLE'					=> 'Майстер налаштування SuiteCRM',
