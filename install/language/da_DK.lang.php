...
$mod_strings = array(
	...
	'ERROR_VERSION_INCOMPATIBLE'		=> 'Den uploadede fil er ikke kompatibel med denne version af SuiteCRM: ',
	...
	'LBL_DBCONF_DB_DROP_CREATE_WARN'	=> 'Vigtigt! Alle SuiteCRM-data slettes,<br>hvis dette felt er markeret.',
	'LBL_DBCONF_DB_DROP_CREATE'			=> 'Vil du droppe og oprette eksisterende SuiteCRM-tabeller igen?',
	...
	'LBL_DISABLED_TITLE'				=> 'Installationen af SuiteCRM er deaktiveret',
	...
	'LBL_LOCALE_DESC'					=> 'De angivne landestandardindstillinger afspejles globalt i SuiteCRM-forekomsten.',
	...
	'LBL_PERFORM_CREATE_RELATIONSHIPS'	=> 'Opretter SuiteCRM-relationstabeller',
	...
	'LBL_SITECFG_SUGAR_UPDATES'			=> 'Konfiguration af SuiteCRM-opdateringer',
...
//	'LBL_NO_THANKS'						=> 'Continue to installer',
	...
	'LBL_WELCOME_1'						=> 'Dette installationsprogram opretter SuiteCRM-databasetabellerne og angiver de konfigurationsvariabler, du skal bruge for at starte. Hele processen tager cirka ti minutter.',
	...
	'REQUIRED_SYS_COMP_MSG' =>
		'Før du starter, skal du sikre dig, at du har de understøttede versioner af følgende systemkomponenter:<br> <ul> <li> Database/databaseadministrationssystem "eksempler: MySQL, SQL Server, Oracle"</li> <li> Webserver "Apache, IIS"</li> </ul> Se kompatibilitetsmatrixen "Compatibility Matrix" i produktbemærkningerne "Release Notes" for kompatible komponenter til den SuiteCRM-version, du vil installere.<br>',
	'REQUIRED_SYS_CHK' => 'Indledende systemkontrol',
	'REQUIRED_SYS_CHK_MSG' =>
		'Når du starter installationsprocessen, udføres der en systemkontrol på den webserver, hvor SuiteCRM-filerne er placeret, for at sikre, at systemet er korrekt konfigureret og har alle de nødvendige komponenter til at fuldføre installationen. <br><br> Systemet tjekker alle følgende elementer:<br> <ul> <li><b>PHP-version</b>  skal være kompatibel med programmet</li> <li><b>Sessionsvariabler</b>  skal fungere korrekt</li> <li> <b>MB-strenge</b>  skal være installeret og aktiveret i php.ini</li> <li> <b>Databaseunderstøttelse</b>  skal foreligge for MySQL, SQL Server eller Oracle</li> <li> <b>Config.php</b>  skal foreligge og have de korrekte tilladelser, så den kan gøres skrivbar</li> <li>Følgende SuiteCRM-filer skal være skrivbare:<ul><li><b>/custom</li> <li>/cache</li> <li>/modules</b></li></ul></li></ul> Hvis resultatet af kontrollen viser fejl, kan du ikke fortsætte med installationen. En fejlmeddelelse vises og fortæller, hvorfor systemet ikke bestod kontrollen. Når du har foretaget alle nødvendige ændringer, kan du køre systemkontrollen igen for at fortsætte installationen.<br>',
	...
	'LBL_WELCOME_TITLE'					=> 'Guiden Installation af SuiteCRM',
...
$contact_user_link_guid',
	...
	'CURRENT_LOGO_HELP'=>'Dette logo vises i øverste venstre hjørne af SuiteCRM-programmet.',
