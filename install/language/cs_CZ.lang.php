...
$mod_strings = array(
	...
	'ERR_ADMIN_PASS_BLANK'				=> 'Vložte heslo pro administrátora SuiteCRM. ',

	//'ERR_CHECKSYS_CALL_TIME'			=> 'Allow Call Time Pass Reference is Off (please enable in php.ini)',
	'ERR_CHECKSYS'                      => 'Během kontroly kompatibility byly detekovány chyby. Aby Vaše SuiteCRM instalace fungovala korektně, proveďte, prosím, kroky potřebné k odstranění problémů a buď stiskněte tlačítko Opakuj kontrolu nebo zkuste opakovat instalaci.',
	'ERR_CHECKSYS_CALL_TIME'            => 'Call Time PassReference je vypnuta (aktivujte v php.ini)',
	'ERR_CHECKSYS_CURL'					=> 'Nenalezeno: SuiteCRM plánovač poběží s omezenou funkcionalitou.',
	...
	'ERR_URL_BLANK'						=> 'Zvolte základní URL pro SuiteCRM instanci.',
	...
	'LBL_CHECKSYS_PCRE'					=> 'PCRE knihovna',
	...
	'LBL_DBCONF_DB_DROP_CREATE_WARN'	=> 'Varování: Pokud je políčko zaškrtnuto,<br>všechna SuiteCRM data budou vymazána.',
	'LBL_DBCONF_DB_DROP_CREATE'			=> 'Smazat a vytvořit znovu existující SuiteCRM tabulky?',
	'LBL_DBCONF_DB_DROP'                => 'Smazat tabulky',
	'LBL_DBCONF_DB_NAME'				=> 'Jméno databáze',
	'LBL_DBCONF_DB_PASSWORD'			=> 'Heslo pro uživatele SuiteCRM databáze',
	'LBL_DBCONF_DB_PASSWORD2'			=> 'Opakovaně vložte heslo pro uživatele SuiteCRM databáze',
	'LBL_DBCONF_DB_USER'				=> 'Uživatel databáze SuiteCRM',
	'LBL_DBCONF_SUGAR_DB_USER'          => 'Uživatel databáze SuiteCRM',
	...
	'LBL_DBCONFIG_MSG3'                 => 'Jméno databáze, která bude obsahovat data SuiteCRM instance, kterou se chystáte nainstalovat:',
	...
	'LBL_LOCALE_DESC'					=> 'Zvolená lokální nastavení budou aplikována globálně v celé SuiteCRM instanci.',
	...
	'LBL_SITECFG_ADMIN_PASS_2'			=> 'Vložte znova heslo SuiteCRM administrátora',
	...
	'LBL_SITECFG_TITLE2'                => 'Specifikujte Vaší SuiteCRM instanci',
	...
	'LBL_SITECFG_ANONSTATS_DIRECTIONS'  => 'Při této volbě bude SuiteCRM pravidelně při každé kontole existence aktualizované verze zasílat anonymní statistiky o Vaší instalaci firmě SuiteCRM Inc. Tato informace nám pomůže lépe porozumět jak je aplikace využívána a pomůže ve zlepšování produktu.',
	...
	'LBL_STEP1' => 'Krok 1 ze 2 - Před instalační požadavky',
...
//	'LBL_NO_THANKS'						=> 'Continue to installer',
	...
	'LBL_WELCOME_1'						=> 'Instalátor vytvoří SuiteCRM databázové tabulky a nastaví konfigurační proměnné, tak aby jste mohli začít. Celý proces by měl zabrat kolem deseti minut.',
...
<li>/upload</b></li></ul></li></ul>
	...
	'LBL_WELCOME_TITLE'					=> 'Průvodce instalací SuiteCRM',
	...
	'LBL_OOTB_REMOVE_DOCUMENTS_FROM_FS' => 'Odstranění dokumentů z filesystem',
	...
	'LBL_REQUIRED_SYSTEM_NAME'=>'Zvolte systémové jméno pro SuiteCRM instanci.',
	...
	'LBL_BACKWARD_COMPATIBILITY_ON' => 'Tvoje verze PHP není kompatibilní s SuiteCRM. Postupuj prosím dle požadovaných parametrů pro systém.',
	'LBL_STREAM' => 'PHP dovoluje použití stream',
...
After you log in using the above password, you may be required to reset the password to one of your own choice.',
	...
	'advanced_password_forgot_password_email' => array(
		'subject' => 'Obnovení hesla k účtu',
		'description' => "Tato šablona slouží k odesílání odkazu uživateli, který je na obnovu hesla k účtu uživatele.",
		'body' => '<div><table border=\\"0\\" cellspacing=\\"0\\" cellpadding=\\"0\\" width="550" align=\\"\\&quot;\\&quot;center\\&quot;\\&quot;\\"><tbody><tr><td colspan=\\"2\\"><p>Nedávno jste požádal na $contact_user_pwd_last_changed o možnost obnovení hesla. </p><p>Klikněte na níže uvedený odkaz pro obnovení hesla:</p><p> $contact_user_link_guid </p>  </td>         </tr><tr><td colspan=\\"2\\"></td>         </tr> </tbody></table> </div>',
		'txt_body' =>
			'
...
$contact_user_link_guid',
		'name' => 'Zapomněli jste heslo',
	),

	// SMTP settings

	'LBL_WIZARD_SMTP_DESC' => 'Zadejte e-mailový účet, který bude použit k odeslání e-mailů, například přiřazení upozornění a nové heslo uživatele. Uživatelé budou dostávat e-maily ze systému SuiteCRM, odeslané ze zadaného e-mailového účtu.',
	...
	'CURRENT_LOGO_HELP'=>'Toto logo se zobrazí v levém rohu zápatí aplikace SuiteCRM.',
	...
	'ERR_LANG_UPLOAD_UNKNOWN' => 'Objevil se neznámý error při uploudu souboru.',
	...
	'ERR_ADMIN_EMAIL' => 'Emailová adresa administrátora je nevalidní.',
	'ERR_SITE_URL' => 'Je požadována adresa (URL).',

	'STAT_CONFIGURATION' => 'Konfigurace vazeb...',
	'STAT_CREATE_DB' => 'Vytvářím databázi...',
	//'STAT_CREATE_DB_TABLE' => 'Create database... (table: %s)',
	'STAT_CREATE_DEFAULT_SETTINGS' => 'Vytvářím výchozí nastavení...',
	'STAT_INSTALL_FINISH' => 'Instalace dokončena...',
	'STAT_INSTALL_FINISH_LOGIN' => 'Installation process finished, <a href="%s">please log in...</a>',
	'LBL_LICENCE_TOOLTIP' => 'Prosím, nejprve odsouhlaste licenci',
