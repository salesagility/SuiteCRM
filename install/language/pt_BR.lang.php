...
$mod_strings = array(
	...
	'ERR_CHECKSYS_PHP_INVALID_VER'		=> 'A sua versão de PHP não é suportada pelo SuiteCRM. É necessário instalar uma versão que seja compatível com a aplicação SuiteCRM. Por favor consulte a Matriz de Compatibilidade nas Notas de Lançamento para Versões PHP suportadas. A sua versão é ',
	...
	'ERR_CHECKSYS_SESSION_SAVE_PATH_NOT_SET'       => 'A definição session.save_path no seu arquivo de configuração php (php.ini) não está configurada ou está definida para um local inexistente. Talvez seja necessário definir o save_path em php.ini ou verificar se a pasta definida em save_path existe.',
	'ERR_CHECKSYS_SESSION_SAVE_PATH_NOT_WRITABLE'  => 'A definição session.save_path no seu arquivo de configuração php (php.ini) está configurada para uma pasta que não é editável. Por favor tome as medidas necessárias para tornar a pasta editável. <br>Dependendo do seu sistema operacional, pode ser necessário alterar as permissões executando o chmod 766, ou clicar com o botão direito no nome do arquivo para acessar às propriedades e desmarcar a opção somente leitura.',
	...
	'LBL_CHECKSYS_1'					=> 'Para que a sua instalação SuiteCRM funcione corretamente, por favor assegure-se que todos os itens de verificação do sistema abaixo listados estão a verde. Se algum deles estiver a vermelho, por favor tome as medidas necessárias para o corrigir.<BR><BR> Para mais ajuda sobre estas verificações de sistema, por favor visite a <a href="http://www.suitecrm.com" target="_blank">SuiteCRM Wiki</a>.',
	...
	'LBL_CHECKSYS_CONFIG_OVERRIDE'		=> 'Arquivo de configuração gravável SuiteCRM (config_override.php)',
	...
	'LBL_DBCONF_DB_DROP_CREATE_WARN'	=> 'Atenção: Todos os dados do SuiteCRM serão apagados<br>se esta caixa estiver verificada.',
	'LBL_DBCONF_DB_DROP_CREATE'			=> 'Remover e Recriar as tabelas SuiteCRM Existentes?',
	...
	'LBL_DISABLED_TITLE_2'				=> 'Instalação SuiteCRM foi Desativada',
	'LBL_DISABLED_TITLE'				=> 'Instalação SuiteCRM Desativada',
	...
	'LBL_LOCALE_DESC'					=> 'As definições locais especificadas serão refletidas globalmente dentro da instância SuiteCRM.',
	...
	'LBL_PERFORM_CREATE_DEFAULT'		=> 'criar dados padrão do SuiteCRM',
	'LBL_PERFORM_CREATE_LOCALHOST'		=> 'criar o nome do usuário e senha da Base de Dados para o servidor local...',
	'LBL_PERFORM_CREATE_RELATIONSHIPS'	=> 'criar tabelas de relacionamento do SuiteCRM',
	...
	'LBL_REG_CONF_3'					=> 'Obrigado por se registar. Clique no botão Concluir para acessar ao SuiteCRM. É necessário fazer o login pela primeira vez utilizando o nome "admin" e a senha que inseriu no passo 2.',
...
//	'LBL_NO_THANKS'						=> 'Continue to installer',
	...
	'LBL_WELCOME_1'						=> 'Este instalador cria as tabelas da base de dados do SuiteCRM e define as variáveis de configuração que necessita para iniciar. O processo completo deve levar cerca de dez minutos.',
	...
	'LBL_OOTB_TRACKER'		=> 'Remover tabelas de rastreadores apagados',
