...
$mod_strings = array(
	...
	'LBL_MAKE_DIRECTORY_WRITABLE'      => 'لطفا راهنمای زیر را قابل نوشتن:',
	...
	'ERR_CHECKSYS_CALL_TIME'            => 'اجازه تماس هم مرجع تصویب است در (این به در php.ini مجموعه ای خاموش شود باید)',
	...
	'ERR_CHECKSYS_MSSQL_MQGPC'			=> 'زمانی که از MS SQL Server استفاده مسگیشود امکان فعال کردن ویژگی Magic Quotes GPC وجود ندارد.',
	'ERR_CHECKSYS_MEM_LIMIT_0'			=> 'هشدار: ',
	'ERR_CHECKSYS_MEM_LIMIT_1'			=> ' (این مجموعه ',
	'ERR_CHECKSYS_MEM_LIMIT_2'			=> 'متر و یا بزرگتر در فایل php.ini)',
	'ERR_CHECKSYS_MYSQL_VERSION'		=> 'حداقل نسخه 4.1.2 - در بر داشت: ',
	'ERR_CHECKSYS_NO_SESSIONS'			=> 'نوشتن و خواندن متغیر های session مشکل داشت. ادامه ی نصب و راه اندازی ممکن نیست.',
	'ERR_CHECKSYS_NOT_VALID_DIR'		=> 'مسیر نامعتبر است',
	...
	'ERR_CHECKSYS_PHP_UNSUPPORTED'		=> 'نسخه ی PHP نصب شده پشتیبانی نمی گردد: ( ver',
	...
	'ERR_CHECKSYS_CONFIG_OVERRIDE_NOT_WRITABLE'  => 'جایگزینی پیکربندی فایل وجود دارد اما نه writeable.  لطفا مراحل لازم به پرونده writeable را.  بسته به سیستم عامل خود را, این ممکن است نیاز به شما اجازه تغییر سطح دسترسی 766 در حال اجرا یا با کلیک راست روی نام فایل را به دسترسی به خواص و تنها گزینه ادامه را پاک کنید.',
	'ERR_CHECKSYS_CUSTOM_NOT_WRITABLE'  => 'فهرست سفارشی وجود دارد اما نه writeable.  شما ممکن است به تغییر مجوزها بر روی آن (سطح دسترسی 766) یا بر روی آن راست کلیک کنید و تنها گزینه اطلاعات بسته به سیستم عامل خود را پاک کنید.  لطفا مراحل مورد نیاز به فایل writeable را.',
	'ERR_CHECKSYS_FILES_NOT_WRITABLE'   => "فایل یا دایرکتوری زیر writeable نیست یا مفقود شده است و قادر به ایجاد نمی شود.  بسته به سیستم عامل خود را تصحیح این تغییر مجوز فایل ها یا دایرکتوری های پدر و مادر (سطح دسترسی 755)، یا به کلیک راست در پوشه پدر و مادر و گزینه \"فقط خواندنی\" را پاک کنید و پوشه های فرعی اعمال شما ممکن است نیاز به.",
	...
	'ERR_DB_NAME2'						=> "نام پایگاه داده نباید شامل  '\\', '/', or '.' باشد",
	...
	'ERR_LICENSE_NOT_FOUND'				=> 'پروندۀ اجازه‌نامه یافت نشد!',
	...
	'ERROR_LICENSE_EXPIRED'				=> "خطا: مجوز شما منقضی شده ",
	...
	'LBL_CHECKSYS_COMPONENT_OPTIONAL'	=> 'اجزاء اختیاری',
	...
	'LBL_CHECKSYS_MYSQL_VERSION'		=> 'نسخۀ MySQL',
	...
	'LBL_DBCONF_CREATE_DB'				=> 'ایجاد پایگاه داده',
	'LBL_DBCONF_CREATE_USER'			=> 'ایجاد کاربر',
	...
	'LBL_DISABLED_HELP_2'				=> 'انجمن پشتیبانی',
	'LBL_DISABLED_TITLE_2'				=> 'نصب SuiteCRM غیرفعال شده‌است',
	'LBL_DISABLED_TITLE'				=> 'نصب SuiteCRM غیرفعال است',
	...
	'LBL_LICENSE_DOWNLOAD_KEY'			=> 'کلید دانلود را وارد کنید',
	'LBL_LICENSE_EXPIRY'				=> 'تاریخ انقضا',
	'LBL_LICENSE_I_ACCEPT'				=> 'من قبول می کنم',
	'LBL_LICENSE_NUM_USERS'				=> 'تعداد کاربران',
	...
	'LBL_LICENSE_USERS'					=> 'کاربران مجاز',

	'LBL_LOCALE_CURRENCY'				=> 'تنظیمات ارز',
	'LBL_LOCALE_CURR_DEFAULT'			=> 'واحد پول پیش فرض',
	'LBL_LOCALE_CURR_SYMBOL'			=> 'نماد واحد پول',
	'LBL_LOCALE_CURR_ISO'				=> 'کد ارز (ISO 4217)',
	'LBL_LOCALE_CURR_1000S'				=> '1000s Separator',
	'LBL_LOCALE_CURR_DECIMAL'			=> 'جدا کننده اعشار',
	'LBL_LOCALE_CURR_EXAMPLE'			=> 'مثال',
	'LBL_LOCALE_CURR_SIG_DIGITS'		=> 'Significant Digits',
	'LBL_LOCALE_DATEF'					=> 'فرمت پیش فرض تاریخ',
	...
	'LBL_LOCALE_EXPORT_TITLE'			=> 'تنظیمات درون ریزی و برون ریزی',
	'LBL_LOCALE_LANG'					=> 'زبان پیش فرض',
	'LBL_LOCALE_NAMEF'					=> 'فرمت نام پیش فرض',
	'LBL_LOCALE_NAMEF_DESC'				=> 's = salutation<br />f = first name<br />l = last name',
	'LBL_LOCALE_NAME_FIRST'				=> 'David',
	'LBL_LOCALE_NAME_LAST'				=> 'Livingstone',
	'LBL_LOCALE_NAME_SALUTATION'		=> 'دکتر',
	'LBL_LOCALE_TIMEF'					=> 'فرمت پیش فرض زمان',
	'LBL_CUSTOMIZE_LOCALE'              => 'Customize Locale Settings',
	'LBL_LOCALE_UI'						=> 'رابط کاربری',
	...
	'LBL_PERFORM_AUDIT_TABLE'			=> 'جدول ممیزی / ',
	...
	'LBL_PERFORM_CREATE_RELATIONSHIPS'	=> 'ایجاد جداول رابطه SuiteCRM',
	'LBL_PERFORM_CREATING'				=> 'creating / ',
	'LBL_PERFORM_DEFAULT_REPORTS'		=> 'ایجاد گزارش های پیش فرض',
	...
	'LBL_REG_NO_THANKS'                 => 'نه، ممنون',
	'LBL_REG_SKIP_THIS_STEP'            => 'رد شدن از این مرحله',
	'LBL_REQUIRED'						=> '* اجباری',
	...
	'LBL_SITECFG_SUGAR_UP'				=> 'چک شدن به طور خودکار برای به روز رسانی?',
	...
	'LBL_SITECFG_USE_DEFAULTS'			=> 'استفاده از پیش فرض?',
...
//	'LBL_NO_THANKS'						=> 'Continue to installer',
	...
	'LBL_TITLE_ARE_YOU_READY'            => 'آیا شما برای نصب آماده هستید؟',
...
<li>/upload</b></li></ul></li></ul>
	...
	'LBL_WELCOME_TITLE_WELCOME'			=> 'به SuiteCRM خوش آمدید ',
	...
	'LBL_OOTB_SEND_EMAIL_REMINDERS'	=> 'اجرا اطلاع رسانی یادآوری',
...
$contact_user_link_guid',
	...
	'LBL_MAIL_SMTPAUTH_REQ'				=> 'آیا از تأیید هویت SMTP استفاده شود؟',
