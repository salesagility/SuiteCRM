...
$mod_strings = array(
	...
	'ERR_CHECKSYS_IIS_INVALID_VER'      => 'Su versión de IIS no está soportada por SuiteCRM. Debe instalar una versión compatible. Por favor, consulte la matriz de compatibilidad. Su versión es ',
	'ERR_CHECKSYS_FASTCGI'              => 'Se ha detectado que usted no utiliza FastCGI para el manejo de PHP. Necesita instalar o configurar una versión compatible con SuiteCRM. Por favor, consulte la matriz de compatibilidad para conocer las versiones soportadas. Para mayor información dríjase a  <a href="http://www.iis.net/php/" target="_blank">http://www.iis.net/php/</a> ',
	...
	'ERR_CHECKSYS_ZLIB'					=> 'No encontrado: SuiteCRM obtiene grandes beneficios de rendimiento con compresión zlib.',
	'ERR_CHECKSYS_ZIP'					=> 'Soporte ZIP no encontrado: SuiteCRM necesita soporte ZIP para comprimir archivos.',
	...
	'ERR_DB_PASSWORD'					=> 'Las contraseñas introducidas para el administrador de base de datos de SuiteCRM no coinciden.  Por favor, introduzca de nuevo la misma contraseña en los campos de contraseña.',
	...
	'ERR_DB_USER_EXISTS'				=> 'El nombre de usuario para la base de datos de SuiteCRM ya existe -- no es posible crear otro con el mismo nombre. Por favor, introduzca un nuevo nombre de usuario.',
	...
	'ERR_DBCONF_PASSWORD_MISMATCH'      => 'Las contraseñas introducidas para el usuario de base de datos de SuiteCRM no coinciden. Por favor, introduzca de nuevo la misma contraseña en los campos de contraseña.',
	...
	'ERR_PASSWORD_MISMATCH'				=> 'Las contraseñas introducidas para el usuario administrador de SuiteCRM no coinciden.  Por favor, introduzca de nuevo la misma contraseña en los campos de contraseña.',
	...
	'ERR_PERFORM_NO_TCPIP'				=> '<b>No se ha podido detectar una conexión a internet.</b>Por favor, cuando disponga de una, visite <a href="http://www.suitecrm.com/">http://www.suitecrm.com/</a> para registrarse con SuiteCRM. Permitiéndonos saber un poco sobre los planes de su compañía para utilizar SuiteCRM, podemos asegurarnos de que siempre estamos suministrando el producto adecuado para las necesidades de su negocio.',
	...
	'ERR_URL_BLANK'						=> 'Introduce el URL base para la instancia de SuiteCRM.',
	...
	'LBL_CHECKSYS_CONFIG'				=> 'Archivo de Configuración editable (config_override.php)',
	...
	'LBL_DBCONFIG_MSG3'                 => 'Nombre de la base de datos que albergará los datos de la instancia de SuiteCRM que va a instalar:',
	'LBL_DBCONFIG_MSG3_LABEL' => 'Nombre de Base de datos',
	'LBL_DBCONFIG_B_MSG1'               => 'Para configurar la base de datos de SuiteCRM, es necesario el nombre de usuario y contraseña del administrador de base de datos que puede crear tablas de base de datos y usarios y que puede escribir a la base de datos.',
	'LBL_DBCONFIG_B_MSG1_LABEL' => '',
	'LBL_DBCONFIG_SECURITY'             => 'Por motivos de seguridad, puede especificar un usuario de base de datos exclusivo para conectarse a la base de datos de SuiteCRM.  Este usuario debe ser capaz de escribir, actualizar y recuparar datos en la base de datos de SuiteCRM que será creada para esta instancia.  Este usuario puede ser el administrador de base de datos anteriormente especificado, o puede introducir la información de un usuario de base de datos nuevo o existente.',
	...
	'LBL_LANG_1'						=> 'Para utilizar un idioma en SuiteCRM distinto al del idioma por defecto (Inglés de EEUU), puede subir e instalar ahora el paquete de idioma. También podrá subir e instalar paquetes de idioma desde la aplicación SuiteCRM.  Si quiere saltarse este paso, haga clic en Siguiente.',
	...
	'LBL_LAUNCHING_SILENT_INSTALL'     => 'Instalando SuiteCRM en estos momentos.  La instalación puede llegar a tardar unos minutos.',
	...
	'LBL_PERFORM_TABLES'				=> 'Creando las tables de aplicación de SuiteCRM, tablas de auditoría, y metadatos de relaciones',
	...
	'LBL_SITECFG_ADMIN_Name'            => 'Nombre del Administrador de la Aplicación SuiteCRM',
	'LBL_SITECFG_ADMIN_PASS_2'			=> 'Introduzca de nuevo la Contraseña del Usuario Admin de SuiteCRM',
	'LBL_SITECFG_ADMIN_PASS_WARN'		=> 'Precaución: Esto substituirá la contraseña de admin de cualquier instalación previa',
	'LBL_SITECFG_ADMIN_PASS'			=> 'Contraseña del Usuario Admin de SuiteCRM',
	'LBL_SITECFG_APP_ID'				=> 'ID de Aplicación',
	'LBL_SITECFG_CUSTOM_ID_DIRECTIONS'	=> 'Si está seleccionado, debe introducir un ID de aplicación para sustituir al ID autogenerado. El ID asegura que las sesiones de una instancia de SuiteCRM no son utilizadas por otras instancias.  Si tiene un cluster de instalaciones SuiteCRM, todas deben compartir el mismo ID de aplicación.',
	'LBL_SITECFG_CUSTOM_ID'				=> 'Proveer Su Propio ID de Aplicación',
	'LBL_SITECFG_CUSTOM_LOG_DIRECTIONS'	=> 'Si está seleccionado, debe especificar un directorio de trazas para sustituir al directorio por defecto de trazas de SuiteCRM.  Independientemente de donde resida el archivo de trazas, el acceso al mismo a través del navegador será restringido mediante una redirección definida en un archivo .htaccess .',
	'LBL_SITECFG_CUSTOM_LOG'			=> 'Usar un Directorio Personalizado de Trazas',
	'LBL_SITECFG_CUSTOM_SESSION_DIRECTIONS'	=> 'Si está seleccionado, debe especificar una carpeta segura para almacenar la información de las sesiones de SuiteCRM. Esto se hace para evitar que los datos de la sesión sean vulnerables en servidores compartidos.',
	...
	'LBL_SITECFG_TITLE2'                => 'Identifique su Instancia de SuiteCRM',
	...
	'LBL_SITECFG_ANONSTATS_DIRECTIONS'  => 'Si está seleccionado, SuiteCRM enviará estadísticas <b>anónimas</b> sobre su instalación a SuiteCRM Inc. cada vez que su sistema compruebe la existencia de nuevas versiones. Esta información nos ayudará a entender mejor cómo la aplicación es usada y guiar así las mejoras al producto.',
	'LBL_SITECFG_URL_MSG'               => 'Introduzca el URL que será utilizado para acceder a la instancia de SuiteCRM tras la instalación. Este URL también se usará como base para los URLs de las páginas de la aplicación SuiteCRM. El URL debería incluir el nombre de servidor web o máquina, o su dirección IP.',
	...
	'LBL_SITECFG_PASSWORD_MSG'          => 'Tras la instalación, necesitará usar el usuario administrador de SuiteCRM (nombre de usuario = admin) para iniciar la sesión en la instancia de SuiteCRM.  Introduzca una contraseña para este usuario administrador. Esta contraseña puede ser cambiada tras el inicio de sesión inicial.',
...
//	'LBL_NO_THANKS'						=> 'Continue to installer',
	...
	'REQUIRED_SYS_COMP_MSG' =>
		'Antes de empezar, por favor asegúrese de que tiene las versiones soportadas de los siguientes componentes del sistema:<br><ul><li> Base de Datos/Sistema de Gestión de Base de Datos (Ejemplos: MySQL, SQL Server, Oracle)</li><li> Servidor Web (Apache, IIS)</li></ul>Consulte la Matriz de Compatibilidad en las Notas de Lanzamiento para los componentes del sistema compatibles para la versión de SuiteCRM que está instalando.<br>',
	'REQUIRED_SYS_CHK' => 'Comprobación inicial del sistema',
	'REQUIRED_SYS_CHK_MSG' =>
		'Cuando inicie el proceso de instalación, se realizará una comprobación del sistema en el servidor web en el que los archivos de SuiteCRM están localizados para asegurar que el sistema está debidamente configurado y tiene todos los componentes necesarios para completar la instalación con éxito. <br><br> El sistema comprueba lo siguiente:<br><ul><li>Que la <b>versión de PHP</b> &#8211; sea compatible con la aplicación</li><li><b>Las Variables de Sesión</b> &#8211; deben funcionar adecuadamente</li><li> <b>Las Cadenas MB</b> &#8211; deben estar instaladas y habilitadas en php.ini</li><li> <b>El Soporte de Base de Datos</b> &#8211; debe existir para MySQL, SQL Server u Oracle</li><li> <b>Config.php</b> &#8211; debe existir y tiene que tener los permisos adecuados para que sea escribible</li>					  <li>Los siguientes archivos de SuiteCRM deben ser escribibles:<ul><li><b>/custom</li><li>/cache</li><li>/modules</b></li></ul></li></ul>Si la comprobación falla, no podrá continuar con la instalación. Un mensaje de error será mostrado, explicándole por qué su sistema no ha pasado las comprobaciones. Tras realizar los cambios necesarios, puede realizar las comprobaciones del sistema de nuevo para continuar con la instalación.<br>',
	'REQUIRED_INSTALLTYPE' => 'Instalación Típica o Personalizada',
	'REQUIRED_INSTALLTYPE_MSG' =>
		'Tras la comprobación del sistema, puede elejir entre la instalación Típica o la Personalizada.<br><br>Tanto para la instalación <b>Típica</b> como para la <b>Personalizada</b>, necesitará saber lo siguiente:<br><ul><li> <b>Tipo de base de datos</b> que almacenará los datos de SuiteCRM <ul><li>Tipos de base de datos compatibles: MySQL, MS SQL Server, Oracle.<br><br></li></ul></li><li> <b>Nombre del servidor web</b> o máquina (equipo) en el que la base de datos setá ubicada<ul><li>Esto puede ser <i>localhost</i> si la base de datos está en su equipo local o en en el mismo servidor web o máquina que sus archivos SuiteCRM.<br><br></li></ul></li><li><b>Nombre de la base de datos</b> que desea utilizar para almacenar los datos de SuiteCRM</li><ul><li> Puede que ya disponga de una base de datos que quiera utilizar. Si proporciona el nombre de una base de datos existente, las tablas de la base de datos serán eliminadas durante la instalación, cuando se defina el esquema para la base de datos de SuiteCRM.</li><li> Si no tiene una base de datos, el nombre que proporcione se utilizará para la nueva base de datos que será creada para la instacia durante la instalación.<br><br></li></ul><li><b>Nombre y contraseña del usuario administrador de Base de datos</b> <ul><li>El administrador de base de datos debería ser capaz de crear tablas y usuarios y de escribir en base de datos.</li><li>Puede que necesite contactar con su administrador de base de datos para que le proporcione esta información si la base de datos no está ubicada en su equipo local y/o si usted no es el administrador de base de datos.<br><br></ul></li></li><li> <b>Nombre y contraseña del usuario de base de datos de SuiteCRM</b></li><ul><li> El usuario puede ser el administrador de base de datos, o puede proporcionar el nombre de otro usuario de base de datos existente. </li><li> Si quiere crear un nuevo usuario de base de datos para este propósito, podrá proporcionar un nuevo nombre de usuario y contraseña durante el proceso de instalación, y el usuario será creado durante la instalación. </li></ul></ul><p>Para la instalación <b>Personalizada</b>, también necesitará conocer lo siguiente:<br><ul><li> <b>El URL que se utilizará para acceder a la instancia de SuiteCRM</b> tras su instalación. Este URL debería incluir el nombre del servidor web o de máquina, o su dirección IP.<br><br></li><li> [Opcional] <b>Ruta al directorio de sesiones</b> si desea utilizar un directorio de sesiones personalizado para la información de SuiteCRM con el objeto de evitar que los datos de las sesiones sean vulnerables en servidores compartidos.<br><br></li><li> [Opcional] <b>Ruta a un directorio personalizado de trazas</b> si desea sustituir el directorio por defecto para las trazas de SuiteCRM.<br><br></li><li> [Opcional] <b>ID de Aplicación</b> si desea sustituir el ID autogenerado que asegura que las sesiones de una instancia de SuiteCRM no sean utilizadas por otras instancias.<br><br></li><li><b>Juego de Caracteres</b> más comúnmente usado en su configuración regional.<br><br></li></ul>Para información más detallada, por favor consulte la Guía de Instalación.',
	...
	'LBL_WIZARD_TITLE'					=> 'Asistente de Instalación de SuiteCRM: ',
	'LBL_YES'							=> 'Sí',
	...
	'LBL_SESSION_ERR_DESCRIPTION'		=> "SuiteCRM depende de las sesiones de PHP para almacenar información importante mientras que está conectado a su servidor web.  Su instalación de PHP no tiene la información de Sesión correctamente configurada.<br><br>Un error de configuración bastante común es que la directiva <b>'session.save_path'</b> no apunte a un directorio válido.<br><br> Por favor, corrija su <a target=_new href='http://us2.php.net/manual/en/ref.session.php'>configuración PHP</a> en el archivo php.ini localizado donde se indica a continuación.",
	...
	'LBL_REQUIRED_SYSTEM_NAME'=>'Introduzca un Nombre de Sistema para la instancia de SuiteCRM.',
