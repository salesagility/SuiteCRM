...
$mod_strings = array(
	...
	'LBL_DBCONF_TITLE_USER_INFO_LABEL' => 'Потребител',
	'LBL_DBCONF_TITLE_PSWD_INFO_LABEL' => 'Парола:',
...
$contact_user_link_guid',
	...
	'COMPANY_LOGO_UPLOAD_BTN' => 'Зареждане',
	...
	'ERR_UPLOAD_FILE_UPLOAD_ERR_INI_SIZE' => 'Размерът на зареждания файл надхвърля стойността на параметъра upload_max_filesize във файла php.ini.',
	'ERR_UPLOAD_FILE_UPLOAD_ERR_FORM_SIZE' => 'Размерът на зареждания файл надхвърля стойността на параметъра MAX_FILE_SIZE в HTML форма.',
	'ERR_UPLOAD_FILE_UPLOAD_ERR_PARTIAL' => 'Файлът беше зареден частично.',
	'ERR_UPLOAD_FILE_UPLOAD_ERR_NO_FILE' => 'Файлът не беше зареден.',
	'ERR_UPLOAD_FILE_UPLOAD_ERR_NO_TMP_DIR' => 'Папката за временни файл-ове липсва.',
	'ERR_UPLOAD_FILE_UPLOAD_ERR_CANT_WRITE' => 'Грешка при записване на файла на диск.',
