...
$mod_strings = array(
	'LBL_BASIC_SEARCH'					=> 'Բազային որոնում',
	'LBL_ADVANCED_SEARCH'				=> 'Լրացուցիչ որոնում',
	'LBL_BASIC_TYPE'					=> 'Բազային որոնում',
	'LBL_ADVANCED_TYPE'					=> 'Ընդլայնված որոնում',
	'LBL_SYSOPTS_1'						=> 'Ընտրեք հետևյալ համակարգի կոնֆիգուրացիաների կարգավորումները։',
	...
	'LBL_MAKE_DIRECTORY_WRITABLE'      => 'Հաջորդ պանակները պատք է հասանելի լինեն գրառման համար․',
	...
	'ERR_CHECKSYS_NOT_VALID_DIR'		=> 'Սխալ պանակ',
	...
	'ERR_LOG_DIRECTORY_NOT_EXISTS'		=> 'Տեղեկամատյան ցուցակում պայմանով վավեր չէ։',
	'ERR_LOG_DIRECTORY_NOT_WRITABLE'	=> 'Գրանցամատյանների համար նշված պանակը անհասանելի է։',
	...
	'ERR_PERFORM_HTACCESS_1'			=> 'Չեք կարող գրել',
	...
	'LBL_DBCONF_TITLE'					=> 'Տվյալների բազայի ձևակերպում',
	...
	'LBL_LICENSE_NUM_USERS'				=> 'Օգտագործողների քանակը',
	...
	'LBL_LOCALE_DATEF'					=> 'Ամսաթվի ընդունված ձևաչափ',
	...
	'LBL_SITECFG_CUSTOM_LOG'			=> 'Օգտագործել ուրիշ պանակ գրանցամատյանի ֆայլի համար',
	...
	'LBL_SITECFG_LOG_DIR'				=> 'Գրանցամատյանի ֆայլի պանակը',
