...
$mod_strings = array(
	'LBL_BASIC_SEARCH'					=> 'Հիմնական որոնում',
	'LBL_ADVANCED_SEARCH'				=> 'Ընդլայնված որոնում',
	'LBL_BASIC_TYPE'					=> 'Հիմնական տեսակը',
	'LBL_ADVANCED_TYPE'					=> 'Ընդլայնված տեսակը',
	'LBL_SYSOPTS_1'						=> 'Ընտրեք հետևյալ համակարգից կարգավորումների ընտրանքները։',
	'LBL_SYSOPTS_2'                     => 'Ի՞նչ տեսակի տվյալների բազա կօգտագործվի SuiteCRM-ում։',
	'LBL_SYSOPTS_CONFIG'				=> 'Համակարգի կարգավորում',
	'LBL_SYSOPTS_DB_TYPE'				=> '',
	'LBL_SYSOPTS_DB'					=> 'Նշեք տվյալների բազայի տեսակը',
	'LBL_SYSOPTS_DB_TITLE'              => 'Տվյալների բազայի տեսակը',
	'LBL_SYSOPTS_ERRS_TITLE'			=> 'Խնդրում ենք ուղղել հետևյալ սխալները մինչ շարունակելը:',
	'LBL_MAKE_DIRECTORY_WRITABLE'      => 'Հետևյալ պանակների կատալոգը պատք է հասանելի լինի գրառման համար․',
	'ERR_DB_VERSION_FAILURE'			=> 'Անհնար է ստուգել տվյալների բազայի տարբերակը.',
	'DEFAULT_CHARSET'					=> 'UTF-8',
	'ERR_ADMIN_USER_NAME_BLANK'         => 'Տրամադրել օգտվողի անունը SuiteCRM ադմինիստրատորին։ ',
	'ERR_ADMIN_PASS_BLANK'				=> 'Տրամադրել գաղտնաբառը SuiteCRM ադմինիստրատորին։ ',
	...
	'ERR_CHECKSYS_CALL_TIME'            => 'Allow Call Time Pass Reference միացված է (անջատել այս տարբերակը php.ini)',
	'ERR_CHECKSYS_CURL'					=> 'Գտնված չէ։ SuiteCRM պլանավորողը կաշխատի սահմանափակ ֆունկցիոնալությամբ։',
	'ERR_CHECKSYS_IMAP'					=> 'Գտնված չէ․ Մուտքային էլ-փոստի և մարքեթինգային արշավի (էլ-փոստի) համար հարկավոր է IMAP գրադարաններ։',
	'ERR_CHECKSYS_MSSQL_MQGPC'			=> 'Magic Quotes GPC cannot be turned "On" when using MS SQL Server.',
	'ERR_CHECKSYS_MEM_LIMIT_0'			=> 'Զգուշացում․ ',
	'ERR_CHECKSYS_MEM_LIMIT_1'			=> '(Սահմանել, որ սա',
	'ERR_CHECKSYS_MEM_LIMIT_2'			=> 'M կամ ավելի մեծ է ձեր php.ini ֆայլը)',
	'ERR_CHECKSYS_MYSQL_VERSION'		=> 'Նվազագույն 4.1.2 տարբերակը գտնվել է․ ',
	'ERR_CHECKSYS_NO_SESSIONS'			=> 'Չհաջողվեց գրել և կարդալ սեսիայի փոփոխականները։ Տեղադրման աշխատանքը անհնար է շարունակել։',
	'ERR_CHECKSYS_NOT_VALID_DIR'		=> 'Անհասանելի պանակների կատալոգ',
	'ERR_CHECKSYS_NOT_WRITABLE'			=> 'Զգուշացում. Չեք կարող գրառում կատարել',
	...
	'ERR_CHECKSYS_FASTCGI_LOGGING'      => 'IIS/FastCGI sapi օպտիմալ օգտագործման համար, տեղադրեք fastcgi.logging պարամետրը php.ini ֆայլի մեջ, որը հավասար է 0։',
	...
	'LBL_CHECKSYS_OVERRIDE_CONFIG' => 'Վերագրանցել կարգավորումները',
	//'ERR_CHECKSYS_SAFE_MODE'			=> 'Safe Mode is On (please disable in php.ini)',
	'ERR_CHECKSYS_SAFE_MODE'			=> 'Անվտանգության ռեժիմը միացած է (դուք կարող եք անջատել php.ini -ում)',
	...
	'ERR_DB_MYSQL_VERSION'				=> 'Ձեր MySQL տարբերակը (%s) չի բավարարում SuiteCRM-ի պահանջներին։ Դուք պետք է տեղադրեք մի նոր տարբերակ, որը համատեղելի է SuiteCRM ծրագրին։ Խնդրում ենք ուսումնասիրեք համատեղելիության աղյուսակը։',
	...
	'ERR_DBCONF_VALIDATION'				=> 'Խնդրում ենք ուղղել հետևյալ սխալները մինչ շարունակելը:',
	...
	'ERR_ERROR_GENERAL'					=> 'Տեղի են ունեցել հետևյալ սխալները',
	'ERR_LANG_CANNOT_DELETE_FILE'		=> 'Հնարավոր չէ ջնջել ֆայլը. ',
	'ERR_LANG_MISSING_FILE'				=> 'Հնարավոր չէ գտնել ֆայլը․',
	'ERR_LANG_NO_LANG_FILE'			 	=> 'No language pack file found at include/language inside: ',
	'ERR_LANG_UPLOAD_1'					=> 'Բեռնումը չի հաջողվել: Խնդրում ենք փորձել կրկին:',
	'ERR_LANG_UPLOAD_2'					=> 'Language Packs must be ZIP archives.',
	'ERR_LANG_UPLOAD_3'					=> 'PHP չի կարող տեղափոխել ժամանակավոր ֆայլերը թարմացումների պանակների կատալոգ։',
	'ERR_LICENSE_MISSING'				=> 'Missing Required Fields',
	'ERR_LICENSE_NOT_FOUND'				=> 'Լիցենզիայի ֆայլը չի գտնվել!',
	'ERR_LOG_DIRECTORY_NOT_EXISTS'		=> 'Գրանցամատյանների կատալոգի համար նշված պանակների կատալոգը անհասանելի է։',
	'ERR_LOG_DIRECTORY_NOT_WRITABLE'	=> 'Գրանցամատյանների կատալոգի համար նշված պանակների կատալոգը անհասանելի է գրառման համար:',
	'ERR_LOG_DIRECTORY_REQUIRED'		=> 'Գրանցամատյանների կատալոգում պետք է նշված լինի, եթե դուք ուզում եք սահմանել, որպես ձեր սեփական։',
	...
	'ERR_PERFORM_CONFIG_PHP_1'			=> 'Հնարավոր չէ գրել <span class=stop>config.php</span> ֆայլում։',
	...
	'ERR_PERFORM_CONFIG_PHP_3'			=> 'Չե՞ք մոռացել ստեղծել config.php ֆայլը։',
	'ERR_PERFORM_CONFIG_PHP_4'			=> 'Warning: Could not write to config.php file.  Please ensure it exists.',
	'ERR_PERFORM_HTACCESS_1'			=> 'Հնարավոր չէ գրել ',
	'ERR_PERFORM_HTACCESS_2'			=> 'ֆայլ:',
	'ERR_PERFORM_HTACCESS_3'			=> 'Եթե դուք ուզում եք անվտանգություն ապահովել գրանցամատյանի ֆայլը բրաուզերին հասանելի լինելուց, ստեղծեք .htaccess ֆայլը ձեր գրանցամատյանի կատալոգում այս տողով․',
	...
	'ERR_SESSION_DIRECTORY_NOT_EXISTS'	=> 'Սեսիայի ֆայլապանակների համար նշված պանակների կատալոգը անհասանելի է։',
	'ERR_SESSION_DIRECTORY'				=> 'Սեսիայի ֆայլապանակների համար նշված պանակների կատալոգը անհասանելի է գրառման համար:',
	...
	'LBL_CHECKSYS_COMPONENT'			=> 'Բաղադրիչ',
	'LBL_CHECKSYS_COMPONENT_OPTIONAL'	=> 'Լրացուցիչ բաղադրիչներ',
	...
	'LBL_CHECKSYS_CUSTOM'				=> 'Հարմարեցված պանակների կատալոգը գրառման համար հասանելի չէ',
	...
	'LBL_CHECKSYS_MEM_OK'				=> 'OK (անսահմանափակ)',
	'LBL_CHECKSYS_MEM_UNLIMITED'		=> 'OK (անսահմանափակ)',
	...
	'LBL_CHECKSYS_UPLOAD'               => 'Վերբեռնման պանակների կատալոգը հասանելի է գրառում կատարելու համար',
	'LBL_CLOSE'							=> 'Փակել',
	'LBL_THREE'                         => '3',
	'LBL_CONFIRM_BE_CREATED'			=> 'ստեղծված կլինի',
	'LBL_CONFIRM_DB_TYPE'				=> 'Տվյալների բազայի տեսակը',
	'LBL_CONFIRM_DIRECTIONS'			=> 'Խնդրում ենք ստուգել ներքևի կարգավորումները։ Եթե ցանկանում եք փոխել որևէ կարգավորում, սեղմեք "հետ" կոճակը, եթե ամեն ինչ նորմալ է, սեղմեք "առաջ" սկսել տեղադրումը։',
	'LBL_CONFIRM_LICENSE_TITLE'			=> 'Լիցենզիայի տեղեկատվություն',
	'LBL_CONFIRM_NOT'					=> 'ոչ',
	'LBL_CONFIRM_TITLE'					=> 'Հաստատել կարգավորումները',
	'LBL_CONFIRM_WILL'					=> 'will',
	'LBL_DBCONF_CREATE_DB'				=> 'Ստեղծել տվյալների բազա',
	'LBL_DBCONF_CREATE_USER'			=> 'Ստեղծել օգտոգարծող',
	...
	'LBL_DBCONF_DB_NAME'				=> 'Տվյալների բազայի անվանումը',
	...
	'LBL_DBCONF_HOST_PORT'				=> 'Նավահանգիստ',
	...
	'LBL_DBCONFIG_MSG3_LABEL' => 'Տվյալների բազայի անվանումը',
	...
	'LBL_DBCONF_TITLE'					=> 'Տվյալների բազայի կարգավորում',
	'LBL_DBCONF_TITLE_NAME'             => 'Provide Database Name',
	'LBL_DBCONF_TITLE_USER_INFO'        => 'Provide Database User Information',
	'LBL_DBCONF_TITLE_USER_INFO_LABEL' => 'Օգտագործող',
	'LBL_DBCONF_TITLE_PSWD_INFO_LABEL' => 'Գաղտնաբառ',
	...
	'LBL_EMAIL_CHARSET_TITLE'			=> 'Ելքային էլ-փոստի կարգավորումներ',
	'LBL_EMAIL_CHARSET_CONF'            => 'Ելքային էլ-փոստի կոդավորում ',
	'LBL_HELP'							=> 'Օգնություն',
	'LBL_INSTALL'                       => 'Install',
	'LBL_INSTALL_TYPE_TITLE'            => 'Տեղադրման ընտրանքներ',
	...
	'LBL_INSTALL_TYPE_MSG2'             => 'Պահանջվում է մինիմալ տեղեկատվություն ծրագրի ներդրման համար։ Խորհուրդ է տրվում նոր օգտագործողների համար։',
	'LBL_INSTALL_TYPE_MSG3'             => 'Ապահովում է հավելյալ ընտրություններ ծրագրի ներդրման ժամանակ։ Այս տարբերակների մեծ մասը հասանելի են ծրագրի ներդրումից հետո ադմինիստարտորի էկրանին։ Խորհուրդ է տրվում փորձառու օգտագործողների համար։',
	...
	'LBL_LICENSE_REDIRECT'              => 'Վերաուղղորդում ',
	'LBL_LICENSE_DIRECTIONS'			=> 'If you have your license information, please enter it in the fields below.',
	'LBL_LICENSE_DOWNLOAD_KEY'			=> 'Գրանցել ներբեռնման բանալին',
	'LBL_LICENSE_EXPIRY'				=> 'Վերջնաժամկետի օրը',
	'LBL_LICENSE_I_ACCEPT'				=> 'Ընդունում եմ',
	'LBL_LICENSE_NUM_USERS'				=> 'Օգտվողների քանակը',
	'LBL_LICENSE_OC_DIRECTIONS'			=> 'Խնդրում ենք մուտք անել ձեռք բերված արտացանցային կլիենտների քանակը։',
	'LBL_LICENSE_OC_NUM'				=> 'Արտացանցային կլիենտների լիցենզիաների քանակը',
	'LBL_LICENSE_OC'					=> 'Արտացանցային կլիենտների լիցենզիաները',
	'LBL_LICENSE_PRINTABLE'				=> ' Printable View ',
	'LBL_PRINT_SUMM'                    => 'Print Summary',
	'LBL_LICENSE_TITLE_2'				=> 'SuiteCRM License',
	'LBL_LICENSE_TITLE'					=> 'Լիցենզիայի տեղեկատվություն',
	'LBL_LICENSE_USERS'					=> 'Licensed Users',

	'LBL_LOCALE_CURRENCY'				=> 'Currency Settings',
	'LBL_LOCALE_CURR_DEFAULT'			=> 'Ընդունված արտարժույթ',
	'LBL_LOCALE_CURR_SYMBOL'			=> 'Արժույթի նշանը',
	'LBL_LOCALE_CURR_ISO'				=> 'Currency Code (ISO 4217)',
	'LBL_LOCALE_CURR_1000S'				=> '1000s Separator',
	'LBL_LOCALE_CURR_DECIMAL'			=> 'Decimal Separator',
	'LBL_LOCALE_CURR_EXAMPLE'			=> 'Օրինակ',
	'LBL_LOCALE_CURR_SIG_DIGITS'		=> 'Significant Digits',
	'LBL_LOCALE_DATEF'					=> 'Ամսաթվի ընդունված ձև',
	...
	'LBL_LOCALE_LANG'					=> 'Ընդունված լեզու',
	'LBL_LOCALE_NAMEF'					=> 'Անունների լռելյայն ֆորմատ',
	'LBL_LOCALE_NAMEF_DESC'				=> 's = salutation<br />f = first name<br />l = last name',
	'LBL_LOCALE_NAME_FIRST'				=> 'Դավիթ',
	'LBL_LOCALE_NAME_LAST'				=> 'Լիվինգստոուն',
	'LBL_LOCALE_NAME_SALUTATION'		=> 'Դոկտոր',
	'LBL_LOCALE_TIMEF'					=> 'Ժամանակի ընդունված ֆորմատ',
	...
	'LBL_PERFORM_DEFAULT_SCHEDULER'		=> 'Ստեղծվում է լռելյայն պլանավորողի աշխատանքները',
	...
	'LBL_REG_CONF_3'					=> 'Շնորհակալություն գրանցվելու համար։ Որպեսզի մուտք անեք SuiteCRM սեղմեք "ավարտ" կոճակը։ Առաջին անգամ համակարգ մուտք գործելու համար ձեզ անհրաժեշտ է ձեր "մուտքանունը" և "գաղտնաբառը", որոնք դուք մուտքագրելեք քայլ 2-ի ժամանակ։',
	'LBL_REG_TITLE'						=> 'Գրանցում',
	'LBL_REG_NO_THANKS'                 => 'No Thanks',
	'LBL_REG_SKIP_THIS_STEP'            => 'Skip this Step',
	'LBL_REQUIRED'						=> '* Պարտադիր դաշտեր',
	...
	'LBL_SITECFG_CUSTOM_LOG_DIRECTIONS'	=> 'Եթե ընտրված է, դուք պետք է նշեք գրանցամատյանի պանակների կատալոգը և չեղարկեք նախնական կատալոգը SuiteCRM-ի գրանցամատյանների համար։ Անկախ նրանից, թե որտեղ է գրանցամատյանի ֆայլը գտնվում, նրա մուտքի իրավունքը վեբ բրաուզեր կարող է սահմանափակվել .htaccess վերահղման միջոցով։',
	'LBL_SITECFG_CUSTOM_LOG'			=> 'Օգտագործեք հարմարեցված գրանցամատյանի պանակների կատալոգը',
	...
	'LBL_SITECFG_CUSTOM_SESSION'		=> 'Օգտագործեք հարմարեցված սեսիայի պանակների կատալոգը SuiteCRM-ի համար',
	...
	'LBL_SITECFG_LOG_DIR'				=> 'Գրանցամատյանի պանակների կատալոգ',
	'LBL_SITECFG_SESSION_PATH'			=> 'Ճանապարհ դեպի սեսիաների պանակների կատալոգ<br>(պետք է լինի գրելի)',
	'LBL_SITECFG_SITE_SECURITY'			=> 'Ընտրել անվտանգության ընտրանքները',
	...
	'LBL_START'							=> 'Մեկնարկ',
	'LBL_SHOW_PASS'                     => 'Ցույց տալ գաղտնաբառերը',
...
<li>/upload</b></li></ul></li></ul>
	...
	'LBL_OOTB_SUGARFEEDS'   => 'Մաքրել SuiteCRM լրահոսի ցանկը',
	'LBL_OOTB_SEND_EMAIL_REMINDERS'	=> 'Տարածել ծանուցումներ էլ-փոստի միջոցով',
	'LBL_UPDATE_TRACKER_SESSIONS' => 'Թարմացնել tracker_sessions աղյուսակը',
	...
	'LBL_RECOMMENDED_PHP_VERSION' =>' Խորհուրդ է տրվում php տարբերակը 5.2.x)',
...
$contact_user_link_guid',
		'name' => 'Մորացել եք էլ-փոստի գաղտնաբառը',
	),
	...
	'LBL_CHOOSE_EMAIL_PROVIDER'        => 'Ընտրեք Ձեր էլ-փոստի պրովայդերը.',
	...
	'UPLOAD_LOGO' => 'Խնդրում ենք սպասել, լոգոն վերբեռնվում է․․',
	...
	'ERR_ADMIN_EMAIL' => 'Ադմինիստրատորի էլ-փոստի սխալ հասցե։',
	'ERR_SITE_URL' => 'Site URL is required.',

	'STAT_CONFIGURATION' => 'Հարաբերությունների կարգավորում․․․',
	...
	'STAT_INSTALL_FINISH_LOGIN' => 'Տեղադրումը ավարտված է, <a href="%s">խնդրում ենք մուտք գործել համակարգ․․․</a>',
	'LBL_LICENCE_TOOLTIP' => 'Please accept license first',

	'LBL_MORE_OPTIONS_TITLE' => 'Լրացուցիչ ընտրանքներ',
	'LBL_START' => 'Մեկնարկ',
