...
if ($_SESSION['demoData'] != 'no') {
    ...
    echo $render_table_close;
    echo $render_table_open;
...
installStatus(sprintf($mod_strings['STAT_INSTALL_FINISH_LOGIN'], $loginURL), ['function' => 'redirect', 'arguments' => $loginURL]);
