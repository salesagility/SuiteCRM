    ...
    public function createModuleRecord(Request $req, Response $res, array $args)
    {
        ...
        if (isset($body['data']['id']) && empty($body['data']['id']) === false) {
            $exception = new Forbidden(
                '[creating a record with id that has been generated by client is forbidden] "' .
                $body['data']['id'] . '"'
            );
        ...
        // TODO: Add better client side validation
        // $this->validateRequestWithJsonApiSchema($req);
